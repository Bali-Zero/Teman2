...
kbli_codes:
  ...
  - "70201 — Aktivitas Konsultansi Manajemen dan Bisnis Pariwisata — National: TERBUKA 100% — Bali: CHIUSO_PMA_NO_BESAR (blocked)"
...
- **70201 — Konsultansi Manajemen dan Bisnis Pariwisata** (tourism consulting): open nationally, but **blocked** in Bali — the OSS system offers no large-scale row, so it's reserved for local UMKM. A PT PMA can't register it.
