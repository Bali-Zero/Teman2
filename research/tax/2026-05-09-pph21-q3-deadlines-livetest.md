...
**devils-advocate (7 passes, DeepSeek Reasoner primary)**: P1 BLOCK (3 crit) → P2 NEEDS_FIX (0 crit, 5 high) → P3 NEEDS_FIX (0 high, 2 med + 2 low) → P4 NEEDS_FIX (1 med BD-arithmetic) → P5 NEEDS_FIX (1 med BD definitional) → P6 NEEDS_FIX (1 med counting prose) → P7 NEEDS_FIX (1 med Q3 scope, 3 low: TER deferred OK, PMK 242/243 precision, BD-buffer label vs filing-window). All critical+high resolved by P3; P4-P7 cycled through definitional refinements. Doc reaches "regulatorially solid" at P7; remaining residuals are editorial nitpicks (3+ findings of any severity → NEEDS_FIX per protocol) below client-blocking gate. Status: `draft` pending JDIH primary verification of: PMK 81/2024 text + correct predecessor PMK number (242/2014 vs 243/2014), PMK 168/2023 Lampiran A, SKB 3 Menteri 2026 decree number, KEP DJP Coretax-transition number, PER for Coretax filing platform mandate.
...
- **KEP DJP — Coretax-transition waiver for Desember 2025 SPT Masa PPh 21** — earlier draft cited "KEP-37/PJ/2026 (27 Feb 2026)" sourced from a WebSearch summary; DeepSeek red-team confirmed no such KEP appears in `jdih.pajak.go.id`. Known Coretax-transition KEPs are KEP-6/PJ/2026, KEP-9/PJ/2026, KEP-11/PJ/2026 (penalty waivers, scope varies). Do NOT cite "KEP-37/PJ/2026" until verified. Do NOT conflate with KEP-71/PJ/2026 (different domain — SPT Tahunan PPh Badan extension). For client work, refer simply to "the DJP Desember 2025 SPT Masa transition waiver" without a specific KEP number until JDIH lookup completes.
