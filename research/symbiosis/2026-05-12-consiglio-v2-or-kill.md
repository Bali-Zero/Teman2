...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ----------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| P4.1 — Periodic deliberation                                 | Pattern 1 (wave-orchestrator) on a cron + Pattern 4 (ad-hoc) | **COVERED** | Wave triggered by Zero/cron events; ad-hoc when needed. Periodic without trigger = solution looking for problem.                   |
