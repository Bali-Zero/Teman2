...
|---|---|---|---|
| 9+2+2 = 13 | YouTube URL clusters | NB-4 (d4b2eedb) | Pending Zero review |
...
| Count | Type | Target NB | Status |
|---|---|---|---|
| 9 | Cloudflare block pages | AIResearch (dc5d01cd) | Pending Zero review |
| 4 | Vercel deploy error pages | AIResearch (dc5d01cd) | Pending Zero review |

### Press Anomaly (1 source)

| Source | Title | Target NB | Status |
|---|---|---|---|
| b7a6ee97 | "Neoregelia lillyae - Wikipedia" | Press (9d262101) | Pending Zero review — 12 days |
