...
# NB Arsenal Health Report — 2026-08-19 (daily)

## Summary
- Total: 62 notebooks live, 6,158 sources (sum of `source_count`; vs 6,119 on 2026-08-18 → +39).
- Healthy: 60
...
4. "Indonesia Cuts Visa-Free Entry by 87% to Tighten Foreign Screening" / "Indonesia Slashes Visa-Free Entry as Border Controls Tighten"

### Proposed Topic Summarization Clusters (4 clusters, >=10 sources)
1. **Visa-free entry cut / reduction (87% - 88%)** (>=10 sources)
2. **Golden Visa investments and launching** (>=10 sources)
3. **E-commerce and Marketplace tax collection (PMK 37/2025 / PPh 22)** (>=10 sources)
