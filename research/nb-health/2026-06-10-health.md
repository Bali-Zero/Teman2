...
|---|---|---|---|---|
| NB-4 Tax | YT-DUP-01..13 | 13 | YouTube duplicate sources (9+2+2 structure) | Pending Zero approval |
...
**Action**: These 24 proposals have been pending since 2026-05-31. Recommend Zero review + approve/reject via `nlm source remove`. Reference: `2026-05-31-health.md` and `2026-05-30-health.md` for full cluster details.
