...
| --- | ------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| C1  | Q2 NB-INTEL boundary      | **MODIFY** | Verbatim regulatory text è public domain (fair use) — MA da public/legal cache, NON da raw NB-INTEL notes/source_ids/sintesi. Codex sharpens: privato NB context, annotations, synthesis MAI escono dal Pro.                |
...
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| Verbatim regulatory text (UU/PP/PMK pubblici) from **public/legal cache**           | Raw NB-INTEL notes / annotations / synthesis                                  |
...
| Brand cortex skills (constitution.md, forbidden-phrases.md) committed in git        | NB-INTEL query results raw (must be filtered through brief-interpreter cache) |
...
| 2 OSINT blindato           | NB-INTEL stays local. Brief-interpreter caches regulatory facts in local PG before propagation. **NO source_ids in published manifest.**               | `lint_wr3_osint_boundary.py`                   |
...
6. **NB-INTEL source_id filtering**: brief-interpreter cache regulatory facts in local PG → quanto è OK manifest contenga `regulation_id: PMK_12_2026` ma non `nb_source_uuid: xxx-yyy-zzz`?
