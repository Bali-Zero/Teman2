...
# Reachability report — rulepack-prod-007.source.json

Pack `453ee842-7f35-5d77-b460-31d67e2784c2` sequence **7** (version `2026.8.11`, environment `PRODUCTION`) — 38 products, 104 rules.

## Reachability

- **Reachable (has ≥1 SUPPORT rule): 27** — A1, B1, BRIDGING, C1, C2, C6, D1, D12, D2, E23, E28A, E30, E30A, E30B, E31A, E31B, E31C, E31D, E31E, E31F, E31G, E31H, E31J, E33, E33E, E33F, E33G
- **Blocked (zero SUPPORT rules): 11** — E23U, E23V, E28B, E28C, E28D, E28F, E30E, E30F, E33A, E33B, E33C

## Fact-path coverage

- 36/44 FactPaths referenced by at least one rule.
- **8 FactPaths referenced by zero rules**: commercial.service_fee_budget_idr, commercial.wants_quote, immigration.last_entry_date, intent.desired_entry_date, person.birth_date, process.application_channel, sponsor.type, work.employer_country_code
...
- 4 facts the interview DOES collect but this pack references in zero rules (collected data the pack does not yet use): person.birth_date, process.application_channel, sponsor.type, work.employer_country_code
