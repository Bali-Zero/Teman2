...
- **CL-E30-01 — E30 family index structure, per this EXTENSION's own answer.** `Kepmen
...
| 6 | `CL-E30-01` (this EXTENSION) describes E30A as "primary/secondary education"; the already-merged section's own `CL-E30F-01` describes E30A, in passing, as "academic research" — a genuine unflagged cross-document contradiction about what E30A covers | **FIXED, not silently resolved** — `CL-E30-01` now states this discrepancy explicitly and recommends a dedicated E30A doctrine-card query rather than asserting either description as settled |
