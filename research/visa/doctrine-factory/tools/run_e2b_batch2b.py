...
SELECTION_PATH = Path(__file__).parent.parent / "query-bank" / "e2b-batch2b-selection.json"
...
def main():
    ...
    summary_path = Path(__file__).parent.parent / "query-bank" / "e2b-batch2b-run-summary.json"
