...
Use spare capacity only after the five lanes above are registered and the active builder count is below four. Admit at most one preparation lane per packet and prefer new namespaced evidence files over shared code.
