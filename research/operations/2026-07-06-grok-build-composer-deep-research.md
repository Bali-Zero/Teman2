...
These are concrete, scoped proposals — **each requires Zero's explicit paid-API authorization before implementation**, per CLAUDE.md. None should be built during the trial week itself; they are what the trial's Day 7 verdict should be measured against.
