...
sources:
  ...
  - "PR #4216 adapter source head 0b8705527: Codex subscription adapter, offline harness, tests, CI, and ADR"
...
The selected adapter evidence is frozen at PR #4216 source head `0b8705527`. Live-path evidence was
...
- [x] #4194 threat/privacy addendum reconciled to source head `0b8705527`; its independent Kimi K3
...
`0b8705527` narrowed it to the intended future credential-path choice plus the current human-run
