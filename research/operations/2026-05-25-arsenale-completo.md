...
**ALWAYS** `from=zantara@balizero.com` / `name=Zantara` (alias di `zero@balizero.com`) via Brevo endpoint `/api/notifications/send-email` + `X-API-Key: REDACTED-ROTATED-KEY`. Mai `notifications@`, `subhi@`, personal addresses.
