...
async def test_llm_adapter():
    ...
    try:
        ...
        print(f"   📤 Test generazione: {'✅' if response.provider == LLMProvider.OLLAMA else '⚠️ Mock'}")
...
async def test_test_guardian():
    ...
    try:
        ...
        if text and len(text) > 10:
            ...
            print(f"   ⚠️  Generazione fallita o mock")
            return False
...
async def test_test_creator():
    ...
    try:
        ...
        if hasattr(creator, '_generate_test_skeleton'):
            ...
            if skeleton:
                print(f"   ✅ Generazione skeleton funziona!")
                return True
...
async def test_test_force_orchestrator():
    ...
    try:
        ...
        if result.get("success"):
            ...
            print(f"   ✅ Coverage scan funziona!")
