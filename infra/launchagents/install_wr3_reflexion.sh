...
TARGET_SCRIPT="/Users/nuzantara/nuzantara/scripts/wr3_reflexion_synthesis.py"
...
case "$MODE" in
    install)
        ...
        echo "[install] Manual run: WR3_REPO_ROOT=/Users/nuzantara/nuzantara \\"
        echo "            /Users/nuzantara/nuzantara/apps/backend-rag/.venv/bin/python \\"
        echo "            $TARGET_SCRIPT"
        ;;
    --uninstall)
        bootout
