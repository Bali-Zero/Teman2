# 🎨 TASK: Create Professional Visual Assets for KBLI Navigator

**For**: Claude Code
**Priority**: HIGH
**Deadline**: ASAP
**Skill Required**: `canvas-design`
...
**Dimensions**: 800x450px each (16:9 ratio)
...
- Accent cyan: `#6EC8D2` (glowing cyan)
...
- Depth & dimensionality (NOT flat design)
- Cinematic lighting (dramatic shadows, rim lights)

---

## 🖼️ IMAGE 1: HERO COVER (Most Important!)

### Concept: "Convergent Taxonomy - The Intelligent Puzzle"
...
- Each piece displays a **KBLI code** in glowing cyan typography:
  - "56101" (Restaurant)
  - "62191" (Software Development)
  - "47111" (Retail)
  - "10111" (Food Processing)
  - "85141" (Education)
...
- Gold surfaces show realistic reflections and specular highlights
...
- Atmospheric depth (darker at edges, slight glow at center)
...
## 🖼️ IMAGE 2: Article 1 - "KBLI 2025: What Changed"

### Concept: "Rising Evolution"
...
**Mood**: Progressive, forward-looking, data-driven

---

## 🖼️ IMAGE 3: Article 2 - "Risk Levels Explained"

### Concept: "Spectrum of Risk"
...
**Mood**: Informative, clear hierarchy, professional risk assessment

---

## 🖼️ IMAGE 4: Article 3 - "Finding Your Code in 30 Seconds"

### Concept: "Instant Discovery"
...
**Mood**: Discovery, speed, precision, user-friendly

---

## 🖼️ IMAGE 5: Podcast Cover - "KBLI 2025 Deep Dive"

### Concept: "Audio Intelligence"
...
**Mood**: Audio-focused, intelligent conversation, premium podcast
...
### Step 2: Create Hero Cover First (Priority #1)
...
- Test different code arrangements
...
### Step 4: Create Podcast Cover

Square format, but same design DNA.
...
- [ ] Cyan glows are subtle and elegant (not neon)
- [ ] Depth and dimensionality clear (3D feel)
...
- [ ] Sharp where needed, soft where intended
...
- [ ] Would look at home on balizero.com
...
4. **Cultural Memory**: Indonesian elements refined and sophisticated
5. **Premium Quality**: Museum-grade craftsmanship
...
- Automotive luxury (Tesla, Mercedes)
...
- Cheap 3D renders (needs premium quality)
- Stereotypical Indonesian imagery (no cliché temples/wayang)
...
**Create visual assets that will make balizero.com look like a premium fintech brand!**

---

**Task Created**: 2026-02-16
**For**: Claude Code
**By**: Claude Sonnet 4.5 (Cowork)
**Priority**: HIGH
