...
├── kbli-2025-hero-cover.png     ← Homepage hero
├── article-1-kbli-changes.png   ← Article 1
├── article-2-risk-levels.png    ← Article 2
├── article-3-finding-code.png   ← Article 3
└── podcast-kbli-2025.png        ← Podcast
```
...
Everything is prepared and tested. Just follow the deployment guide in `CONSOLIDATED-DEPLOYMENT-TASK.md` and you'll have a professional KBLI Navigator live on balizero.com within 30 minutes.

**Questions?** Check `INDEX.md` to find the right document.
