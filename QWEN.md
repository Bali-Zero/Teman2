...
| **DeepSeek v4-pro/v4-flash/v3.2** | IL SECONDO RAGIONATORE — reasoning second-opinion, refuter reserve (eligible_for_quorum: false)                                                   | PROBATION; riammesso da Zero 2026-08-10 (il ritiro 2026-07-19 fu morte economica del seat standalone 402, non un verdetto di qualita'); PII boundary invariato |
...
- PII cliente: MAI su questa ala (cloud CN/SG — UU PDP Law 2). Intake PII = SEA-LION/locale.
