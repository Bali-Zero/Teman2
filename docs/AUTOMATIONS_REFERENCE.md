...
> Generated: 2026-09-26 15:15 UTC
...
| `com.balizero.nlm-watchdog.6h`                                              | M5   | every 6h                                                               | One-shot every 6h: StartInterval, no KeepAlive (scar #7).                                                                                                        |
...
| `com.nuzantara.kbli-oss-refresh.weekly`                                     | Pro  | weekly Mon 09:40 WITA                                                  | cron-runner.sh - run a shell script from cron and emit a Cell-readable receipt.                                                                                  |
...
| ---------------------------------------- | ------------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ci-image-mirror.yml`                    | CI image mirror (GHCR)                                  | 17 3 * * 1            | WHY: CI `services:` pulled postgres:15/redis:7 ANONYMOUSLY from public.ecr.aws, whose anonymous data quota is shared per runner egress IP — 3 of 30 `Tests &...  |
...
> Ultimo aggiornamento sentinel: `2026-09-26T15:14:31Z`

| Metrica                   | Valore         |
| ------------------------- | -------------- |
| Circuit OPEN              | **0**          |
| Circuit TERMINAL          | **174**        |
| DLQ entries totali        | **0**          |
| DLQ phase distribution    | `TERMINAL=174` |
...
| ----------------------------------------------- | ---------------------- | ---------- | ---- | ------- | ----- | -------- |
| `ai.openclaw.gateway`                           | 🔄 Running (PID=937)   | —          | 0    | —       | —     |          |
| `ai.openclaw.node`                              | 🔄 Running (PID=1013)  | —          | 0    | —       | —     |          |
...
| `com.balizero.dropbox-intake`                   | 🔄 Running (PID=1022)  | —          | 0    | —       | —     |          |
...
| `com.balizero.meta-dispatcher`                  | 🔄 Running (PID=916)   | —          | 0    | —       | —     |          |
...
| `com.balizero.observatory-export`               | 🔄 Running (PID=80267) | —          | 0    | —       | —     |          |
...
| `com.balizero.translate.hourly`                 | 🔄 Running (PID=39474) | —          | 0    | —       | —     |          |
...
| `com.balizero.wa-mirror-auto-promote`           | 🔄 Running (PID=36864) | —          | 0    | —       | —     |          |
...
| `com.cell.organism`                             | 🔄 Running (PID=70323) | —          | -9   | —       | —     |          |
...
| `com.matagaruda.gap.consumer`                   | 🔄 Running (PID=16415) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.automap-telegram`                | 🔄 Running (PID=944)   | —          | 0    | —       | —     |          |
| `com.nuzantara.automap-watchdog`                | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.nuzantara.automations-reference`           | 🔄 Running (PID=80266) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.fly-logs-accumulator`            | 🔄 Running (PID=1020)  | —          | 0    | —       | —     |          |
...
| `com.nuzantara.intake-worker`                   | 🔄 Running (PID=954)   | —          | 0    | —       | —     |          |
...
| `com.nuzantara.memory-sync-bidirectional`       | 🔄 Running (PID=38227) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.ollama`                          | 🔄 Running (PID=31931) | —          | 0    | —       | —     |          |
| `com.nuzantara.openclaw-children-watchdog`      | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.nuzantara.openclaw-logrotate`              | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.nuzantara.openclaw-whatsapp-bridge`        | 🔄 Running (PID=974)   | —          | 0    | —       | —     |          |
| `com.nuzantara.openclaw-whatsapp-tunnel`        | 🔄 Running (PID=920)   | —          | 0    | —       | —     |          |
...
| `cron_state`          | every 5m (+22 more)       | 2026-09-26 23:15 | ? check   | —            | —     |          | [openclaw-bridge] Cannot read jobs.json: [Errno 2] |
...
| `run`                 | every 15m (+14 more)      | 2026-09-26 23:15 | ❌ FAIL   | —            | —     |          | 2026-09-26 23:15:07 [info ] check_now_done         |

---

_Generated by `scripts/generate_automations_reference.py` — 2026-09-26 15:15 UTC_
