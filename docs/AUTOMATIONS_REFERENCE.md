...
> Generated: 2026-05-23 15:15 UTC
...
> Ultimo aggiornamento sentinel: `2026-05-23T14:52:53Z`
...
| DLQ phase distribution    | `T0=5 · T4=5 · TERMINAL=53` |
...
| ------------------------------------------------ | ---------------------- | ---------- | ---- | ------- | ----- | -------- |
| `ai.openclaw.gateway`                            | 🔄 Running (PID=73429) | —          | 1    | —       | —     |          |
...
| `com.balizero.guardrails-daemon`                 | 🔄 Running (PID=54316) | —          | -15  | —       | —     |          |
...
| `com.balizero.intel-lake.shadow-validate.6h`     | ❌ FAILED (exit=1)     | —          | 1    | —       | —     |          |
...
| `com.balizero.wa-mirror-launcher`                | 🔄 Running (PID=14929) | —          | 0    | —       | —     |          |
| `com.balizero.wa-mirror-strategic-recap`         | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.balizero.wa-viewer`                         | 🔄 Running (PID=52209) | —          | 1    | —       | —     |          |
| `com.balizero.wr2.canva-apply`                   | ❌ FAILED (exit=-15)   | —          | -15  | —       | —     |          |
...
| `com.balizero.wr2.canva-renderer`                | ❌ FAILED (exit=3)     | —          | 3    | —       | —     |          |
...
| `com.balizero.wr2.e2e-probe.daily`               | ❌ FAILED (exit=1)     | —          | 1    | —       | —     |          |
...
| `com.balizero.wr2.measurer`                      | ❌ FAILED (exit=1)     | —          | 1    | —       | —     |          |
| `com.balizero.wr2.newsletter`                    | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.balizero.wr2.oracle`                        | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.balizero.wr2.pg-proxy`                      | 🔄 Running (PID=52218) | —          | 0    | —       | —     |          |
...
| `com.balizero.wr2.supervisor`                    | 🔄 Running (PID=71991) | —          | 1    | —       | —     |          |
| `com.balizero.wr2.supervisor-watchdog`           | 🔄 Running (PID=44557) | —          | -9   | —       | —     |          |
...
| `com.nuzantara.automations-reference`            | 🔄 Running (PID=16203) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.organism.supervisor`              | 🔄 Running (PID=54111) | —          | -15  | —       | —     |          |
| `com.nuzantara.outbox-prune.daily`               | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.nuzantara.outbox-prune.weekly`              | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.nuzantara.pg-organism-bridge`               | 🔄 Running (PID=67325) | —          | -15  | —       | —     |          |
...
| `auto_test`             | daily 18:15 UTC           | 2026-05-23 18:15 | ❌ FAIL | —              | —            |          | [2026-05-23 18:15:00] ❌ Test failures: agentic llm |
...
| `coverage_trend`        | daily 4:30 UTC            | 2026-05-23 04:30 | ? check | —              | LOCAL        |          | /Users/nuzantara/Desktop/nuzantara/apps/backend-ra  |
| `cron_agent`            | daily 1:10 UTC (+8 more)  | 2026-05-23 01:11 | ✅ OK   | —              | —            |          | [2026-05-23T01:11:37] [nlm-deep-research] OK durat  |
...
| `curiosity_loop`        | daily 20:42 UTC           | 2026-05-23 20:42 | ❌ FAIL | —              | —            |          | 2026-05-23 20:42:00,752 INFO nuzantara_graph.curio  |
| `docs_guardian`         | Sun 5:00 UTC              | 2026-04-26 05:00 | ❌ FAIL | —              | —            |          | /bin/bash: /Users/nuzantara/Desktop/nuzantara/scri  |
| `fly_backup`            | daily 3:00 UTC            | 2026-05-23 03:14 | ✅ OK   | —              | EXTERNAL     | 🔴       | [03:14:54] === Backup complete: PG ✅ Qdrant ✅ === |
| `fly_cost_alert`        | Mon 9:00 UTC              | 2026-05-18 09:00 | ? check | ✅ CLOSED/None | —            |          | [2026-05-18 09:00:01] Cost within budget ✅         |
| `genome_decay`          | daily 18:30 UTC           | 2026-04-29 18:30 | ❌ FAIL | —              | —            |          | /bin/bash: /Users/nuzantara/Desktop/nuzantara/scri  |
| `job_health`            | daily 9:00 UTC            | 2026-05-23 09:00 | ✅ OK   | —              | —            |          | ✅ t4-monitor healthy 2026-05-23 06:00              |
...
| `ollama_cron_window`    | daily 17:10 UTC (+1 more) | 2026-05-23 22:05 | ? check | —              | —            |          | [2026-05-23 22:05:00] No models loaded — nothing t  |
| `ollama_warm_pin`       | Sun 5:00 UTC              | 2026-05-17 05:00 | ✅ OK   | —              | —            |          | [2026-05-17T05:00:29] Warm-pin complete on Nuzanta  |
| `openclaw_state_bridge` | every 5m                  | 2026-05-23 23:15 | ? check | —              | —            |          | [openclaw-bridge] Written 24/24 state files         |
| `pro_heartbeat`         | 0 \* \* \* \*             |                  |         | —              | —            |          |                                                     |
| `ragas_eval`            | 5 22:30 UTC               | 2026-05-22 22:30 | ? check | —              | —            |          | [ragas-eval] 2026-05-22 22:30 WITA — similarity=0.  |
| `run`                   | every 15m (+14 more)      | 2026-05-23 23:15 | ❌ FAIL | —              | —            |          | 2026-05-23 23:15:00 [info ] check_now_start         |
| `sentry_quota_check`    | daily 9:00 UTC            | 2026-05-23 09:00 | ✅ OK   | —              | —            |          | [sentry-quota-check] OK                             |
| `sync_damar`            | 0 \* \* \* \*             |                  |         | —              | —            |          |                                                     |
| `sync_memory_ruslana`   | daily 8:00 UTC            | 2026-05-23 08:00 | ⚠️ WARN | —              | —            |          | [2026-05-23 08:00] Ruslana host unreachable — skip  |
...
| `homebrew.mxcl.postgresql@18`            | 🔄 Running (PID=91208) | —        | 0    | —       | —     |          |
...
| Job                      | Schedule       | Last Run         | Status  | Circuit | Scope | Critical | Notes                                               |
| ------------------------ | -------------- | ---------------- | ------- | ------- | ----- | -------- | --------------------------------------------------- |
| `crm_kg_build_mediated`  | every 6h (:0)  | 2026-05-23 18:00 | ✅ OK   | —       | —     |          | [2026-05-23 18:00:22] ✅ build-mediated OK: {"statu |
| `crm_kg_garbage_collect` | daily 3:00 UTC | 2026-05-23 03:00 | ✅ OK   | —       | —     |          | [2026-05-23 03:00:00] ✅ garbage-collect OK: {"stat |
| `drive_poll`             | every 5m       | 2026-05-23 23:15 | ❌ FAIL | —       | —     |          | [2026-05-23 23:10:37] ⚠️ Drive poll failed (HTTP 5  |

---

_Generated by `scripts/generate_automations_reference.py` — 2026-05-23 15:15 UTC_
