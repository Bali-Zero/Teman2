...
> Generated: 2026-09-21 15:15 UTC
...
> Ultimo aggiornamento sentinel: `2026-09-21T15:11:26Z`
...
| ----------------------------------------------- | ---------------------- | ---------- | ---- | ------- | ----- | -------- |
| `ai.openclaw.gateway`                           | 🔄 Running (PID=50735) | —          | 0    | —       | —     |          |
| `ai.openclaw.node`                              | 🔄 Running (PID=50471) | —          | -15  | —       | —     |          |
...
| `com.balizero.dropbox-intake`                   | 🔄 Running (PID=32689) | —          | 0    | —       | —     |          |
...
| `com.balizero.wa-mirror-auto-promote`           | 🔄 Running (PID=88122) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.automations-reference`           | 🔄 Running (PID=88421) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.intake-worker`                   | 🔄 Running (PID=14004) | —          | -11  | —       | —     |          |
...
| `com.nuzantara.memory-sync-bidirectional`       | 🔄 Running (PID=88614) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.openclaw-whatsapp-bridge`        | 🔄 Running (PID=50609) | —          | -15  | —       | —     |          |
| `com.nuzantara.openclaw-whatsapp-tunnel`        | 🔄 Running (PID=50491) | —          | 0    | —       | —     |          |
...
| `cron_state`          | every 5m (+22 more)       | 2026-09-21 23:15 | ? check   | —            | —     |          | [openclaw-bridge] Cannot read jobs.json: [Errno 2] |
...
| `run`                 | every 15m (+14 more)      | 2026-09-21 23:15 | ❌ FAIL   | —            | —     |          | 2026-09-21 23:15:04 [info ] check_now_done         |

---

_Generated by `scripts/generate_automations_reference.py` — 2026-09-21 15:15 UTC_
