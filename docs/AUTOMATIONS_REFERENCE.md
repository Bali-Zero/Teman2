...
> Generated: 2026-09-10 23:42 UTC
...
> Ultimo aggiornamento sentinel: `2026-09-10T23:35:10Z`

| Metrica                   | Valore         |
| ------------------------- | -------------- |
| Circuit OPEN              | **0**          |
| Circuit TERMINAL          | **141**        |
| DLQ entries totali        | **0**          |
| DLQ phase distribution    | `TERMINAL=141` |
...
| ----------------------------------------------- | ---------------------- | ---------- | ---- | ------- | ----- | -------- |
| `ai.openclaw.gateway`                           | 🔄 Running (PID=7977)  | —          | 0    | —       | —     |          |
| `ai.openclaw.node`                              | 🔄 Running (PID=7949)  | —          | -15  | —       | —     |          |
...
| `com.balizero.dropbox-intake`                   | 🔄 Running (PID=82726) | —          | 0    | —       | —     |          |
| `com.balizero.fly-cost-alert.weekly`            | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.balizero.guardrails-daemon`                | 🔄 Running (PID=1487)  | —          | 0    | —       | —     |          |
| `com.balizero.intel-dedup-gateway`              | 🔄 Running (PID=9964)  | —          | 1    | —       | —     |          |
| `com.balizero.intel-lake-nb-pusher.15min`       | ❌ FAILED (exit=2)     | —          | 2    | —       | —     |          |
...
| `com.balizero.nuzantara-drive-sync`             | 🔄 Running (PID=21932) | —          | 0    | —       | —     |          |
...
| `com.balizero.translate.hourly`                 | 🔄 Running (PID=27619) | —          | 1    | —       | —     |          |
...
| `com.nuzantara.automations-reference`           | 🔄 Running (PID=35345) | —          | 1    | —       | —     |          |
...
| `com.nuzantara.chatgpt-marketing-tunnel`        | 🔄 Running (PID=1468)  | —          | 0    | —       | —     |          |
...
| `com.nuzantara.memory-sync-bidirectional`       | 🔄 Running (PID=20170) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.openclaw-whatsapp-bridge`        | 🔄 Running (PID=7974)  | —          | -15  | —       | —     |          |
| `com.nuzantara.openclaw-whatsapp-tunnel`        | 🔄 Running (PID=7953)  | —          | 0    | —       | —     |          |
...
| `cron_state`          | every 5m (+22 more)       | 2026-09-11 07:40 | ? check   | —            | —     |          | [openclaw-bridge] Cannot read jobs.json: [Errno 2] |
...
| `run`                 | every 15m (+14 more)      | 2026-09-11 07:30 | ❌ FAIL   | —            | —     |          | 2026-09-11 07:30:05 [info ] check_now_done         |
...
| `com.nuzantara.mini-iqoo-radar-relay`        | 🔄 Running (PID=28264) | —        | 0    | —       | —     |          |
...
| ------------------------ | ------------------------ | ---------------- | ------- | ------- | ----- | -------- | -------------------------------------------------- |
| `Tailscale`              | * * * * *                |                  |         | —       | —     |          |                                                    |
| `crm_kg_build_mediated`  | every 6h (:0)            | 2026-09-11 06:00 |         | —       | —     |          |                                                    |
| `crm_kg_garbage_collect` | daily 3:00 UTC           | 2026-09-11 03:00 |         | —       | —     |          |                                                    |
| `cron_runner`            | daily 9:15 UTC (+2 more) | 2026-09-10 09:15 |         | —       | —     |          |                                                    |
| `drive_poll`             | every 5m                 | 2026-09-11 07:40 | ❌ FAIL | —       | —     |          | [2026-09-11 07:40:01] ⚠️ Drive poll failed (HTTP 4 |

---

_Generated by `scripts/generate_automations_reference.py` — 2026-09-10 23:42 UTC_
