...
> Generated: 2026-09-22 15:15 UTC
...
> Ultimo aggiornamento sentinel: `2026-09-22T15:14:12Z`
...
| ----------------------------------------------- | ---------------------- | ---------- | ---- | ------- | ----- | -------- |
| `ai.openclaw.gateway`                           | 🔄 Running (PID=88239) | —          | 0    | —       | —     |          |
| `ai.openclaw.node`                              | 🔄 Running (PID=88125) | —          | -15  | —       | —     |          |
...
| `com.balizero.dropbox-intake`                   | 🔄 Running (PID=37536) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.automations-reference`           | 🔄 Running (PID=37719) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.chatgpt-marketing-tunnel`        | 🔄 Running (PID=15705) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.intake-worker`                   | 🔄 Running (PID=1274)  | —          | -6   | —       | —     |          |
...
| `com.nuzantara.merge-train`                     | 🔄 Running (PID=37861) | —          | 0    | —       | —     |          |
...
| `com.nuzantara.ollama`                          | 🔄 Running (PID=40846) | —          | 0    | —       | —     |          |
| `com.nuzantara.openclaw-children-watchdog`      | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.nuzantara.openclaw-logrotate`              | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.nuzantara.openclaw-whatsapp-bridge`        | 🔄 Running (PID=88225) | —          | -15  | —       | —     |          |
| `com.nuzantara.openclaw-whatsapp-tunnel`        | 🔄 Running (PID=88149) | —          | 0    | —       | —     |          |
...
| `cron_state`          | every 5m (+22 more)       | 2026-09-22 23:15 | ? check   | —            | —     |          | [openclaw-bridge] Cannot read jobs.json: [Errno 2] |
...
| `run`                 | every 15m (+14 more)      | 2026-09-22 23:15 | ❌ FAIL   | —            | —     |          | 2026-09-22 23:15:01 [info ] check_now_done         |
...
| `com.nuzantara.healer.4h`                    | 🔄 Running (PID=62333) | —        | 0    | —       | —     |          |
...
| ------------------------ | ------------------------ | ---------------- | ------- | ------- | ----- | -------- | -------------------------------------------------- |
| `Tailscale`              | * * * * *                |                  |         | —       | —     |          |                                                    |
| `crm_kg_build_mediated`  | every 6h (:0)            | 2026-09-22 18:00 |         | —       | —     |          |                                                    |
| `crm_kg_garbage_collect` | daily 3:00 UTC           | 2026-09-22 03:00 |         | —       | —     |          |                                                    |
| `cron_runner`            | daily 9:15 UTC (+2 more) | 2026-09-22 09:15 |         | —       | —     |          |                                                    |
| `drive_poll`             | every 5m                 | 2026-09-22 23:15 | ❌ FAIL | —       | —     |          | [2026-09-22 23:15:02] ⚠️ Drive poll failed (HTTP 4 |

---

_Generated by `scripts/generate_automations_reference.py` — 2026-09-22 15:15 UTC_
