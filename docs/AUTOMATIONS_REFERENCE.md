...
> Generated: 2026-05-06 12:35 UTC
...
> Ultimo aggiornamento sentinel: `2026-05-06T12:17:10Z`
...
| DLQ phase distribution    | `T0=3 · T4=57 · TERMINAL=3` |
...
| --------------------------------------------- | ---------------------- | ---------- | ---- | ------- | ----- | -------- |
| `ai.openclaw.gateway`                         | 🔄 Running (PID=95408) | —          | 1    | —       | —     |          |
...
| `com.balizero.wr2.canva-apply`                | 🔄 Running (PID=92359) | —          | 0    | —       | —     |          |
...
| `com.balizero.wr2.pg-proxy`                   | 🔄 Running (PID=40190) | —          | 0    | —       | —     |          |
| `com.balizero.wr2.sla-worker`                 | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.balizero.wr2.strategos`                  | ✅ OK                  | —          | 0    | —       | —     |          |
| `com.balizero.wr2.supervisor`                 | 🔄 Running (PID=66755) | —          | 1    | —       | —     |          |
...
| `auto_test`             | daily 18:15 UTC           | 2026-05-06 18:15 | ❌ FAIL   | —            | —            |          | [2026-05-06 18:15:00] ❌ Test failures: agentic llm |
...
| `curiosity_loop`        | daily 20:30 UTC           | 2026-05-06 20:30 | ❌ FAIL   | —            | —            |          | 2026-05-06 20:30:02,755 INFO nuzantara_graph.curio  |
...
| `ollama_cron_window`    | daily 17:10 UTC (+1 more) | 2026-05-06 17:10 | ? check   | —            | —            |          | [2026-05-06 17:10:00] Qwen model available          |
| `ollama_warm_pin`       | Sun 5:00 UTC              | 2026-05-06 20:29 | ✅ OK     | —            | —            |          | [2026-05-06T20:29:43] Warm-pin complete on Nuzanta  |
| `openclaw_state_bridge` | every 5m                  | 2026-05-06 20:35 | ? check   | —            | —            |          | [openclaw-bridge] Written 24/24 state files         |
...
| `run`                   | every 15m (+14 more)      | 2026-05-06 20:30 | ❌ FAIL   | —            | —            |          | 2026-05-06 20:30:04 [info ] check_now_done          |
...
_Generated by `scripts/generate_automations_reference.py` — 2026-05-06 12:35 UTC_
