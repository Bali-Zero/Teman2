...
| `utils/wa-deeplink.ts`              | nuovo                  | costruttore deeplink `wa.me/6282210302328?text=...` context-aware                            |
...
- Sticky bottom `CTAHandoff` — 3 livelli: `Scarica report PDF` (lead magnet gratis) → `Chatta con Zantara` (self-service) → `Parla su WhatsApp` (vero conversion CTA, deeplink canonico `+6282210302328` con context pre-riempito)
