...
- **Closing page**: dark brand surface, contacts large, generated **WhatsApp QR code** linking `wa.me/6282264599868` (libqrencode SVG, generated inline in script)
...
- **Client send:** PDF attached via WhatsApp `+62 822 6459 9868` or email `zero@balizero.com`.
...
- WhatsApp number `+62 822 6459 9868` was given by user on 2026-05-06; the previous brand book had `+62 813 3805 1876`. **User decision is the final word.** Generator uses the new number. ⚠️ Please double-check this number before render — different formatting interpretations are possible (10 digits after +62 ID code).
