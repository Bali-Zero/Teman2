...
**Architecture:** Ogni funnel diventa `<FunnelFrame funnel="…" sessionId={…}><ToolBody /></FunnelFrame>`. Il session_id generato da `getOrCreateSessionId()` (lato client) e `attachToServerSession({funnel})` chiamato al mount. CTAHandoff preconfigurato con canonical WA `+6282210302328`.
  ...
  return (
    <>
      <NavShell
        ...
        actions={
          <a href="https://wa.me/6282210302328" className="btn btn-primary">
            WhatsApp
          </a>
        }
      />
      ...
      >
        {filtered.map((d) => (
          ...
          >
            ...
            <a
              href="https://wa.me/6282210302328?text=Delega%20Bali%20Zero%20SPT"
