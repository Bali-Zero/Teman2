...
```json
{
  ...
  "metadata": {
    ...
    "contact": {
      ...
      "wa_link": "https://wa.me/6282264599868",
...
Expected: `Total services: 80` (give or take 2 — the count is approximate), all 10 categories listed, WhatsApp `+62 822 6459 9868`.
...
categories, contacts updated to zero@balizero.com / +62 822 6459 9868 /
...
Scan the QR code on the PDF closing page with a phone camera. It should open WhatsApp to a chat with `+62 822 6459 9868` (the canonical contact).
