...
| ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Effect schema      | `backend/db/migrations_v2/249_worker_effect_ledger.sql`, `backend/worker_plane/effects.py`, `effect_ledger.py`                                                    | Stable effect projection, append-only attempts, resolution audit, and late-fence transitions.                                                            |
