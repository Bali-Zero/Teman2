...
**Why:** Oggi i link WhatsApp sono hardcoded `https://wa.me/6282230102328?text=Hi%20Bali%20Zero...` ovunque. Senza UTM, ogni lead WhatsApp arriva senza context "da quale pagina veniva". Helper centralizza + aggiunge UTM.
...
- Modify: any other file with `wa.me/6282230102328` hardcoded
...
```bash
cd /Users/nuzantara/Desktop/nuzantara/apps/mouth
grep -rn "wa.me/6282230102328" src/ 2>/dev/null
```
...
```tsx
<a href="https://wa.me/6282230102328?text=Hi%20Bali%20Zero%2C%20I%20would%20like%20to%20get%20started.">
```
...
Open `http://localhost:3000` in browser. Hover the "Get Started" header button → check status bar shows `wa.me/6282230102328?text=...&utm_source=balizero_web&utm_medium=whatsapp_cta&utm_campaign=home`.
