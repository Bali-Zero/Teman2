...
2349:X_API_KEY = os.environ.get("NOTIFICATIONS_X_API_KEY", "zantara-secret-2024")
...
/bin/zsh -lc "nl -ba apps/backend-rag/backend/migrations/migration_119_partners.py | sed -n '1,260p'" in /Users/nuzantara/Desktop/partners-spec-wt
 ...
 succeeded in 0ms:
    ...
    44	)
    45	X_API_KEY = os.environ.get("NOTIFICATIONS_X_API_KEY", "zantara-secret-2024")
    46	
    47	
    48	# ─── Internal helpers ───────────────────────────────────────────────────────
    49	
