...
**Fix:** drop the `or admin` fallback; require explicit `finance.mark_paid` permission bit. Seed that permission for Zero, Zero, Asya as part of migration 119. **~15 min.**
