...
The Layer 26 memory mentions AHU "on-demand" as a scheduling _hint_ (not on a fixed schedule). That's OK. What triggers a HALT: any phrase like "never from batch", "AHU exclusion", "deliberately skip AHU".
...
<html lang="id">
  <head>
    <title>AHU Search Results (fixture)</title>
  </head>
  <body>
