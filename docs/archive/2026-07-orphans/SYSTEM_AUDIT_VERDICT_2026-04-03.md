...
| ----- | ---------------------------------------------------------------------------- | --------------- | --------- | ----------------------------- |
| NEW-1 | **`REDACTED-ROTATED-KEY` hardcoded in 16 file** come default fallback         | Gemini          | CRITICO   | SI (16 occorrenze in 15 file) |
...
| --- | --------------------------------------------------------------------------- | ------ | ------- |
| 1   | **Rimuovere `REDACTED-ROTATED-KEY`** default da 16 file (NEW-1)              | 1h     | Basso   |
