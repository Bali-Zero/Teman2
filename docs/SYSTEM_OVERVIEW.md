...
_Originally auto-generated by The Scribe on 2026-02-02 02:57:08_
...
- `/clients/{client_id}/drive-folder`
...
- `/clients/{client_id}/drive-folder`
- `/clients/{client_id}/drive-folder/stats`
- `/clients/{client_id}/drive-folder/structure`
- `/clients/{client_id}/drive-folder/{folder_name}/files`
- `/migration/clients-summary`
- `/migration/documents-by-client/{client_id}`
- `/migration/status`
...
- `/api/intel/store`
- `/clients/{client_id}/create-drive-folder`
- `/clients/{client_id}/drive-folder/{folder_name}/upload`

**PUT:**

- `/api/intel/staging/{type}/{item_id}`

### Article Composer (6 endpoints)
...
### Knowledge Graph RAG (4 endpoints)
...
### Messaging Identity Admin (6 endpoints)
...
### admin-team-activity (6 endpoints)
...
### knowledge-activity (1 endpoints)
...
- Captures request/response deta...
