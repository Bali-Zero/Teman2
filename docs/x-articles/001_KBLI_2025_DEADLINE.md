# KBLI 2025: The Clock Is Ticking

**Updated March 2026** | Reading time: 14 minutes

---

Indonesia's entire business classification system is being rewritten. Every company operating in the country --- from a single-person consulting outfit in Bali to a multinational manufacturing plant in Karawang --- must migrate to the new KBLI 2025 framework before **June 18, 2026**. Miss the deadline, and your business licensing through the OSS-RBA system becomes structurally invalid. This is not a routine paperwork update. It is the most significant reclassification of Indonesian commerce in five years, touching 1,563 activity codes across 87 economic sectors.
...
The dataset is definitive: **1,563 business activity codes**, sourced from both BPS Regulation 7/2025 (activity definitions) and PP 28/2024 (licensing metadata). Of these, 1,552 codes carry both classification data and licensing requirements. Each code maps to specific risk categories, license types, processing timelines, and authority jurisdictions.

This is not a cosmetic renumbering. KBLI 2025 introduces entirely new activity categories that did not exist in KBLI 2020, while restructuring how existing activities are classified, licensed, and supervised.

---

## The Numbers: A Statistical Portrait of KBLI 2025
...
## The New Codes: Where 2025 Diverges from 2020

The most consequential change in KBLI 2025 is the introduction of activity codes for industries that did not have formal classifications under KBLI 2020. Indonesia's regulatory philosophy is explicit: if there is no KBLI code for what you do, you cannot obtain a license for it.

### Digital Economy and Platform Intermediation

KBLI 2025 introduces a systematic framework for **platform intermediation** (jasa intermediasi), creating dedicated codes for businesses that connect buyers and sellers without holding inventory:

- **47901** --- Digital Platform for Retail Intermediation
- **55400** --- Accommodation Intermediation Services (the "Airbnb code")
- **56400** --- Food & Beverage Intermediation Services (the "GoFood/GrabFood code")
- **68210** --- Real Estate Intermediation Services
- **52319** --- Freight Transport Intermediation
- **52329** --- Passenger Transport Intermediation

Under KBLI 2020, platform businesses had to shoehorn themselves into general IT or trade categories. Under KBLI 2025, they have purpose-built codes with calibrated risk levels and specific licensing requirements. A food delivery platform in Bali previously classified under a generic trade code can now register under 56400 with a regulatory framework designed for its actual operations.
...
- **60102** --- Digital Radio Broadcasting
- **60202** --- Digital Television Broadcasting

The media sector's digital transition now has its own classification, separating digital broadcasters from their analog predecessors for the first time.
...
Accommodation (55xxx codes), certain food & beverage activities, media, transportation, and education carry foreign ownership caps ranging from 49% to 67%. Villa operations under **55203** (Aktivitas Vila) are further complicated in Bali by **Perda 4/2026**, which criminalizes conversion of protected agricultural land (LP2B) into commercial properties.

**Closed Sectors:**

Alcohol retail, gambling, certain traditional industries, and activities explicitly reserved for cooperatives or MSMEs remain closed to foreign ownership.

---

## The OSS-RBA Gap: A Transition in Transition

Here is the operational reality that catches businesses off guard: as of March 2026, **OSS-RBA has not yet fully integrated KBLI 2025 codes into its system**.
...
- **BKPM coordination letters** for PT PMA investment approval are being issued with KBLI 2025 references

The regulatory intent is clear even if the digital infrastructure is still being updated. Companies that wait until June 2026 expecting a seamless online migration will likely face bottlenecks.

---

## Risk-Based Licensing: How KBLI 2025 Determines Your Permit Path

Every KBLI code maps to a risk-based licensing tier under PP 5/2021. The tier determines what documents you need, how long approval takes, and which government authority handles your application.
...
**What you need:** NIB + Sertifikat Standar (Standard Certificate)
**Processing:** Automatic
**Authority:** Bupati/Walikota
**Examples:** AI development (62194), cloud hosting (63102), app development (62193), restaurant operations at small-medium scale

The Standard Certificate is a self-declaration that your business meets the operational standards for its activity type. It is submitted alongside the NIB application and processed automatically. You declare compliance; the government retains the right to audit.

### Tier 3: Medium-High Risk (Menengah Tinggi) --- 905 Pairs

**What you need:** NIB + Sertifikat Standar (with verification)
**Processing:** 7 days
...
**What you need:** NIB + Izin (specific permits)
**Processing:** 15-60 days, varies significantly
**Authority:** Typically Minister/Agency Head
**Examples:** Mining, financial services, healthcare, alcohol distribution, broadcasting

High-risk activities require sector-specific permits beyond the standard NIB + certificate framework. These are reviewed by the relevant ministry (e.g., mining permits by ESDM, financial licenses by OJK, health licenses by Kemenkes).
...
## The Migration Playbook: A Practical Checklist

For companies that need to migrate, the process involves five steps:
...
- Codes that no longer exist (requires selecting a new activity entirely)
...
### Step 3: Review Foreign Ownership Implications

If you are a PT PMA, verify that the new KBLI 2025 codes still permit your ownership structure. The investment restrictions in PP 5/2021 apply to KBLI 2025 codes, and some reclassifications may change the ownership cap or conditions for your activities.
...
- Estimated cost: **IDR 3,000,000 -- 7,000,000** for the notarial process depending on complexity
- Timeline: **2-4 weeks** for the complete amendment process

### Step 5: Update NIB and Downstream Licenses

Once the akta is updated, the NIB must be amended through OSS-RBA. All downstream licenses (Sertifikat Standar, specific Izin, sector permits) will need to reference the new KBLI 2025 codes. For PT PMA companies, the BKPM investment registration should also be updated.

---

## Sector Spotlight: The 285 Trade Codes
...
- **Specialized retail** categories have been expanded (cosmetics, electronics, automotive parts each have dedicated codes)

For a PT PMA operating an e-commerce business in Bali, the correct code selection between 47911 (own-inventory online retail) and 47901 (marketplace/platform intermediation) determines the risk tier, the licensing requirements, and potentially the foreign ownership conditions.

---

## Sector Spotlight: Technology and Professional Services
...
- **62193** --- Technology-based application development
- **62194** --- AI component development
- **62199** --- Other computer programming
...
- **62204** --- IoT consulting and design
- **62209** --- Other IT consulting and facilities management

These carry Medium-High risk with 7-day processing. The higher risk classification reflects the government's view that these activities handle sensitive data or critical infrastructure.

---

## The Hospitality Trap: 15 Accommodation Codes
...
4. IMB/PBG (building permit) --- now under scrutiny with Perda 4/2026
5. Environmental assessment if in a sensitive zone

Operators who previously registered under generic accommodation codes must now select the specific sub-category. The wrong code selection can trigger audit flags, especially under Bali's intensified zoning enforcement.

---

## What KBLI 2025 Signals About Indonesia's Economic Direction

Step back from the technical details and the regulatory architecture reveals Indonesia's economic strategy:
...
**4. ASEAN harmonization.** KBLI 2025 moves closer to international standard industrial classification (ISIC Rev. 4), facilitating cross-border investment reporting and trade statistics within ASEAN economic integration frameworks.

---

## Timeline: The 82 Days Remaining
...
Companies with multiple KBLI codes, complex ownership structures, or activities in restricted sectors should budget **8-12 weeks** for the complete migration. That window is closing.

---

## Frequently Asked Questions

### What is KBLI 2025 and why does it matter for my Indonesian company?

KBLI 2025 is the new Indonesian Standard Industrial Classification system, enacted through Peraturan BPS Nomor 7 Tahun 2025. It replaces KBLI 2020 and defines the 1,563 business activity codes that determine what your company can legally do, what licenses you need, and which government authority supervises your operations. Every company registered in Indonesia --- both local (PT) and foreign-owned (PT PMA) --- must update its business classification to KBLI 2025 codes before June 18, 2026. The codes directly affect your NIB, your OSS-RBA licensing, your tax classification (KLU), and your ability to modify or expand your business activities.

### What is the exact deadline for KBLI 2025 migration?

The compliance deadline is **June 18, 2026**. After this date, business licensing through OSS-RBA will only recognize KBLI 2025 codes. Companies still referencing KBLI 2020 codes will be unable to process license renewals, modifications, or new activity additions through the system. The deadline applies to all company types: PT, PT PMA, CV, and individual businesses (perorangan) registered in OSS.

### How many new codes were introduced in KBLI 2025?

KBLI 2025 contains 1,563 total activity codes across 87 economic sectors. While many codes are direct equivalents of KBLI 2020 classifications, the new framework introduces purpose-built codes for digital platform intermediation (at least 15 new intermediasi codes), artificial intelligence development (62194), cybersecurity (62201-62204), digital financial assets (66113, 66123), and digital broadcasting (60102, 60202). Additionally, several broad KBLI 2020 categories have been split into more granular codes --- for example, accommodation now has 15 specific codes from five-star hotels to camping grounds.

### Can foreign-owned companies (PT PMA) still get 100% ownership under KBLI 2025?

Yes, many KBLI 2025 codes remain fully open (TERBUKA) to 100% foreign ownership. Key examples include management consulting (70209), software development (62199), AI development (62194), cloud infrastructure (63102), online retail (47911), and real estate services (68201+). The investment conditions under PP 5/2021 still apply: minimum total investment of IDR 10 billion (~USD 625,000) and paid-up capital of IDR 2.5 billion per shareholder. However, some codes carry ownership restrictions. Accommodation, media, transportation, and certain food & beverage activities have foreign ownership caps ranging from 49% to 67%. Always verify the specific investment conditions for your KBLI code through OSS-RBA or BKPM.

### What happens if I do not migrate before the deadline?

Non-compliance creates cascading operational problems. Your NIB, which references KBLI 2020 codes, will become structurally incompatible with OSS-RBA once the system completes its transition. This means you cannot: renew existing licenses, add new business activities, modify your company structure, or apply for sector-specific permits. Banks may flag your corporate account during compliance checks. Your KLU tax classification may fall out of sync with the new KBLI mapping, potentially triggering audit flags under Coretax. Formal sanctions under PP 5/2021 include written warnings, administrative fines, temporary suspension of business activities, and ultimately license revocation.

### How much does the KBLI migration process cost?

The migration cost depends on complexity. For a company with 1-3 KBLI codes and no ownership structure complications, expect approximately **IDR 3,000,000 to 7,000,000** for the notarial deed amendment, AHU registration, and NIB update. Companies with complex structures --- multiple codes, restricted activities, changes in ownership percentages --- may incur additional costs for legal review and BKPM coordination. The OSS-RBA system itself does not charge migration fees; the costs are for the notarial and legal administrative process.

### Is OSS-RBA already updated to accept KBLI 2025 codes?

As of March 2026, OSS-RBA is still in the process of integrating KBLI 2025 codes into its system. New company registrations using KBLI 2025 codes may require manual processing at DPMPTSP (Dinas Penanaman Modal dan Pelayanan Terpadu Satu Pintu) offices. Companies should prepare migration documentation now and coordinate with their local DPMPTSP for the most current processing status. The BPS regulation is in force regardless of OSS system readiness.
