...
| **Cross-family refuter** (floor 2 only, one seat) | Codex Spark · Gemini Flash via `agy` — whichever probes live first                                                                                                                                                                                                             | The Dux                                                             | One cheap adversarial read of the FROZEN diff, after push                                                                                                                     | Editing the diff; being the builder of any slice in it; growing into a council                                  |
