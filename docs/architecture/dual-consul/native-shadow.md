...
synthetic text consumer. It follows the pinned
[common contract](https://github.com/Bali-Zero/Teman2/blob/d48f57d38d365b52b16eeac99b70a3615f877e2a/docs/architecture/dual-consul/common-contract.md)
and [Astra specification](https://github.com/Bali-Zero/Teman2/blob/d48f57d38d365b52b16eeac99b70a3615f877e2a/docs/architecture/dual-consul/astra-native.md).
It does not qualify operational
...
This package targets `main` at `cb322979455aff66459c1bd3b6b17d1b20df9370` and
supersedes the feature-base packaging in PR #5832, which the existing protected
base-branch check rejected. It includes the native consumer and its required
pure admission contracts; PostgreSQL, lifecycle, MIR, and the four parent design
documents are not copied into this diff. PR #5825 remains the first-merge
dependency because its admission module and test also appear here. The eleven
review-bound source/test hashes are unchanged; `c03b182fcd` below identifies the
historical probe source, not this package's base or final commit.
...
The separate rerun in `infra-consul-native-main` passed **125 tests in 3.31s**;
Ruff passed on all ten new Python files. Its receipt is retained in the
[main-base evidence pack](../../../evidence/2026-09/agent-air-m5-infra-consul-native-main-9d42c5a0/pack.yml)
without changing the historical validation JSON.
The
