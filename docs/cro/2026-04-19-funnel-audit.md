...
- Endpoint `https://nuzantara-rag.fly.dev/api/analytics/revenue?period=30d` e `/api/analytics/completion-rates?period=30d` (header `X-API-Key: REDACTED-ROTATED-KEY`)
