...
Riferimento test: tests/test_registry.py (da creare in Sprint 1)

Status: POC reference code, NON ancora installabile.
"""
...
# Convenience decorators (esposti come API pubblica del modulo)
