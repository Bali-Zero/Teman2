...
2. After 24h, verify on Pro Mac:
   ...
   p = '/Users/nuzantara/nuzantara/scripts/nuzantara-sentinel.py'
...
1. Add to user crontab on Pro:
   ...
   30 4 * * 1-6 /bin/bash /Users/nuzantara/scripts/cron-runner.sh /Users/nuzantara/nuzantara/apps/evaluator/nlm_deep_research/scripts/run_canary_all.sh >> /tmp/cron-canary.log 2>&1
   ```
...
1. Add cron on Pro:
   ...
   0 6 * * * /bin/bash /Users/nuzantara/scripts/cron-runner.sh /Users/nuzantara/nuzantara/apps/evaluator/cep/run_cep_daily.sh >> /tmp/cron-cep.log 2>&1
   ```
...
3. Schedule cron:
   ...
   30 3 * * 1-6 /bin/bash /Users/nuzantara/scripts/cron-runner.sh /Users/nuzantara/nuzantara/scripts/nlm_shadow_run_all.sh >> /tmp/cron-shadow-extractor.log 2>&1
   ```
