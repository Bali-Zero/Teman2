...
We are to output to docs/audits/2026-04-29-zero-crash-audit/ as a dedicated section. The user is Zero/Zero, not a developer. So our output should be clear with guardrails.
