...
**The pattern:** every failure was either silent or had a misleading first signal. The user (Zero) would have seen "completed exit 0, file 0 bytes" and not known what to do.
