...
| final gate | opus-5 | window | serial | 1 | <command> | <next> |
## Termination
...
- Your FINAL gate row in Tactics: the seat cell names `opus-5` (`Opus 5` and `fresh opus-5 xhigh`
  read as the same entity) and the mode cell contains the word `window` (C5). List pre-gates
