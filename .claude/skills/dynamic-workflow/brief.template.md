...
F1. PARABELLUM, first 36 h (2026-09-10/12): 111 PRs merged; 29% ledger/gate ceremony PRs; 60 of
300 harness-floor runs came back red; 0 ORANGE missions; 2 customer-visible results.
(source: docs/rules/RULINGS.md:106, SAETTA 2026-09-12 retrospective — 111 PRs, the 32/111
...
`PENDING-ARMS.md` since 09-12, 5 healer-tick closes landed on 09-16 alone.
...
research/operations/2026-09-07-astra-operative-workflow-audit.md — 113-agent run composition
