...
`jury/mapping.json` is never required and never copied. Refuses before creating anything: exit
...
refusal, ledger tamper detection. `scripts/tests/test_dynamic_workflow.py` (pytest,
