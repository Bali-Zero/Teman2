...
The instance was cured by #3265. This file exists because curing an instance
does not cure a class: nothing stopped the next module-level `chdir` from being
written, and the shape is attractive enough that it had already been written
once with a comment claiming it was needed for imports.
