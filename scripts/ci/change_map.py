...
SCRIPTS_COUPLING: frozenset[str] = frozenset(
    (
        ...
        "scripts/sota_literature_research.py", "scripts/suite_growth_probe.py", "scripts/sync_frontend_prices.py", "scripts/sync_kbli_dataset.sh", "scripts/test_cron_single_voice.sh", "scripts/tests/test_adversarial_review_gate.py", "scripts/tests/test_install_claude_code_version_skew.sh", "scripts/tests/test_intake_dsn_guard_covers_every_var.py",
        "scripts/tests/test_kbli_68112_pp28_mice_collision.py", "scripts/tests/test_merah_putih_day_contrast.py", "scripts/tests/test_pytest_verbosity_guard.py", "scripts/tests/test_test_deps_declared.py", "scripts/tg_notify.py", "scripts/token_lint.py", "scripts/tp1_call.py", "scripts/translate-articles-cron-wrapper.sh", "scripts/vercel_prod_deploy.py", "scripts/wa_codex_seat_probe.py",
        "scripts/wa_media_pull_worker.py", "scripts/wa_mirror_intake_sweeper.py", "scripts/whatsapp_export_backfill/import_staging.py", "scripts/wr2-cron-wrapper.sh", "scripts/wr2_bootstrap_canva_oauth.py", "scripts/wr2_canva_pdf_render.py", "scripts/wr2_daily_reconciler.py", "scripts/wr2_damar_publish_consumer.py", "scripts/wr2_draft_generator.py", "scripts/wr2_fact_checker.py",
        "scripts/wr2_fact_extractor.py", "scripts/wr2_html_render_apply.py", "scripts/wr2_ig_profile_harvester.py", "scripts/wr2_ig_publish.py", "scripts/wr2_image_generator.py", "scripts/wr2_queue_writer.py", "scripts/wr2_rerender_requeue.py", "scripts/wr2_supervisor.py", "scripts/wr2_topic_selector.py", "scripts/wr2_validate_master.py", "scripts/wr3_supervisor.py",
    )
)
