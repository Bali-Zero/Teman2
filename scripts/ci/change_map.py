...
SCRIPTS_COUPLING: frozenset[str] = frozenset(
    (
        ...
        "scripts/kbli_apply_en_titles.py", "scripts/kbli_dataset_lint.py", "scripts/kbli_filiera/_coverage_basis.py", "scripts/kbli_filiera/_whatchanged_basis.py", "scripts/kbli_filiera/apply_perpres_foreign_caps.py", "scripts/kbli_filiera/apply_residual_open.py", "scripts/kbli_filiera/cure_canonical_collisions.py", "scripts/kbli_filiera/cure_l23_whatchanged_language.py",
        "scripts/kbli_filiera/cure_l4bali_hold_review.py", "scripts/kbli_filiera/editorial_record_conformance.py", "scripts/kbli_filiera/emit_batch_membership.py", "scripts/kbli_filiera/gold_risk_dispute_relation.py", "scripts/kbli_filiera/perpres_body_default_relation.py", "scripts/kbli_filiera/perpres_slice_disclosure_relation.py", "scripts/kbli_filiera/tests/test_pma_zero_cap_basis.py",
        "scripts/kbli_filiera/tests/test_withdrawn_umkm_inference_absent.py", "scripts/lead_intent_matcher.py", "scripts/lib/codex_seat.py", "scripts/lib/codex_seat.sh", "scripts/lib/heartbeat.py", "scripts/lib/yaml_strict.py", "scripts/lint/lint_claude_headless_model_pin.py", "scripts/lint_avatar_url_validators.py", "scripts/lint_content_reasoning_leak.py", "scripts/lint_home_fork.py",
        "scripts/lint_i18n_providers.sh", "scripts/lint_migration_numbers.py", "scripts/lint_tcc_desktop_paths.py", "scripts/lint_telegram_tokens.py", "scripts/lint_test_reward_hacking.py", "scripts/mata_garuda_invalidation_sweep.py", "scripts/metabolic_rollup.py", "scripts/nlm_shadow_extractor.py", "scripts/openclaw_whatsapp_bridge.py", "scripts/patch_pricing_contact_block.py",
        "scripts/pending_arms_report.py", "scripts/pg-to-organism-bridge.py", "scripts/pg.sh", "scripts/portal_challenge_leaderboard.py", "scripts/pricelist_2026/schema.py", "scripts/probes/intel_lake_e2e_probe.py", "scripts/provision_zantara_codex.sh", "scripts/pytest_guards/pytest_verbosity_guard.py", "scripts/rag_canary.py", "scripts/repair_description_fields.py",
        "scripts/repair_swallowed_titles.py", "scripts/s7_yield_dispatch.py", "scripts/scrape_competitor_serp.py", "scripts/sentinel_lib/__init__.py", "scripts/sentinel_lib/alerter.py", "scripts/sentinel_lib/circuit_breaker.py", "scripts/sentinel_lib/classifier.py", "scripts/sentinel_lib/escalations.py", "scripts/sentinel_lib/guardrail_liveness.py", "scripts/sentinel_lib/incident_detector.py",
        "scripts/sentinel_lib/metrics.py", "scripts/sentinel_lib/repairer.py", "scripts/sentinel_lib/zombie_hunter.py", "scripts/sentry-quota-check.sh", "scripts/setup_chatgpt_marketing_tunnel.sh", "scripts/sota_infer_personas.py", "scripts/sota_literature_research.py", "scripts/suite_growth_probe.py", "scripts/sync_frontend_prices.py", "scripts/sync_kbli_dataset.sh",
        "scripts/test_cron_single_voice.sh", "scripts/tests/test_adversarial_review_gate.py", "scripts/tests/test_install_claude_code_version_skew.sh", "scripts/tests/test_intake_dsn_guard_covers_every_var.py", "scripts/tests/test_kbli_68112_pp28_mice_collision.py", "scripts/tests/test_merah_putih_day_contrast.py", "scripts/tests/test_pytest_verbosity_guard.py",
        "scripts/tests/test_test_deps_declared.py", "scripts/tg_notify.py", "scripts/token_lint.py", "scripts/tp1_call.py", "scripts/translate-articles-cron-wrapper.sh", "scripts/vercel_prod_deploy.py", "scripts/wa_codex_seat_probe.py", "scripts/wa_media_pull_worker.py", "scripts/wa_mirror_intake_sweeper.py", "scripts/whatsapp_export_backfill/import_staging.py", "scripts/wr2-cron-wrapper.sh",
        "scripts/wr2_bootstrap_canva_oauth.py", "scripts/wr2_canva_pdf_render.py", "scripts/wr2_daily_reconciler.py", "scripts/wr2_damar_publish_consumer.py", "scripts/wr2_draft_generator.py", "scripts/wr2_fact_checker.py", "scripts/wr2_fact_extractor.py", "scripts/wr2_html_render_apply.py", "scripts/wr2_ig_profile_harvester.py", "scripts/wr2_ig_publish.py", "scripts/wr2_image_generator.py",
        "scripts/wr2_queue_writer.py", "scripts/wr2_rerender_requeue.py", "scripts/wr2_supervisor.py", "scripts/wr2_topic_selector.py", "scripts/wr2_validate_master.py", "scripts/wr3_supervisor.py",
    )
)
