...
SCRIPTS_COUPLING: frozenset[str] = frozenset(
    (
        ...
        "scripts/intake_identity_backfill.py", "scripts/intake_reprocess_backlog.py", "scripts/intake_review_reader_run.sh", "scripts/intake_wa_mirror_audit.py", "scripts/intel-lake-router-a2/intel-lake-router-cron-standalone.py", "scripts/journey_sentinel.sh", "scripts/kb/cukup_jelas_sample.py", "scripts/kb/kb_inventory_probe.py", "scripts/kb/legal_status_drift_gate.py",
        "scripts/kb/probe_legal_status_marking.py", "scripts/kbli_apply_editorials.py", "scripts/kbli_apply_en_titles.py", "scripts/kbli_dataset_lint.py", "scripts/kbli_filiera/_coverage_basis.py", "scripts/kbli_filiera/_whatchanged_basis.py", "scripts/kbli_filiera/apply_perpres_foreign_caps.py", "scripts/kbli_filiera/apply_residual_open.py", "scripts/kbli_filiera/cure_canonical_collisions.py",
        "scripts/kbli_filiera/cure_l23_whatchanged_language.py", "scripts/kbli_filiera/cure_l4bali_hold_review.py", "scripts/kbli_filiera/editorial_record_conformance.py", "scripts/kbli_filiera/emit_batch_membership.py", "scripts/kbli_filiera/gold_risk_dispute_relation.py", "scripts/kbli_filiera/perpres_body_default_relation.py", "scripts/kbli_filiera/perpres_slice_disclosure_relation.py",
        "scripts/kbli_filiera/tests/test_pma_zero_cap_basis.py", "scripts/kbli_filiera/tests/test_withdrawn_umkm_inference_absent.py", "scripts/lead_intent_matcher.py", "scripts/lib/codex_seat.py", "scripts/lib/codex_seat.sh", "scripts/lib/heartbeat.py", "scripts/lib/yaml_strict.py", "scripts/lint/lint_claude_headless_model_pin.py", "scripts/lint_avatar_url_validators.py",
        "scripts/lint_content_reasoning_leak.py", "scripts/lint_home_fork.py", "scripts/lint_i18n_providers.sh", "scripts/lint_migration_numbers.py", "scripts/lint_tcc_desktop_paths.py", "scripts/lint_telegram_tokens.py", "scripts/lint_test_reward_hacking.py", "scripts/mata_garuda_invalidation_sweep.py", "scripts/metabolic_rollup.py", "scripts/nlm_shadow_extractor.py",
