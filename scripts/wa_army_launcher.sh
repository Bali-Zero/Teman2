...
REPO_ROOT="${WA_ARMY_REPO_ROOT:-$HOME/Desktop/nuzantara}"
PROMPTS_DIR="${WA_ARMY_PROMPTS_DIR:-$REPO_ROOT/army-prompts}"
CLAUDE_BIN="${WA_ARMY_CLAUDE_BIN:-$HOME/.local/bin/claude}"
CLAUDE_MODEL="${WA_ARMY_MODEL:-claude-opus-4-8}"
LOG_DIR="${WA_ARMY_LOG_DIR:-$HOME/Library/Logs/wa-army}"
WATCHER="${WA_ARMY_WATCHER:-$REPO_ROOT/scripts/wa_army_watcher.sh}"
