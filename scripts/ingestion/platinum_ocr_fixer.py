...
GARBAGE_PATTERNS = [
    ...
    r"Skala Usehe \(ls\)",
    r"SLela Usahe \(sl",
    r"Kewen[a|c]ng[a|e]n\s+\(?13[t|l|i|1]?\)?",
    r"Keweaangan l13l",
    r"Kewenangaa t13t",
    r"Menteri/ Kepala Badan",
    r"Rueng Lingkup \(4\)",
    r"Ruang Lingkup \(4t\)?",
    r"Ruang Ltnglup \(41",
    r"Ruang Ltnglrup l4l",
    r"Ruaag Linglup \(4\)",
    r"Ruang Liagkup t4t",
    r"Seluruh Ruang Lingkup l4t",
    r"Periziaan Berusaha 17l",
    r"Perizinaa Berusaha 17l",
    r"Perizinan Berusehe 17l",
    r"Perizinan Beruerha t7l",
    r"Perizinan Berusrha 17l",
    r"Perizinan Berusahe t7l",
    r"NIB dan",
    r"Judul KBLI \(3t?",
    r"Judul I\(BLI \(3\)?",
    r"Judul KBLI l3t",
