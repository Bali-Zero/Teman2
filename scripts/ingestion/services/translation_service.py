...
class TranslationService:
    ...
    def translate_with_google(self, text: str) -> Optional[str]:
        ...
        try:
            ...
            params = {"client": "gtx", "sl": "id", "tl": "en", "dt": "t", "q": text}
        ...
        try:
            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are a professional translator. Translate Indonesian to English accurately.",
                    },
    ...
    def translate_batch(
        self, texts: list[str], save_interval: int = 100
    ) -> Dict[str, str]:
        """
