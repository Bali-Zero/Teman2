...
def test_generator_finds_components():
    ...
    # disk-state truth: the real tree has 28 (17 top-level incl. Money +
    # ListPageHeader/SearchBox/FilterBar/StatChips + 11 under apps/)
    assert len(arts) == 28, f"expected 28 components on disk, got {len(arts)}"
