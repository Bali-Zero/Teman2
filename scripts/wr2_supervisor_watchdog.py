    ...
    while not _shutdown_event.is_set():
        ...
        try:
            ...
            while not _shutdown_event.is_set():
                ...
                except (asyncpg.InterfaceError, asyncpg.PostgresError, OSError, asyncio.TimeoutError):
                ...
                try:
                    ...
                    return
        except (asyncpg.InterfaceError, asyncpg.PostgresError, OSError, asyncio.TimeoutError) as e:
