    ...
    for article_file in PENDING_DIR.glob("*.json"):
        try:
            ...
            if cover_image and cover_image != "None":
                ...
                image_path = INTEL_DIR / cover_image if not Path(cover_image).is_absolute() else Path(cover_image)
