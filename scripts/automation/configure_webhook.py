...
BOT_TOKEN = os.getenv(
    "TELEGRAM_BOT_TOKEN", "8295471667:AAHufchz_6zO5i8BitsUGNof5fVn8iMHHPE"
)
        ...
        try:
            ...
            if result.get("ok"):
                ...
                if verify_result.get("ok"):
                    ...
                    print(
                        f"   Updates in attesa: {webhook_info.get('pending_update_count', 0)}"
                    )
                    if webhook_info.get("last_error_message"):
                        print(
                            f"   ⚠️  Ultimo errore: {webhook_info.get('last_error_message')}"
                        )
