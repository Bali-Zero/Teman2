...
- [ ] React Query: Cache hit rate > 80% dopo 5 min di navigazione
- [ ] Rate Limiting: 429 responses dopo 100 req/min
- [ ] Brotli: Content-Encoding: br header presente
- [ ] DB: EXPLAIN ANALYZE mostra Index Scan invece di Seq Scan
- [ ] Docker: Immagine < 500MB (prima era ~1GB)
