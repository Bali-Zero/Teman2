# Visa Oracle — LIVE STATE full chronology

Moved out of `.agents/skills/visaoracle/SKILL.md` § LIVE STATE on 2026-09-09 (context-budget split).

Update protocol: whoever changes state appends the entry HERE (newest first) and refreshes the
CURRENT POSITION block in SKILL.md in the same commit.
...
- 2026-08-07 (Mini, Visa Oracle V2 completion): **REPOSITORY CANDIDATE G0–G6 PASS;
  ...
  `.agents/skills/visaoracle/references/CURRENT_STATE.md`.
...
2026.8.8`: Cameroon → normal document path, no more `CALLING_VISA_REVIEW`
  ...
  Full evidence: `.agents/skills/visaoracle/references/CURRENT_STATE.md` §"Production
...
- 2026-08-08 (Mini, second entry same day — 0%-conclusive-rate diagnosis): **ROOT
  ...
  `.agents/skills/visaoracle/references/HANDOFF-2026-08-08-voa-conclusive-rate.md`. Deploy
