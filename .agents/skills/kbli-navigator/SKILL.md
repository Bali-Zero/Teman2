...
- **Mente immobile / final gate**: **Opus 5** (max effort, interactive) — RULED 2026-08-20, was
...
- **D5 Independent verification** (anti-correlation): the refuter does BLIND re-extraction, does not
  ...
  text-pack (W100).
- **D6 Batch gate**: deterministic censuses + gates G13–G17 → **Opus 5 max-effort final empirical
