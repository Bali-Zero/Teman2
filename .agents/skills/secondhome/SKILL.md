...
| Studio print (custody diagram) | ❌ **REGRESSION, IN-CURE — NOT MERGED** — confirmed in source: #4751's print stylesheet (`SavePlanBar.tsx`) hides every `<button>` (`nav, button, ... { display: none !important; }`), and #4753 made each custody node a `<button>` (`CustodyMap.tsx:78`). Printing the plan now silently drops the three custody nodes and prints arrows around empty space. Fix tracked at **#4764** ("fix(mouth): the printed plan lost the money-path diagram") — confirmed `state: OPEN`, `mergedAt: null`; do not mark this cured until it lands.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
