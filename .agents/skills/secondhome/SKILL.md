...
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Pricing                     | ✅ **LIVE** — `search_service_pricing` prod returns E33 = 35.000.000 IDR all-inclusive (repriced 2026-08-19), + E33E 14/16M, E33F 14/16M, E33F extend 10M. Re-verified LIVE 2026-08-23 through the same production PricingTool — figures unchanged.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| Seats (Mini, cross-family)  | ⚠️ **MEASURED 2026-08-23** — on Mini: `kimi` LIVE; `codex` 401 refresh-token-revoked and `agy` auth-timeout, both **alive via `ssh pro`**; `claude-glm` has no Keychain token; the TP1 Alibaba key returns 401; NotebookLM MCP is not registered on Mini at all. Consequence for anyone loading this corner on Mini: NB ground-truth is unavailable here, and cross-family red-team must route through Pro. PENDING-ARMS row opened.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
- **F6 — Commercial**:
  ...
  - **Property module** — ⏸️ **SUSPENDED**, cause: blocked on
    `property_validation_standard` (addendum 007 Q5).
  - **Senior price review** — ⏸️ **SUSPENDED**, cause: `operator[business]`
    (Legge 5), now QUANTIFIED: E33E (5y) and E33F (1y) sell at the SAME
    price (14M offshore / 16M onshore) although E33E's own PNBP
    (Rp 13,000,000 — §4bis PNBP row) is nearly double E33F's
    (Rp 7,000,000). E33E offshore clears only Rp 1,000,000 over PNBP —
    Rp 2,000,000 BELOW the PNBP+3jt pattern the rest of this pricing
    follows (E33E onshore matches it exactly) — while E33F/E33G sit +6M to
    +9M over PNBP. That PNBP+3jt pattern is itself an informal internal
    composition yardstick, not a documented ruling — see
    `research/visa/2026-08-23-e33-second-home-ultra-research.md`.
