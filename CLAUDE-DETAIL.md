# CLAUDE-DETAIL.md — Nuzantara Project Context (Extended)

> **Load on demand via Read tool.** Riferimenti dal main [`CLAUDE.md`](CLAUDE.md) come "`[CLAUDE-DETAIL.md §N]`".
> **Archived from CLAUDE.md** 2026-04-22 (T1.2 split, 487 righe originale preservato qui).
...
- **Backend:** Python 3.11+, FastAPI, 253 routers, 485 services, 809 test files
...
**Formato proposta (una riga):** _"Questa mi sembra da salvare in `research/<domain>/` — procedo? (y/n)"_
