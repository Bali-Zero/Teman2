...
- [ ] Any tone-shift from past posts to current strategy is acknowledged + Zero-approved (e.g. older posts were promotional → new strategy is editorial; reader doesn't see whiplash)
