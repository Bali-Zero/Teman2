...
directly contradict a currently-enforced constitutional gate or cron validator. Until Zero
...
**Status**: PROPOSED, awaiting Zero veto/approve on Rule 1 specifically (see flag below);
