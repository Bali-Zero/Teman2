...
qr_caption:
  string? # OPTIONAL — 1-3 words above the QR. Default: "PRIMARY SOURCE"
...
<html>
  <head>
    ...
    <style>
      ...
      body {
        ...
        padding: 100px var(--spacing-edge-margin) 220px
  ...
  <body data-slide-index="{{index}}" data-layout="elegant-close">
    ...
    <div class="qr-closing__caption" data-zone-type="text">
      {{qr_caption | default: "PRIMARY SOURCE"}}
    </div>
    <div
      class="qr-closing"
      data-zone-type="text"
      style="--qr-image-url: url('qr.png');"
    ></div>
    {{/if}}
...
```json
{
  ...
  "reach": "WHATSAPP +62 821 3454 721",
