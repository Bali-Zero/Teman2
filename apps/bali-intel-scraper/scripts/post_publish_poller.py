...
def run_image(slug: str, category: str) -> bool:
    ...
    3. Genera con ComfyUI (porta 8188) → Pollinations.ai → Unsplash
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if not generated:
            log("  ComfyUI offline — uso Pollinations.ai")
        ...
        # --- 3. Picsum fallback (foto curate, sempre disponibile) ---
        if not generated:
        ...
        # --- 4. Unsplash fallback (foto reali per categoria) ---
        if not generated:
