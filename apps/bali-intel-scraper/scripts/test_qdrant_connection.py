...
try:
    client = QdrantClient(
        url=QDRANT_URL, api_key=QDRANT_API_KEY, timeout=30, prefer_grpc=False
    )
    ...
    if exists:
        ...
        client.create_collection(
            ...
            optimizers_config=models.OptimizersConfigDiff(
                default_segment_number=2, indexing_threshold=1000
            ),
        ...
        client.create_payload_index(
            COLLECTION_NAME, "published_at", models.PayloadSchemaType.DATETIME
        )
        client.create_payload_index(
            COLLECTION_NAME, "source_url", models.PayloadSchemaType.KEYWORD
        )
        client.create_payload_index(
            COLLECTION_NAME, "category", models.PayloadSchemaType.KEYWORD
        )
        client.create_payload_index(
            COLLECTION_NAME, "tier", models.PayloadSchemaType.KEYWORD
        )
