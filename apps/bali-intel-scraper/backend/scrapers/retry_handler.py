    ...
    def decorator(func: Callable) -> Callable:
        ...
        def sync_wrapper(*args, **kwargs):
            ...
            return loop.run_until_complete(
                retry_handler.execute(func, *args, operation_name=func.__name__, **kwargs)
            )
    ...
    async def execute(self, func: Callable, *args, **kwargs) -> Any:
        ...
        if self.circuit_breaker_name:
            ...
            if breaker and breaker.is_open:
                ...
                raise Exception(f"Circuit breaker '{self.circuit_breaker_name}' is open")
...
async def retry_network_request(
    ...
    **kwargs
    ...
    return await handler.execute(func, *args, operation_name="network_request", **kwargs)
