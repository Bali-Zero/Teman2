...
class TopicClassifier:
    ...
    CATEGORY_KEYWORDS = {
        NewsCategory.POLITICS: ['government', 'election', 'minister', 'president', 'policy', 'political', 'parliament', 'vote'],
        NewsCategory.BUSINESS: ['company', 'market', 'stock', 'investment', 'profit', 'revenue', 'corporate', 'trade'],
        NewsCategory.ECONOMY: ['economy', 'economic', 'inflation', 'gdp', 'finance', 'financial', 'growth'],
        NewsCategory.TECHNOLOGY: ['technology', 'tech', 'digital', 'software', 'app', 'internet', 'ai', 'data'],
        NewsCategory.SPORTS: ['sport', 'game', 'match', 'player', 'team', 'championship', 'tournament', 'score'],
        NewsCategory.ENTERTAINMENT: ['movie', 'music', 'celebrity', 'film', 'actor', 'concert', 'show', 'entertainment'],
        NewsCategory.HEALTH: ['health', 'medical', 'hospital', 'disease', 'treatment', 'doctor', 'medicine'],
        NewsCategory.SCIENCE: ['science', 'research', 'study', 'discovery', 'scientist', 'space', 'physics'],
        NewsCategory.ENVIRONMENT: ['environment', 'climate', 'green', 'pollution', 'sustainability', 'nature'],
        NewsCategory.TRAVEL: ['travel', 'tourism', 'tourist', 'hotel', 'destination', 'flight', 'vacation'],
        NewsCategory.CULTURE: ['culture', 'art', 'heritage', 'tradition', 'festival', 'museum', 'history'],
        NewsCategory.CRIME: ['crime', 'police', 'court', 'arrest', 'criminal', 'investigation', 'law'],
        NewsCategory.EDUCATION: ['education', 'school', 'university', 'student', 'teacher', 'learning', 'academic'],
        NewsCategory.LIFESTYLE: ['lifestyle', 'fashion', 'food', 'recipe', 'home', 'decor', 'wellness'],
    }
    
    # Bali-specific keywords
    BALI_KEYWORDS = ['bali', 'denpasar', 'kuta', 'seminyak', 'ubud', 'nusa dua', 'canggu', 'sanur']
    INDONESIA_KEYWORDS = ['indonesia', 'jakarta', 'indonesian', 'archipelago', 'nusantara']
