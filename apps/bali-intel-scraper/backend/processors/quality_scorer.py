...
class QualityScorer:
    ...
    CREDIBILITY_POSITIVE = [
        ...
        'expert', 'official', 'report', 'survey', 'analysis'
    ]
    
    CREDIBILITY_NEGATIVE = [
        'rumor', 'allegedly', 'unnamed source', 'some say',
        'many believe', 'it is said', 'speculation'
    ]
    ...
    def _score_credibility(self, text: str) -> float:
        ...
        # Source attribution
        has_attribution = any(phrase in text_lower for phrase in ['said', 'told', 'according to'])
