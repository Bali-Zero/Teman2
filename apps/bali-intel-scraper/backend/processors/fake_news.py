...
class FakeNewsDetector:
    ...
    RELIABLE_SOURCES = {
        ...
        'antaranews.com', 'kompas.com', 'detik.com', 'liputan6.com',
        'jakartapost.com', 'balipost.com', 'radarbali.co.id'
    }
    ...
    SENSATIONAL_WORDS = {
        ...
        'outrageous', 'devastating', 'terrifying', 'miracle',
        'secret', 'conspiracy', 'cover-up', 'censored'
    }
    ...
    def assess(
        ...
        logger.info(
            f"Credibility assessment complete",
