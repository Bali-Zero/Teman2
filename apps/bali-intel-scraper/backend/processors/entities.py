...
class EntityExtractor:
    ...
    # Location indicators
    LOCATION_INDICATORS = {
        'bali', 'jakarta', 'surabaya', 'bandung', 'yogyakarta', 'medan',
        'makassar', 'denpasar', 'seminyak', 'kuta', 'ubud', 'nusa dua',
        'indonesia', 'singapore', 'malaysia', 'australia', 'japan',
        'beach', 'island', 'mountain', 'temple', 'province', 'city'
    }
...
Text: {text[:3000]}"""
    ...
    def format_for_indexing(self, entities: Dict[str, List[Entity]]) -> Dict[str, List[str]]:
        """Format entities for search indexing."""
        return {
            label: [e.text for e in ents]
