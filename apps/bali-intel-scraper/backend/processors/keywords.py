...
class KeywordExtractor:
    ...
    DOMAIN_KEYWORDS = {
        'bali', 'indonesia', 'tourism', 'temple', 'beach', 'culture',
        'traditional', 'ceremony', 'island', 'travel', 'destination',
        'hospitality', 'resort', 'hotel', 'villa', 'restaurant',
        'local', 'community', 'village', 'ubud', 'kuta', 'seminyak'
    }
