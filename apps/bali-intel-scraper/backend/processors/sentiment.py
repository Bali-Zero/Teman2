...
class SentimentAnalyzer:
    ...
    POSITIVE_WORDS = {
        ...
        'best', 'awesome', 'perfect', 'brilliant', 'outstanding',
        'success', 'win', 'victory', 'growth', 'improvement', 'progress',
        'beautiful', 'nice', 'pleasant', 'delightful', 'positive'
    }
    
    NEGATIVE_WORDS = {
        'bad', 'terrible', 'awful', 'horrible', 'hate', 'dislike',
        'angry', 'sad', 'disappointed', 'frustrated', 'annoyed',
        'worst', 'fail', 'failure', 'loss', 'decline', 'crisis',
        'problem', 'issue', 'concern', 'worry', 'fear', 'negative',
        'difficult', 'hard', 'struggle', 'challenge', 'risk'
    }
...
Text: {text[:2000]}"""
        ...
        try:
            ...
            logger.error(
                f"Failed to parse AI sentiment response: {e}",
                action=LogAction.ERROR
            )
            return self._analyze_basic(text)
