...
# NB-10 configuration
NB10_NOTEBOOK_ID = "b319f1b3-74a1-415f-b8c0-c0626b008f29"
        ...
        try:
            ...
            try:
                ...
                synthesis_summary = run_daily_synthesis(
                    nb_id=NB10_NOTEBOOK_ID,
                    nb_name="NB-10: Team Guides",
                    claims=all_claims,
                    dry_run=self.dry_run,
                )
                summary["phases"]["synthesis"] = synthesis_summary
                logger.info(
                    "NB-10 synthesis: daily=%s weekly=%s monthly=%s total_synth=%d",
