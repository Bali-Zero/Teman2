...
# NB-3 configuration
NB3_NOTEBOOK_ID = "045f3cdb-ef62-488c-90ba-82594928b671"
...
class NB3Pipeline:
    ...
    def run(self) -> dict:
        ...
        try:
            ...
            if not self.dry_run:
                try:
                    snap = take_snapshot(NB3_NOTEBOOK_ID, "nb3_company")
            ...
            try:
                ...
                logger.info(
                    "NB-3 synthesis: daily=%s weekly=%s monthly=%s total_synth=%d",
