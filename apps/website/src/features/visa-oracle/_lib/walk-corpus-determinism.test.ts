 ...
 * (see `apps/website/proofs/visa-oracle/generate-walk-corpus.ts`), and the
 ...
 *
 * The cure for a red is always
 * `npx tsx proofs/visa-oracle/generate-walk-corpus.ts` from `apps/website`, followed by
...
import {
  DEFAULT_OUT_DIR,
  writeWalkCorpus,
} from "../../../../proofs/visa-oracle/generate-walk-corpus";
