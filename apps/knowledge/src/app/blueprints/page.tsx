...
const BLUEPRINTS: Blueprint[] = [
  ...
  },
  {
    ...
    icon: "hotel",
    description:
      "Investment guide for non-star rated hotels and budget accommodations.",
  },
  {
    id: "kbli-55130",
    kbli_code: "55130",
  ...
  },
  {
    ...
    icon: "home",
    description:
      "Complete guide for villa investment and operations in Indonesia.",
  },
  {
    id: "kbli-55194",
    kbli_code: "55194",
  ...
  },
  {
    ...
    icon: "home",
    description:
      "Guide for bungalows, cottages and other short-term accommodations.",
  },
  {
    id: "kbli-55900",
    kbli_code: "55900",
  ...
  },
  {
    ...
    icon: "building",
    description:
      "Strategic guide for real estate operations and property management.",
  },
  {
    id: "kbli-96121",
    kbli_code: "96121",
  ...
  },
  {
    ...
    icon: "globe",
    description:
      "Technical guide for non-commercial web portals and platforms.",
  },
  // ============================================================
  ...
  },
  {
    ...
    icon: "globe",
    description:
      "Guide for tourist attraction information and ticketing services.",
  },
  // ============================================================
  ...
  // ============================================================
  {
    ...
    icon: "anchor",
    description:
      "Comprehensive guide for fish and seafood processing business.",
  },
  {
    id: "kbli-10234",
    kbli_code: "10234",
  ...
  },
  {
    ...
    icon: "hotel",
    description:
      "Blueprint for establishing successful restaurant and food service operations.",
  },
  {
    id: "kbli-10771",
    kbli_code: "10771",
  ...
  // ============================================================
  {
    ...
    icon: "factory",
    description:
      "Investment guide for mineral water refill and production business.",
  },
  {
    id: "kbli-46333",
    kbli_code: "46333",
  ...
  // ============================================================
  {
    ...
    icon: "briefcase",
    description:
      "Professional services for Indonesia business licensing reform and compliance.",
  },
  {
    id: "kbli-69103",
    kbli_code: "69103",
    ...
    icon: "briefcase",
    description:
      "Advisory services for Indonesia new licensing framework under PP 28/2025.",
  },
  {
    id: "kbli-69201",
    kbli_code: "69201",
    ...
    icon: "briefcase",
    description:
      "Consulting for licensing reform and regulatory accountability.",
  },
  {
    id: "kbli-70100",
    kbli_code: "70100",
    ...
    icon: "briefcase",
    description:
      "Strategic advisory for investment regulatory compliance and planning.",
  },
  {
    id: "kbli-70201",
    kbli_code: "70201",
  ...
  },
  {
    ...
    icon: "briefcase",
    description:
      "Comprehensive business licensing guidance for Indonesia market entry.",
  },
  {
    id: "kbli-70209",
    kbli_code: "70209",
  ...
  },
  {
    ...
    icon: "briefcase",
    description:
      "Advisory bridging Indonesian policy with corporate compliance.",
  },
  {
    id: "kbli-73201",
    kbli_code: "73201",
    ...
    icon: "briefcase",
    description:
      "Strategic consulting for regulatory transformation and compliance.",
  },
  {
    id: "kbli-73202",
    kbli_code: "73202",
    ...
    icon: "briefcase",
    description:
      "Market research services for risk-based licensing implementation.",
  },
  {
    id: "kbli-82190",
    kbli_code: "82190",
  ...
  },
  {
    ...
    icon: "briefcase",
    description:
      "Professional debt collection services under new regulatory standards.",
  },
  {
    id: "kbli-82912",
    kbli_code: "82912",
  ...
  // ============================================================
  {
    ...
    icon: "warehouse",
    description:
      "Wholesale distribution of miscellaneous goods and commodities.",
  },
  {
    id: "kbli-46422",
    kbli_code: "46422",
  ...
  },
  {
    ...
    icon: "warehouse",
    description:
      "Wholesale distribution of construction materials and supplies.",
  },
  {
    id: "kbli-46900",
    kbli_code: "46900",
  ...
  },
  {
    ...
    icon: "cart",
    description:
      "Retail trade of chemical products and pharmaceutical supplies.",
  },
  {
    id: "kbli-47782",
    kbli_code: "47782",
  ...
  },
  {
    ...
    icon: "car",
    description:
      "Retail of transportation equipment and automotive accessories.",
  },
  {
    id: "kbli-47832",
    kbli_code: "47832",
  ...
  },
  {
    ...
    icon: "monitor",
    description:
      "E-commerce retail for food, beverages, pharmaceuticals, and cosmetics.",
  },
  {
    id: "kbli-47919",
    kbli_code: "47919",
    ...
    icon: "monitor",
    description:
      "E-commerce retail for general merchandise and other products.",
  },
  {
    id: "kbli-47920",
    kbli_code: "47920",
    ...
    icon: "cart",
    description:
      "Direct selling, multi-level marketing, and commission-based retail.",
  },
];
...
function BlueprintCard({ blueprint }: BlueprintCardProps) {
  ...
  const handleDownload = () => {
    ...
    if (pdfUrl) {
      ...
      logger.error(
        "CRITICAL: Blueprint senza PDF - questo non dovrebbe mai succedere",
        {
          component: "BlueprintsPage",
      ...
      <div className="absolute top-1.5 left-1.5 right-1.5 z-10 flex items-center gap-1">
        ...
        {blueprint.has_indonesian && (
          <button
            ...
            `}
            title={
              showIndonesian ? "Viewing Indonesian" : "Switch to Indonesian"
            }
          >
        ...
        {blueprint.has_bisnis && (
          <button
            ...
            `}
            title={
              showBisnis ? "Viewing Business guide" : "Switch to Business guide"
            }
          >
...
export default function BlueprintsPage() {
  ...
  const filteredBlueprints = BLUEPRINTS.filter((bp) => {
    ...
    const matchesCategory =
      !selectedCategory || bp.category === selectedCategory;
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-[var(--foreground-muted)] mt-2 max-w-2xl">
            KBLI Business Classification Blueprints based on PP 28/2025.
            Download comprehensive guides for starting your business in
            Indonesia.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-[var(--foreground-secondary)]">
              Our PT PMA experts can guide you through the entire process. Free
