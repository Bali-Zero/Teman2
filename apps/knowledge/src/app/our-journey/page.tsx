...
export default function OurJourneyPage() {
  ...
  useEffect(() => {
    ...
    trackPageView("/our-journey", "Our Journey");
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <p className="text-[var(--foreground-muted)]">
            Discover our ongoing and completed projects. See how we&apos;ve
            helped businesses establish and grow in Indonesia.
          </p>
        ...
        >
          ...
          <p className="text-[var(--foreground-muted)]">
            Browse through our client cases and success stories. Learn from real
            examples of businesses we&apos;ve helped navigate Indonesian
            regulations.
          </p>
          <div className="mt-4 flex items-center gap-2 text-[var(--accent)] group-hover:gap-3 transition-all">
