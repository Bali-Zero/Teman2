...
- **NOT** a replacement for the Meta Cloud API at `backend/channels/whatsapp/` — that handles the official Bali Zero number `+62 822 6459 9868`. wa-mirror handles the **personal numbers** of the team in parallel.
