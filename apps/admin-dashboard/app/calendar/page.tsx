                        ...
                        {dayEvents.slice(0, 3).map((event) => (
                          <div
                            ...
                            className={cn(
                              ...
                              event.hangoutLink && 'bg-green-500/20 text-green-700'
                            )}
                          >
                  ...
                  {events.map((event) => (
                    <div
                      ...
                      className={cn(
                        ...
                        selectedEvent?.id === event.id && 'bg-primary/5 border-l-4 border-l-primary'
                      )}
                    >
            ...
            <div className="flex-1 overflow-auto p-6">
              ...
              <form onSubmit={createEvent} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-sm font-medium mb-1.5">Inizio</label>
                    <input
                      type="datetime-local"
                      required
                      value={newEvent.from}
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1.5">Fine</label>
                    <input
                      type="datetime-local"
                      required
                      value={newEvent.to}
                ...
                <div>
                  <label className="block text-sm font-medium mb-1.5">Partecipanti</label>
                  <input
                    type="text"
