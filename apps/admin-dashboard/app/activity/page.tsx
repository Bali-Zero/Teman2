    ...
    <div className="p-8 max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
           ...
           <p className="text-muted-foreground mt-2">
             Live monitoring of agent actions, decisions, and tool executions. Auto-refreshes every 5s.
           </p>
        </div>
      ...
      {error ? (
          <div className="p-12 border-2 border-dashed rounded-lg text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">Ensure the <code>activity_log</code> table exists in your PostgreSQL database.</p>
          </div>
      ) : (
          <div className="grid gap-4">
            {activities.length === 0 && !loading && (
                 <div className="text-center py-12 text-muted-foreground">No recent activity recorded.</div>
            )}
                    ...
                    <CardContent className="p-4 flex items-start gap-4">
                        ...
                        <div className="flex-1 space-y-1">
                            <div className="flex items-center justify-between">
                                ...
                                {act.duration_ms && <span className="text-xs font-mono">{act.duration_ms}ms</span>}
                            </div>
