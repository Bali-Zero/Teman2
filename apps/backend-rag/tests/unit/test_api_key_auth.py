...
def test_init_creates_admin_key(api_key_auth):
    ...
    admin_key = api_key_auth.valid_keys["REDACTED-ROTATED-KEY"]
...
def test_get_key_info_admin_key(api_key_auth):
    ...
    info = api_key_auth.get_key_info("REDACTED-ROTATED-KEY")
...
def test_different_roles_have_different_permissions(api_key_auth):
    ...
    admin_result = api_key_auth.validate_api_key("REDACTED-ROTATED-KEY")
