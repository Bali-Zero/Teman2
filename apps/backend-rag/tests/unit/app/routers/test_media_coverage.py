...
def _load_module(monkeypatch, service_result=None, service_error=None):
    ...
    monkeypatch.setitem(
        sys.modules,
        "backend.services.misc.image_generation_service",
        types.SimpleNamespace(
            ImageGenerationService=_ImageService, redis_url="redis://localhost:6379"
        ),
    )
    ...
    module_name = "backend.app.routers.media"
