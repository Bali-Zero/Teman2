    ...
    GOLDEN_ROUTES = {
        ...
        "restaurant_foreigner": GoldenRoute(
            ...
            path=[
                ...
                "Sponsor yourself for KITAS E28G (Investor KITAS) via RPTKA",
                "Apply for IMTA for any foreign staff (chef, manager)",
        ...
        "investor_kitas_retirement": GoldenRoute(
            ...
            path=[
                ...
                "Apply for VITAS (Visa Tinggal Terbatas) at Indonesian embassy or e-Visa",
                "Enter Indonesia and convert VITAS to KITAS at immigration office",
            ...
            key_conditions=[
                "Investor KITAS requires active PT PMA with RPTKA approval",
        ...
        "hire_foreign_worker": GoldenRoute(
            ...
            path=[
                "Company prepares RPTKA (Rencana Penggunaan TKA) - foreign worker plan",
                "Submit RPTKA to Ministry of Manpower (Kemnaker) online",
                "Receive RPTKA approval with approved positions and duration",
                "Apply for Notifikasi/IMTA (Izin Mempekerjakan TKA) via TKA Online",
                "Pay DKP-TKA compensation fund (USD 100/month per foreign worker)",
                "Worker applies for VITAS E28A at Indonesian embassy",
                "Worker enters Indonesia, converts VITAS to KITAS E28A",
        ...
        "visa_pre_investment_d12": GoldenRoute(
            ...
            path=[
                "Apply for D12 visa via e-Visa portal or Indonesian embassy",
        ...
        "visa_digital_nomad_e33g": GoldenRoute(
            ...
            path=[
                "Apply for VITAS E33G via e-Visa portal or Indonesian embassy",
        ...
        "visa_spouse_family_e31": GoldenRoute(
            ...
            path=[
                ...
                "Apply for VITAS at Indonesian embassy or e-Visa portal",
        ...
        "visa_retirement_e33e": GoldenRoute(
            ...
            path=[
                ...
                "Apply for VITAS E33E at Indonesian embassy or e-Visa portal",
        ...
        "visa_second_home": GoldenRoute(
            ...
            path=[
                ...
                "Apply for Second Home Visa via e-Visa portal or embassy",
        ...
        "visa_performing_event_c7_c10_c11": GoldenRoute(
            ...
            path=[
                ...
                "Apply via e-Visa portal or embassy",
                "Pay visa fee (PNBP)",
