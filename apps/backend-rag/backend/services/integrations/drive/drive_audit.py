...
class DriveAuditLogger:
    ...
    def log_operation(self, user_email: str, operation: str, status: str, details: dict = None) -> None:
    ...
    def log_error(self, user_email: str, operation: str, error_type: str, error_msg: str, details: dict = None) -> None:
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(self_or_service: Any, user_email: str, *args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                error_type = "network_error" if "connection" in error_name or "timeout" in error_name else "operation_failed"
                ...
                if METRICS_ENABLED:
                    ...
                    drive_operation_duration_seconds.labels(
                        operation=operation_name
                    ).observe(duration)
