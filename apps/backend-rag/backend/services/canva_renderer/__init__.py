...
Reference: runbooks/APPLICA_WAR_ROOM.md — the editorial runbook that
claude -p executes headlessly. Template element IDs map in
`pending_builder.TEMPLATE_SLOTS`, recovered via start-editing-transaction
on 2026-03-26 and re-confirmed 2026-04-22.
"""
