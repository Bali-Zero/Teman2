...
Reference: the `~/.claude/skills/canva-apply.md` userspace skill loaded through
`claude_invoker.APPLICA_RUNBOOK_PATH`. Template element IDs map in
`pending_builder.TEMPLATE_SLOTS`, recovered via start-editing-transaction on
2026-03-26 and 2026-04-22.
"""
