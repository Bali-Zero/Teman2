...
# SECURITY: Lazy import of sentence_transformers to avoid PyTorch import issues during test collection
# SentenceTransformer will be imported inside methods when needed
