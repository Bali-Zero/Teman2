...
class AlertGeneratorService:  # pragma: no cover — shim
    ...
    def generate_alert(self, *args: object, **kwargs: object) -> None:
        warnings.warn(
    ...
    def find_existing_alert(self, *args: object, **kwargs: object) -> None:
        warnings.warn(
    ...
    def get_alerts_for_client(self, *args: object, **kwargs: object) -> list:
        warnings.warn(
