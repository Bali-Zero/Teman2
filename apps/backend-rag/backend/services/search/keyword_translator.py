...
_TERM_MAP: dict[str, tuple[str, str]] = {
    ...
    "b211a": ("C1 Tourism visa tourist visa", "C1 Tourism visa wisata"),
    "b211": ("C1 Tourism visa tourist visa", "C1 Tourism visa wisata"),
    "b1": ("B1 Visa on Arrival VOA", "B1 Visa Kedatangan VOA"),
    "voa": ("B1 Visa on Arrival visa on arrival", "B1 Visa Kedatangan VOA"),
    "visa on arrival": ("B1 Visa on Arrival VOA", "B1 Visa Kedatangan VOA"),
    "c1": ("C1 Tourism visa tourist visa", "C1 Tourism visa wisata"),
    "c2": ("C2 Business visa single entry", "C2 Business visa bisnis"),
