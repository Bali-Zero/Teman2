...
-- shape): drafted as 294 on the original, now-suspended PR — gated for 4
-- failed rounds on this repo's tripwire test, unrelated to this table
-- (Builder Contract §1 depth-1 cap on a fix-of-a-fix). Renumbered 294->316
-- alongside siblings 293->315 and 295->317 — see 315's own header for the
-- fresh measurement. Everything below, including this file's own now-stale
-- bind-time provenance comment naming 281/282, is otherwise UNCHANGED from
-- the version the split-gate already reviewed as clean.
-- ----------------------------------------------------------------------------
--
...
--     -> highest present is 281 (315_visa_oracle_consultant_requests.sql, this
...
-- Restores 315's original blanket-reject body verbatim (trigger
-- trg_guard_visa_oracle_consultant_requests_append_only, created by 315,
