...
async def test_insert_duplicate_dedup_raises_unique_violation(
    ...
    base = AlertRow(
        ...
        deadline=date.today() + timedelta(days=7),
        days_until=7,
        compliance_item_ref="doc_x",
        dedup_key="visa:1:doc_x",
        message_it="",
        message_en="",
        message_id="",
        suggested_action="",
...
async def test_find_active_by_dedup_key_returns_existing(
    ...
    row = AlertRow(
        ...
        deadline=date.today() + timedelta(days=7),
        days_until=7,
        compliance_item_ref="doc_y",
        dedup_key="visa:1:doc_y",
        message_it="",
        message_en="",
        message_id="",
        suggested_action="",
...
async def test_find_active_ignores_resolved(db_tx: asyncpg.Connection) -> None:
    ...
    row = AlertRow(
        ...
        deadline=date.today() + timedelta(days=7),
        days_until=7,
        compliance_item_ref="doc_z",
        dedup_key="visa:1:doc_z",
        message_it="",
        message_en="",
        message_id="",
        suggested_action="",
...
async def test_promote_updates_severity_and_increments_counter(
    ...
    row = AlertRow(
        ...
        days_until=30,
        compliance_item_ref="doc_w",
        dedup_key="visa:1:doc_w",
        message_it="",
        message_en="",
        message_id="",
        suggested_action="",
...
async def test_update_status_to_resolved(db_tx: asyncpg.Connection) -> None:
    ...
    row = AlertRow(
        ...
        deadline=date.today() + timedelta(days=7),
        days_until=7,
        compliance_item_ref="doc_r",
        dedup_key="visa:1:doc_r",
        message_it="",
        message_en="",
        message_id="",
        suggested_action="",
