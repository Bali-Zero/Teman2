...
class TestCalculatePriority:
    def test_overdue_has_highest_weight(self) -> None:
        result = calculate_priority(
            days_until_action=-1, estimated_revenue_idr=None, complexity=1.0
        )
    ...
    def test_urgent_within_30_days(self) -> None:
        result = calculate_priority(
            days_until_action=20, estimated_revenue_idr=None, complexity=1.0
        )
    ...
    def test_warning_within_60_days(self) -> None:
        result = calculate_priority(
            days_until_action=45, estimated_revenue_idr=None, complexity=1.0
        )
    ...
    def test_planning_within_90_days(self) -> None:
        result = calculate_priority(
            days_until_action=75, estimated_revenue_idr=None, complexity=1.0
        )
    ...
    def test_informational_beyond_90_days(self) -> None:
        result = calculate_priority(
            days_until_action=200, estimated_revenue_idr=None, complexity=1.0
        )
    ...
    def test_no_revenue_gives_0_5_value_weight(self) -> None:
        result = calculate_priority(
            days_until_action=30, estimated_revenue_idr=None, complexity=1.0
        )
    ...
    def test_max_revenue_gives_1_5_value_weight(self) -> None:
        ...
        result = calculate_priority(
            days_until_action=30, estimated_revenue_idr=55_000_000, complexity=1.0
        )
    ...
    def test_half_max_revenue_gives_1_0_value_weight(self) -> None:
        ...
        result = calculate_priority(
            days_until_action=30, estimated_revenue_idr=27_500_000, complexity=1.0
        )
    ...
    def test_score_is_rounded_to_2_decimals(self) -> None:
        result = calculate_priority(
            days_until_action=20, estimated_revenue_idr=18_000_000, complexity=1.5
        )
