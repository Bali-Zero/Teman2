...
EXPECTED_ENUM_VALUES = {
    ...
    ReviewState: ["unreviewed", "machine_checked", "human_approved", "human_rejected", "superseded"],
    PublicationState: ["generated", "staged", "human_approved", "publishing", "deployed", "indexed_verified"],
    ...
    WorkflowState: ["created", "running", "waiting_for_input", "blocked", "succeeded", "failed", "cancelled"],
    QueueState: ["new", "triaged", "assigned", "awaiting_decision", "ready", "closed"],
    ApprovalSubjectKind: ["decision_packet", "topic_lock", "creative_lock", "media_script_lock", "media_shot_lock", "content_revision", "action_intent"],
    ApprovalDecision: ["select", "approve", "reject", "request_changes", "request_evidence", "defer"],
    ...
    OutcomeFamily: ["compliance_protection", "client_journey", "revenue_partnerships", "product_self_service", "decision_intelligence", "authority_demand", "team_enablement", "memory_learning", "platform_governance"],
}
