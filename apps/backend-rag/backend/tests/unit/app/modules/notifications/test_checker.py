...
class TestPassportAlerts:
    ...
    def test_passport_boundary_exactly_9_months(self, checker: ExpiryChecker, base_client: ClientInfo):
    ...
    def test_passport_boundary_exactly_13_months(self, checker: ExpiryChecker, base_client: ClientInfo):
