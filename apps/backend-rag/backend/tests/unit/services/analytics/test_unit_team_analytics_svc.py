...
class TestTeamAnalyticsService:
    ...
    async def test_analyze_work_patterns(self, team_analytics):
        ...
        team_analytics.pattern_analyzer.analyze_work_patterns = AsyncMock(
    ...
    async def test_calculate_productivity_scores(self, team_analytics):
        ...
        team_analytics.productivity_scorer.calculate_productivity_scores = AsyncMock(
            return_value=[],
        )
    ...
    async def test_analyze_performance_trends(self, team_analytics):
        ...
        team_analytics.performance_trend.analyze_performance_trends = AsyncMock(
            return_value={"trend": {}},
        )
    ...
    async def test_analyze_workload_balance(self, team_analytics):
        ...
        team_analytics.workload_balance.analyze_workload_balance = AsyncMock(
    ...
    async def test_identify_optimal_hours(self, team_analytics):
        ...
        team_analytics.optimal_hours.identify_optimal_hours = AsyncMock(
            return_value={"optimal_windows": []},
        )
    ...
    async def test_generate_team_insights(self, team_analytics):
        ...
        team_analytics.team_insights.generate_team_insights = AsyncMock(
            return_value={"team_summary": {}},
        )
