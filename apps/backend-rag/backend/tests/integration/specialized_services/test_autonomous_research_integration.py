...
def autonomous_research_service(mock_search_service, mock_db_pool):
    ...
    service.research = AsyncMock(
        return_value={"success": True, "results": [], "synthesis": "Test synthesis"},
    )
    service.synthesize_results = AsyncMock(
        return_value={"synthesis": "Test synthesis", "key_differences": []},
    )
    return service
...
class TestAutonomousResearchIntegration:
    ...
    @pytest.mark.asyncio
    async def test_autonomous_research_routing(self, mock_search_service, mock_db_pool):
    ...
    async def test_research_result_synthesis(
        ...
        with patch.object(autonomous_research_service, "synthesize_results") as mock_synthesize:
            mock_synthesize.return_value = {
                ...
                "key_differences": ["Investment requirement", "Investor type", "Minimum capital"],
            }
    ...
    @pytest.mark.asyncio
    async def test_research_error_handling(self, autonomous_research_service, mock_search_service):
    ...
    @pytest.mark.asyncio
    async def test_research_caching(self, autonomous_research_service, mock_search_service):
