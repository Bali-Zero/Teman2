...
class TestZantaraFluidity:
    ...
    def test_low_abstain_threshold(self):
        ...
        assert 'ABSTAIN_THRESHOLD = 0.2' in constants_content or 'ABSTAIN_THRESHOLD=0.2' in constants_content, \
    ...
    def test_proactive_abstain_message(self):
        ...
        assert "Posso aiutarti con:" in reasoning_content or "posso aiutarti con" in reasoning_content.lower()
...
class TestZantaraStrength:
    ...
    def test_final_prompt_includes_suggestions(self):
        ...
        assert "IMPORTANT: After your answer" in reasoning_content or "After your answer" in reasoning_content
    ...
    def test_moderate_evidence_uses_positive_language(self):
        ...
        assert "available information" in reasoning_content.lower() or "informazioni disponibili" in reasoning_content.lower()
        # Should NOT use negative language
        assert "limited information" not in reasoning_content.lower() or reasoning_content.count("limited information") == 0
...
class TestZantaraProactivity:
    ...
    def test_abstain_message_quality(self):
        ...
        has_proactive_intro = "Posso aiutarti con:" in reasoning_content or "posso aiutarti con" in reasoning_content.lower()
    ...
    def test_prompt_proactivity_examples(self):
        ...
        assert "Vuoi sapere anche quanto costa?" in prompt_content or "quanto costa" in prompt_content.lower()
    ...
    def test_reasoning_includes_suggestion_instructions(self):
        ...
        assert "suggest 1-2" in reasoning_content.lower() or "suggerire" in reasoning_content.lower()
        assert "related topics" in reasoning_content.lower() or "argomenti correlati" in reasoning_content.lower()
        assert "next steps" in reasoning_content.lower() or "prossimi passi" in reasoning_content.lower()
