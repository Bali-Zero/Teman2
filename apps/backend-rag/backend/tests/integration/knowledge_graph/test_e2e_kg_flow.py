...
class TestE2EKnowledgeGraphFlow:
    ...
    @pytest.mark.asyncio
    async def test_entity_linking_to_episodic_memory(self, kg_pipeline, mock_db_pool):
    ...
    @pytest.mark.asyncio
    async def test_batch_processing_multiple_documents(self, kg_pipeline, mock_db_pool):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_in_kg_pipeline(self, kg_pipeline, mock_db_pool):
