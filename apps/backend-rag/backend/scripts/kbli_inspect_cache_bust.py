...
whole assembled `KBLIDetail` under `kbli_inspect_v7_{code}`, with a TTL from
...
WHAT IT DOES: for each `--only` code, reports whether `kbli_inspect_v7_{code}`
...
CACHE_KEY_TEMPLATE = "kbli_inspect_v7_{code}"
