...
whole assembled `KBLIDetail` under `kbli_inspect_v5_{code}`, with a TTL from
...
WHAT IT DOES: for each `--only` code, reports whether `kbli_inspect_v5_{code}`
...
CACHE_KEY_TEMPLATE = "kbli_inspect_v5_{code}"
