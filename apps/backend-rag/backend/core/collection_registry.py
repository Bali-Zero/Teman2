...
LOGICAL_TO_PHYSICAL_COLLECTIONS: Final[dict[str, str]] = {
    ...
    "kb_indonesian": "training_conversations_hybrid",
    "balizero_news": "intel_authoritative_sources",
    "zantara_books": "training_conversations_hybrid",
    "cultural_insights": "training_conversations_hybrid",
    "tax_updates": "tax_genius_hybrid",
    "tax_knowledge": "tax_genius_hybrid",
    "property_listings": "training_conversations_hybrid",
    "property_knowledge": "training_conversations_hybrid",
