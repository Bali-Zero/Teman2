...
VISA_DATA = {
    ...
    "A1": {
        ...
        "metadata": {
            ...
            "application_methods": ["Upon Arrival", "Pre-Arrival Electronic (evisa.imigrasi.go.id)"]
        }
    },
    "A4": {
    ...
    "F4": {
        ...
        "benefits": [
            "Government duties in Riau Islands",
            "Tourism activities"
        ],
        "metadata": {
            "series": "F",
    ...
    "C18": {
        ...
        "requirements": [
            "Passport valid for at least 6 months",
            "Invitation for competency test"
        ],
        "benefits": [
            "Testing proficiency/skills for work",
...
async def integrate_visas():
    ...
    try:
        ...
        for series, name in [("A", "Visa Free"), ("B", "VOA"), ("F", "VOA Short"), ("C", "Visit Visa")]:
            count = await conn.fetchval(
                "SELECT COUNT(*) FROM visa_types WHERE code LIKE $1",
                f"{series}%"
            )
