...
VISA_TYPES = [
    # =========================================================================
    # C7 Series - Arts & Culture Visas
    # =========================================================================
    {
        "code": "C7",
        "name": "C7 Arts & Culture Visa (General)",
        "category": "Visit",
        "duration": "30 days",
        "extensions": "NOT extendable",
        "total_stay": "30 days maximum (single entry)",
        "renewable": False,
        "processing_time_normal": "5-7 working days",
        "processing_time_express": "3-5 working days",
        "cost_visa": "Contact for quote",
        "cost_extension": "N/A (non-extendable)",
        "cost_details": {"service_fee": "Contact Bali Zero"},
        "requirements": [
            "Valid passport (min 6 months validity)",
            "Round trip ticket",
            "Proof of funds (min USD 1,000)",
            "Indonesian sponsor/guarantor (penjamin)",
            "Invitation letter from Indonesian organization",
            "Passport photos 4x6 red background",
        ],
        "restrictions": [
            "Maximum 30 days - CANNOT be extended",
            "Must exit Indonesia when permit expires",
            "For cultural activities only, not commercial work",
            "No payment/compensation allowed",
        ],
        "allowed_activities": [
            "Art exhibitions",
        ...
        "benefits": [
            "Legal status for cultural activities",
            "Sponsored entry for arts events",
            "Straightforward process",
        ],
        "process_steps": [
            "1. Secure Indonesian sponsor",
            "2. Obtain invitation letter from organizer",
            "3. Prepare required documents",
            "4. Apply via sponsor",
            "5. Receive e-Visa",
        ],
        "tips": [
            "30-day stay is strict - plan accordingly",
            "Cannot work commercially",
            "Need Indonesian sponsor",
        ],
        "foreign_eligible": True,
        "metadata": {
            "popularity": "low",
            "difficulty": "medium",
            "source": "imigrasi.go.id official",
        },
    },
    {
        "code": "C7A",
        "name": "C7A Music Performer Visa (Musisi)",
        "category": "Visit",
        "duration": "30 days",
        "extensions": "NOT extendable",
        "total_stay": "30 days maximum (single entry)",
        ...
        "cost_extension": "N/A (non-extendable)",
        "cost_details": {"service_fee": "IDR 4,500,000", "includes": "Urgent processing"},
        "requirements": [
            "Valid passport (min 6 months validity)",
            "Round trip ticket",
            "Proof of funds (min USD 1,000)",
            "Indonesian sponsor/guarantor (penjamin)",
            "Concert/performance invitation letter",
        ...
        "benefits": [
            "MAY receive payment/compensation for performances",
            "Legal status for music events",
            "Includes urgent processing at Bali Zero",
        ],
        "process_steps": [
            "1. Secure Indonesian sponsor",
            "2. Obtain performance invitation",
            "3. Prepare event documentation",
            "4. Apply via sponsor",
            "5. Receive e-Visa",
        ],
        "tips": [
            "Payment for performances IS allowed (unlike C7)",
            "30-day stay is strict",
            "Good for festival performers",
        ],
        "foreign_eligible": True,
        "metadata": {
            "popularity": "medium",
    ...
    {
        "code": "C7B",
        "name": "C7B Art Performance Visa (Pertunjukan)",
        "category": "Visit",
        "duration": "30 days",
        "extensions": "NOT extendable",
        "total_stay": "30 days maximum (single entry)",
        ...
        "requirements": [
            ...
            "Proof of funds (min USD 1,000)",
            "Indonesian sponsor/guarantor (penjamin)",
            "Exhibition/performance invitation letter",
        ...
        "restrictions": [
            "Maximum 30 days - CANNOT be extended",
            "Must exit Indonesia when permit expires",
            "For art performances (non-music)",
        ],
        "allowed_activities": [
            "Dance performances",
            "Theater shows",
        ...
        "benefits": [
            "Legal status for non-music performances",
            "Covers wide range of art forms",
            "Includes urgent processing at Bali Zero",
        ],
        "process_steps": [
            "1. Secure Indonesian sponsor",
            "2. Obtain exhibition/performance invitation",
            "3. Prepare event documentation",
            "4. Apply via sponsor",
            "5. Receive e-Visa",
        ],
        "tips": [
            "For dance, theater, fashion - NOT music",
            "30-day stay is strict",
            "Good for cultural exchange groups",
        ],
        "foreign_eligible": True,
        "metadata": {
            "popularity": "medium",
    ...
    {
        "code": "C7C",
        "name": "C7C Film Production Visa (Film/Syuting)",
        "category": "Visit",
        "duration": "30 days",
        "extensions": "NOT extendable",
        "total_stay": "30 days maximum (single entry)",
        "renewable": False,
        "processing_time_normal": "7-14 working days",
        "processing_time_express": "5-7 working days",
        "cost_visa": "Contact for quote",
        "cost_extension": "N/A (non-extendable)",
        "cost_details": {"service_fee": "Contact Bali Zero", "note": "Bekraf permit coordination included"},
        "requirements": [
            "Valid passport (min 6 months validity)",
            "Round trip ticket",
            "Proof of funds (min USD 1,000)",
            "Indonesian sponsor/guarantor (penjamin)",
            "Film permit from Bekraf (MANDATORY)",
        ...
        "restrictions": [
            "Maximum 30 days - CANNOT be extended",
            "Must exit Indonesia when permit expires",
            "For film/production activities only",
            "BEKRAF PERMIT MANDATORY",
        ],
        "allowed_activities": [
            "Film shooting (syuting film)",
            "Documentary production",
            "TV commercial filming",
            "Production crew support",
        ],
        "benefits": [
            "Legal status for film production",
            "Bali Zero assists with Bekraf coordination",
            "Covers entire production crew",
        ],
        "process_steps": [
            "1. Apply for Bekraf Film Permit first",
            "2. Secure Indonesian sponsor",
            "3. Prepare production documentation",
            "4. Apply for C7C visa",
            "5. Receive e-Visa",
        ],
        "tips": [
            "BEKRAF PERMIT IS MANDATORY - apply early",
            "Processing takes longer due to permit",
            "Plan for multiple entries if production is long",
        ],
        "foreign_eligible": True,
        "metadata": {
            "popularity": "low",
            "difficulty": "high",
            "bekraf_permit_required": True,
            "source": "imigrasi.go.id official",
        },
    },
    # =========================================================================
    ...
    # =========================================================================
    {
        ...
        "cost_details": {"government_fees": "IDR 2,000,000", "service_fee": "IDR 3,500,000"},
        "requirements": [
            "Valid passport (min 6 months validity)",
        ...
        "allowed_activities": ["Tourism", "Family visits", "Social activities"],
        "benefits": [
    ...
    # =========================================================================
    {
        ...
        "cost_details": {"government_fees": "IDR 10,000,000", "service_fee": "IDR 15,000,000"},
        "requirements": [
    ...
    # =========================================================================
    {
        ...
        "cost_details": {"government_fees": "IDR 8,000,000", "service_fee": "IDR 10,000,000"},
        "requirements": [
            "Valid passport (min 18 months validity)",
            "Photo 4x6 red background",
    ...
    },
    {
        ...
        "cost_details": {"government_fees": "IDR 5,000,000", "service_fee": "IDR 10,000,000"},
        "requirements": [
    ...
    # =========================================================================
    {
        ...
        "cost_extension": "IDR 8,000,000",
        "cost_details": {"government_fees": "IDR 5,000,000", "service_fee": "IDR 7,000,000"},
        "requirements": [
            "Valid passport (min 18 months)",
        ...
        "benefits": ["Legal research status", "Access to research sites", "Can sponsor family"],
        "process_steps": [
        ...
        "foreign_eligible": True,
        "metadata": {"popularity": "low", "difficulty": "high", "source": "notebooklm_session1"},
    },
    # =========================================================================
    ...
    # =========================================================================
    {
        ...
        "cost_details": {"government_fees": "IDR 4,000,000", "service_fee": "IDR 6,000,000"},
        "requirements": [
            "Valid passport (min 18 months)",
        ...
        "foreign_eligible": True,
        "metadata": {"popularity": "high", "difficulty": "low", "source": "notebooklm_session1"},
    },
    # =========================================================================
    # VOA - Visa on Arrival
    # =========================================================================
    {
        ...
        "restrictions": ["Cannot work", "Only 1 extension", "Must exit after 60 days"],
        "allowed_activities": ["Tourism", "Family visit", "Social activities"],
        "benefits": [
        ...
        "foreign_eligible": True,
        "metadata": {"popularity": "very_high", "difficulty": "very_low"},
    },
]
