...
SERVICES = [
    ...
    {
        "code": "visa_c7_music_art",
        "name": "C7A&B Music/Art Visa",
        "category": "single_entry_visa",
        "base_price": 4500000,
        "duration": None,
    ...
    {
        "code": "visa_c18_work_trial",
        "name": "C18 Work Trial Visa",
        "category": "single_entry_visa",
        "base_price": 5500000,
        "duration": 90,
    ...
    {
        "code": "kitas_investor_2yr_offshore",
    ...
    {
        "code": "kitas_investor_2yr_onshore",
    ...
    {
        "code": "kitas_investor_2yr_extend",
    ...
    {
        "code": "kitas_spouse_1yr_offshore",
    ...
    {
        "code": "kitas_spouse_2yr_offshore",
    ...
    {
        "code": "kitas_dependent_1yr_offshore",
    ...
    {
        "code": "kitas_dependent_1yr_onshore",
    ...
    {
        "code": "kitas_dependent_1yr_extend",
    ...
    {
        "code": "kitas_dependent_2yr_offshore",
    ...
    {
        "code": "kitas_dependent_2yr_onshore",
    ...
    {
        "code": "kitas_dependent_2yr_extend",
    ...
    {
        "code": "kitas_remote_worker_offshore",
    ...
    {
        "code": "kitas_remote_worker_onshore",
    ...
    {
        "code": "kitas_remote_worker_extend",
    ...
    {
        "code": "kitas_retirement_offshore",
    ...
    {
        "code": "kitap_investor_merp",
        "name": "Investor KITAP + MERP",
        "category": "kitap",
        "base_price": 55000000,
        "duration": None,
        "notes": "Expedited processing available",
    },
    {
        "code": "kitap_dependent_merp",
    ...
    {
        "code": "company_virtual_office",
        "name": "Virtual Office",
        "category": "company",
        "base_price": 5000000,
        "duration": None,
        "notes": "Solo se il cliente NON ha ancora una sede commerciale propria",
    },
    {
        ...
        "base_price": None,
        "duration": None,
        "notes": "Contact for quote",
    },
    {
        "code": "company_revision_akta",
        "name": "Revision Company (Akta Perubahan)",
        "category": "company",
        "base_price": None,
        "duration": None,
        "notes": "Richiesto se cambia indirizzo sede, direttori, attività",
    },
    # === other_process ===
    {
        "code": "other_reset_molina",
        "name": "Reset Molina",
        "category": "other",
        "base_price": 1000000,
        "duration": None,
    ...
    {
        "code": "other_acc_mutation_passport",
    ...
    {
        "code": "other_cancel_rptka_imta_wl",
    ...
    # === tax (not in JSON but needed) ===
    {
        ...
        "base_price": 3000000,
        "duration": None,
        "notes": "NPWP registration and reporting",
    },
    {
        "code": "tax_annual_reporting",
        "name": "Annual Tax Reporting",
        "category": "tax",
        "base_price": 3000000,
        "duration": None,
        "notes": "SPT Tahunan filing",
    },
]
...
async def downgrade(conn: asyncpg.Connection) -> None:
    ...
    await conn.execute("UPDATE practice_types SET is_active = true")
