    ...
    try:
        ...
        async with db_pool.acquire() as conn:
            await conn.execute("""
                ...
                VALUES ($1, $2, $3, $4, $5, $6)
            """, user_email, activity.action_type, activity.resource_type,
                activity.resource_id, activity.resource_title, activity.resource_category)

        logger.info(f"KB activity logged: {user_email} {activity.action_type} {activity.resource_type}/{activity.resource_id}")
