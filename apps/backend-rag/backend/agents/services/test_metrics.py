...
class TestGenerationMetrics:
    ...
    def success_rate(self) -> float:
        return (
            (self.tests_successful / self.tests_generated * 100)
...
class AgentMetrics:
    ...
    def record_operation(self, duration: float, success: bool = True, error: str | None = None):
        """Record an operation"""
...
class TestMetricsCollector:
    ...
    def get_summary(self) -> dict[str, Any]:
        ...
        total_operations = sum(
            a.operations_completed + a.operations_failed for a in self.agents.values()
        )
        avg_success_rate = (
...
# Singleton instance
_metrics_collector: TestMetricsCollector | None = None
