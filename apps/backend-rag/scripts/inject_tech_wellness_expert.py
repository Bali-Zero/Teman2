...
async def run():
    ...
    expert_data = [
        ...
        {"code": "62012", "name": "App Mobile", "bab": "IX (Digital/IT)", "pb_umku": ["TDPSE (PSE Kominfo)"]},
        {"code": "62015", "name": "Consulenza IT", "bab": "IX (Digital/IT)", "pb_umku": []},
        {"code": "62019", "name": "AI & Programmazione Avanzata", "bab": "IX (Digital/IT)", "pb_umku": ["Certificazione Algoritmi (se applicabile)", "Conformità Data Privacy"]},
        {"code": "63111", "name": "Hosting/Data Center", "bab": "IX (Digital/IT)", "pb_umku": ["Certificazione Sicurezza Infrastruttura"]},
        ...
        {"code": "96111", "name": "Saloni Bellezza", "bab": "VIII (Wellness)", "pb_umku": ["Standard Igiene Bellezza"]},
        {"code": "96112", "name": "Barbieri", "bab": "VIII (Wellness)", "pb_umku": []},
        {"code": "86101", "name": "Ospedali Privati", "bab": "VIII (Health)", "risk": "Tinggi", "pb_umku": ["Izin Operasional Rumah Sakit", "Sertifikat Akreditasi", "Permesso impiego medici stranieri (TKWNA)"]},
        {"code": "86201", "name": "Cliniche Mediche", "bab": "VIII (Health)", "risk": "Tinggi", "pb_umku": ["Izin Klinik", "Sertifikat SLS", "TKWNA permits"]},
        {"code": "86901", "name": "Medicina Alternativa", "bab": "VIII (Health)", "pb_umku": ["Sertifikat STPT (Medicina Tradizionale)"]}
    ]
