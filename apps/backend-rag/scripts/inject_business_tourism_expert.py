...
async def run():
    ...
    expert_data = [
        ...
        {"code": "73100", "name": "Pubblicità & Marketing", "bab": "VII (Business Services)", "pb_umku": []},
        {"code": "74101", "name": "Design Interni", "bab": "VII (Business Services)", "pb_umku": ["Certificato Competenza Professionale"]},
        {"code": "74102", "name": "Design Grafico", "bab": "VII (Business Services)", "pb_umku": []},
        ...
        {"code": "93193", "name": "Diving/Sub", "bab": "IV (Turismo)", "risk": "Menengah Tinggi", "pb_umku": ["Standard Sicurezza Subacquea", "Certificazione Istruttori"]},
        {"code": "93210", "name": "Parchi a tema", "bab": "IV (Turismo)", "risk": "Tinggi", "pb_umku": ["Izin Taman Rekreasi", "Certificato SLS"]},
        {"code": "93221", "name": "Beach Clubs / Nightclubs", "bab": "IV (Turismo)", "risk": "Tinggi", "pb_umku": ["Sertifikat Laik Sehat (SLS)", "SKPL A/B/C (Alcolici)", "Izin Gangguan (UUG/HO)"]},
        {"code": "93224", "name": "Musica dal vivo", "bab": "IV (Turismo)", "pb_umku": ["Permesso Diritti d'Autore (LMKN)"]}
    ]
