        ...
        for test_case in test_cases:
            try:
                ...
                if exists == expected:
                    ...
                    print(f"   ❌ {test_case['name']}: Path resolution incorrect (expected: {expected}, got: {exists})")
                    failed += 1
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            if resolved_path.exists():
                ...
                print(f"✅ Cover image read successfully")
                ...
                print(f"   ✅ Base64 decoding verified")
...
def test_missing_cover_image_handling():
    ...
    try:
        ...
        if staging_data.get("cover_image"):
            ...
            print(f"✅ Missing cover image handled correctly")
