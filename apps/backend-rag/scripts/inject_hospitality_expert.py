...
async def run():
    ...
    hospitality_data = [
        ...
        {'code': '55103', 'name': 'Hotel Bintang Tiga', 'desc': 'Aktivitas Hotel Bintang Tiga (3 Stars)'},
        {'code': '55104', 'name': 'Hotel Bintang Dua', 'desc': 'Aktivitas Hotel Bintang Dua (2 Stars)'},
