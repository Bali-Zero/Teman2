...
``+62 821 3454 721`` / ``Kerobokan`` / ``balizero.com``.
...
> Current router / service / test inventories are generated by
> `python3 scripts/docs_sync.py --json`; no numeric snapshot in tracked docs is authoritative.
