# D1 Tourism Multiple Entry Visa — Full Conversation

> **Generated**: 2025-12-10
> **Topics Covered**: D1 Tourist Visa, 5-year validity, 60-day stay limit, Multiple entry, No extension, Requirements, Bank statement, Comparison with VOA and KITAS
> **Style**: Frequent traveler, practical questions
...
**1 — Client:**
Halo, saya sering bolak-balik Indonesia untuk liburan dan visit keluarga. Ada visa yang cocok supaya ga ribet apply terus?
...
**5 — Client:**
Bank statement harus USD atau bisa currency lain?
...
- EUR 4,500
- AUD 8,000
- IDR 75.000.000 (kalau punya rekening Indo)
...
**9 — Client:**
Saya sering bawa laptop untuk kerja remote. Boleh kerja dengan D1?
...
**10 — Client:**
Entry point harus dari airport tertentu?
...
Multiple entry = flexible entry point setiap kali masuk.

**Tidak seperti VOA** yang restricted ke entry points tertentu.

**11 — Client:**
Ada blacklist negara yang ga bisa apply D1?
...
Check langsung ke embassy Indonesia di negara kamu untuk confirm eligibility.

**12 — Client:**
Ok, saya mau proceed. Langkah pertama apa?
...
2. **Contact embassy** atau pakai agent:
   - Book appointment (kalau embassy)
   - Submit online (kalau evisa eligible)

3. **Bayar fee** (government + agent)

4. **Wait processing** (5-10 hari)

5. **Collect visa** atau terima evisa PDF

6. **Travel to Indonesia!**

Mau kita bantu processing-nya?

---

## English Version — Expat Professional

**1 — Client:**
Hi, I travel to Indonesia frequently for holidays and family visits. Is there a visa that would save me the hassle of applying every time?
...
**5 — Client:**
Does the bank statement need to be in USD?
...
- EUR 4,500
- AUD 8,000
- IDR 75,000,000 (if you have an Indonesian account)
...
**9 — Client:**
I often bring my laptop for remote work. Can I work on a D1?
...
**10 — Client:**
Do I need to enter through specific airports?
...
Multiple entry = flexible entry point each time.

**Unlike VOA** which is restricted to certain entry points.

**11 — Client:**
Are there blacklisted countries that can't apply for D1?
...
Check directly with Indonesian embassy in your country to confirm eligibility.

**12 — Client:**
Okay, I want to proceed. What's the first step?

**Consultant:**
**Steps to apply for D1:**

1. **Collect documents:**
   - Passport (color scan)
   - Red background photo 4x6cm
   - Bank statement 3 months
   - Flight booking
   - Hotel reservation

2. **Contact embassy** or use an agent:
   - Book appointment (if embassy)
   - Submit online (if evisa eligible)

3. **Pay fees** (government + agent)

4. **Wait for processing** (5-10 days)

5. **Collect visa** or receive evisa PDF

6. **Travel to Indonesia!**

Would you like us to assist with the processing?
