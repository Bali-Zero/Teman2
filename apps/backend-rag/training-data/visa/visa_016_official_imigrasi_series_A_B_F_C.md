# Official Indonesian Visa Classification - Series A, B, F, C

> **Source:** imigrasi.go.id (Official)
> **Last Updated:** 2026-01-13
> **Legal Basis:** Keputusan Menteri Imigrasi dan Pemasyarakatan Nomor M.IP-08.GR.01.01 tahun 2025

---

## A Series - Bebas Visa (Visa-Free Entry)
...
|-----------|-------|
| Code | A4 |
| Type | Visa-Free (Government Assignment) |
| Stay | 30 days maximum |
| Entry | Single entry |
| Extension | NOT extendable |
| PNBP Fee | Rp 0 (FREE) |
...
|-----------|-------|
| Code | A37 |
| Type | Visa-Free (Marine Operations) |
| Stay | 30 days maximum |
| Entry | Single entry |
| Extension | NOT extendable |
| PNBP Fee | Rp 0 (FREE) |
...
## B Series - Visa Kunjungan Saat Kedatangan (Visa on Arrival)
...
| Stay | 30 days initial |
| Extension | 1x extension (total 60 days) |
| Convertible | YES (via bridging visa) |
| PNBP Fee | Rp 500,000 |
| Sponsor | Not required |
...
1. **Pre-Arrival + Pre-Payment (e-VOA):**
   - Apply at evisa.imigrasi.go.id or indonesiavoa.vfsevisa.id
   - Upload: passport (6+ months validity), photo, return ticket
   - Pay via debit/credit card
   - Receive e-Visa within 24 hours
   - e-VOA valid for 90 days from issuance

2. **Pre-Arrival + Payment on Arrival:**
   - Apply at evisa.imigrasi.go.id
   - Pay at designated bank counter at airport
   - Collect e-VOA at visa counter

3. **On Arrival (Non-Electronic):**
   - Pay at designated bank counter at immigration area
   - Receive voucher
...
|-----------|-------|
| Code | B4 |
| Type | Visa on Arrival (Government) |
| Stay | 30 days initial |
| Extension | 1x extension (total 60 days) |
| PNBP Fee | Rp 500,000 |
| Sponsor | Not required |

**Same application process as B1**

---

## F Series - Visa Kunjungan Saat Kedatangan (Kepulauan Riau Only)
...
**Application:**
On arrival only - pay at designated bank counter
...
|-----------|-------|
| Code | F4 |
| Type | VOA (Riau Islands - Government) |
| Stay | 7 days maximum |
| Extension | NOT extendable |
| PNBP Fee | Rp 250,000 |

**Same entry points as F1**

---

## C Series - Visa Kunjungan (Single Entry Visit Visa)
...
- Site visits (offices, factories, production facilities)
- Investment location surveys
- Mining site visits
- Medical activities
...
|-----------|-------|
| Code | C1 |
| Type | Single Entry Visit Visa |
| Stay | 60 days initial |
| Extension | Multiple extensions up to 180 days total |
| Convertible | YES (to KITAS) |
| PNBP Fee | Rp 1,000,000 |
...
- Peraturan Pemerintah Nomor 45 tahun 2024 - Tarif PNBP Kemenkumham
- Peraturan Menteri Hukum dan HAM RI Nomor 11 Tahun 2024 - Visa dan Izin Tinggal
- Peraturan Menteri Hukum dan HAM RI Nomor 22 tahun 2023 - Visa dan Izin Tinggal
- Keputusan Menteri Imigrasi dan Pemasyarakatan Nomor M.IP-08.GR.01.01 tahun 2025 - Klasifikasi Visa
- Peraturan Menteri Keuangan RI Nomor 9/PMK.02/2022 - PNBP Keimigrasian
- Peraturan Menteri Keuangan RI Nomor 82 Tahun 2023 - PNBP Golden Visa
