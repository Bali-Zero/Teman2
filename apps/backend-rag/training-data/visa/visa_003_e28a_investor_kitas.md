# E28A Investor KITAS — Full Conversation (Intermediate)

> **Generated**: 2025-12-10
> **Topics Covered**: E28A Investor KITAS, Post PT PMA setup, Timeline, Costs, IMTA coordination, Multiple directors, Validity, Extension
> **Style**: Business owner post-setup, detail-oriented planner

---

## 🇮🇩 Indonesian Version — Jakarta Business Professional

**1 — Client:**
Halo, PT PMA saya baru selesai setup minggu lalu. Sekarang saya perlu apply KITAS sebagai investor. Prosesnya gimana?

**Consultant:**
Halo! Selamat untuk PT PMA-nya yang baru aktif!
...
**2 — Client:**
Syarat E28A apa saja setelah PT PMA aktif?
...
- NPWP perusahaan
- SK Kemenkumham (approval dari Kementerian Hukum & HAM)
...
- CV/resume
- Surat penunjukan sebagai direktur/komisaris
- Medical checkup
- Police clearance dari negara asal (apostille)

**Timeline:** 3-4 minggu setelah dokumen lengkap.

**3 — Client:**
Saya direktur utama, apakah perlu IMTA juga?

**Consultant:**
**Yes, technically.**

E28A = izin tinggal (residence permit)
...
**Kami yang handle RPTKA** — PT kamu tinggal provide data.

**5 — Client:**
PT saya belum hire karyawan lokal, baru saya seorang. Gimana?
...
**6 — Client:**
Berapa gaji minimum karyawan lokal?
...
**Total cost per employee:** ~UMR + 10-15% (BPJS).

**7 — Client:**
Oke noted. Kembali ke E28A — timeline-nya berapa lama?
...
**Rekomendasi:** Offshore lebih cepat dan reliable.

**8 — Client:**
Biaya totalnya berapa dari awal sampai dapat KITAS?
...
**9 — Client:**
E28A bisa untuk berapa orang dalam satu PT?
...
**10 — Client:**
Saya mau add istri saya sebagai komisaris. Dia juga butuh E28A?
...
**11 — Client:**
Kalau E28A sudah dapat, kewajiban saya apa?
...
2. **LKPM Quarterly** (laporan investasi)
   ...
   - Isi: realisasi investasi, revenue, jumlah karyawan
   - **Mandatory** untuk PT PMA

3. **Tax filing:**
   - PPh 21 bulanan (gaji karyawan)
   - PPh Badan tahunan (corporate tax)
   - PPN (kalau PKP)
...
**12 — Client:**
LKPM itu ribet nggak? Saya harus isi sendiri?
...
**13 — Client:**
Setelah 2 tahun, extend E28A gimana?
...
- PT financial statements (tunjukkan operasional aktif)
- Proof of tax compliance (SPT filed, no arrears)
- LKPM up to date
...
**Bisa extend berkali-kali** selama PT masih aktif & compliant.

**14 — Client:**
Kalau PT saya nggak profitable, KITAS bisa di-reject saat extension?
...
- ✅ **Ada operasional** (revenue/activity, meskipun rugi)
- ✅ **Local employees** (hire commitment)
...
**15 — Client:**
Gaji saya sebagai direktur diatur gimana? Harus berapa?

**Consultant:**
**Tidak ada minimum gaji** untuk direktur asing di E28A.

**Opsi:**

1. **Salary dari PT:**
   - PT bayar gaji ke kamu
   - Kena **PPh 21** (tax brackets 5-35%)
   - Bisa diklaim sebagai biaya operasional PT

2. **Dividend:**
   - Ambil profit di akhir tahun
   - Kena **PPh 23 = 10%**
   - Lebih tax-efficient kalau profit besar

3. **No salary (reinvest):**
   - Tidak terima gaji
   - Semua profit reinvest ke PT
...
**16 — Client:**
Saya perlu travel sering ke Singapura. E28A allow multiple entry kan?
...
**17 — Client:**
Kalau saya mau add business lain (KBLI baru), harus apply KITAS baru?

**Consultant:**
**Tidak perlu KITAS baru.**

**Process:**

1. **Revisi PT PMA:**
   - Add KBLI baru via OSS system
   - Inject additional capital (Rp 10 miliar per KBLI baru)
   - Update akta (notary amendment)

2. **Update RPTKA:**
   - Notify Kemnaker tentang business expansion
   - Update employee plan (hire more locals if needed)

3. **KITAS tetap valid** — tidak perlu reapply

**Timeline:** 2-4 minggu untuk revisi PT + RPTKA update.

**18 — Client:**
Bisakah saya convert E28A ke permanent residence (KITAP)?
...
- Pass Indonesian language test (basic level)
...
**20 — Client:**
Perfect! Dokumen PT saya sudah lengkap. Saya kirim sekarang ya. Thanks!

**Consultant:**
Silakan! Kirim semua ke:
...
3. NPWP Perusahaan
4. Surat domisili PT
5. Proof of capital deposit
6. Personal documents (paspor, foto, CV, medical, police clearance)

We'll review within **24 hours** and start processing immediately.

Congrats on your PT PMA — welcome to doing business in Indonesia! 🇮🇩

---

## 🇬🇧 English Version — Business Professional

**1 — Client:**
Hi, my PT PMA was just completed last week. Now I need to apply for a KITAS as an investor. What's the process?

**Consultant:**
Hi! Congratulations on your new PT PMA!
...
**2 — Client:**
What are the E28A requirements after PT PMA is active?
...
**Timeline:** 3-4 weeks after complete documents.

**3 — Client:**
I'm the main director. Do I also need IMTA?

**Consultant:**
**Yes, technically.**

E28A = residence permit
**IMTA** = work permit
...
**We handle RPTKA** — your PT just provides data.

**5 — Client:**
My PT hasn't hired local staff yet, just me. How does that work?
...
**6 — Client:**
What's the minimum salary for local employees?
...
**7 — Client:**
Got it. Back to E28A — what's the timeline?
...
**Recommendation:** Offshore is faster and more reliable.

**8 — Client:**
What's the total cost from start to receiving KITAS?
...
**9 — Client:**
How many people can get E28A in one PT?
...
**10 — Client:**
I want to add my wife as commissioner. Does she also need E28A?
...
**11 — Client:**
Once I get E28A, what are my obligations?
...
2. **LKPM Quarterly** (investment report)
   ...
   - Content: investment realization, revenue, employee count
   - **Mandatory** for PT PMA

3. **Tax filing:**
   - Monthly PPh 21 (employee salaries)
   - Annual PPh Badan (corporate tax)
   - PPN (if PKP)
...
**12 — Client:**
Is LKPM complicated? Do I fill it myself?
...
**13 — Client:**
After 2 years, how do I extend E28A?
...
- PT financial statements (show active operations)
- Proof of tax compliance (SPT filed, no arrears)
- LKPM up to date
...
**Can extend multiple times** as long as PT remains active & compliant.

**14 — Client:**
If my PT isn't profitable, can KITAS be rejected during extension?
...
- ✅ **LKPM filed** regularly
- ✅ **Has operations** (revenue/activity, even if loss)
- ✅ **Local employees** (hiring commitment)
...
**15 — Client:**
How is my salary as director regulated? How much should it be?

**Consultant:**
**No minimum salary** for foreign directors on E28A.

**Options:**

1. **Salary from PT:**
   - PT pays you salary
   - Subject to **PPh 21** (tax brackets 5-35%)
   - Can be claimed as PT operating expense

2. **Dividend:**
   - Take profit at year-end
   - Subject to **PPh 23 = 10%**
   - More tax-efficient for large profits

3. **No salary (reinvest):**
   - Don't take salary
   - Reinvest all profit into PT
   - Take dividend later
...
**16 — Client:**
I need to travel frequently to Singapore. E28A allows multiple entry, right?
...
**17 — Client:**
If I want to add another business (new KBLI), do I need a new KITAS?
...
1. **Revise PT PMA:**
   - Add new KBLI via OSS system
   - Inject additional capital (IDR 10 billion per new KBLI)
   - Update deed (notary amendment)

2. **Update RPTKA:**
   - Notify Kemnaker about business expansion
   - Update employee plan (hire more locals if needed)

3. **KITAS remains valid** — no need to reapply

**Timeline:** 2-4 weeks for PT revision + RPTKA update.

**18 — Client:**
Can I convert E28A to permanent residence (KITAP)?
...
**20 — Client:**
Perfect! My PT documents are complete. I'll send them now. Thanks!

**Consultant:**
Please do! Send everything to:
...
2. NIB
3. Company NPWP
4. PT domicile letter
5. Proof of capital deposit
6. Personal documents (passport, photo, CV, medical, police clearance)
...
**1 — Client:**
Mas, PT PMA ku nembe rampung setup minggu wingi. Saiki aku butuh apply KITAS dadi investor. Prosesne piye?

**Consultant:**
Halo! Selamat kanggo PT PMA-ne sing anyar aktif!
...
**Validity:** 2 taun, multiple entry.

**2 — Client:**
Syarat E28A opo wae sakwise PT PMA aktif?
...
- NIB (Nomor Induk Berusaha) aktif
- NPWP perusahaan
- SK Kemenkumham (approval soko Kementerian Hukum & HAM)
- Surat domisili perusahaan
- Proof of capital deposit (min Rp 2.5 miliar disetor)
...
- CV/resume
- Surat penunjukan dadi direktur/komisaris
- Medical checkup
- Police clearance soko negara asal (apostille)

**Timeline:** 3-4 minggu sakwise dokumen lengkap.

**3 — Client:**
Aku direktur utama, opo perlu IMTA yo?
...
**Kito sing handle RPTKA** — PT sampeyan tinggal provide data.

**5 — Client:**
PT ku durung hire karyawan lokal, anyar aku dewe. Piye?
...
**6 — Client:**
Piro gaji minimum karyawan lokal?
...
**7 — Client:**
Oke noted. Balik neng E28A — timeline-ne piro suwi?
...
**Rekomendasi:** Offshore luwih cepet lan reliable.

**8 — Client:**
Biaya totale piro soko awal sampek entuk KITAS?
...
**9 — Client:**
E28A iso kanggo piro wong neng siji PT?
...
**10 — Client:**
Aku arep add bojoku dadi komisaris. Dheweke yo butuh E28A?
...
**11 — Client:**
Nek E28A wis entuk, kewajiban ku opo?
...
**12 — Client:**
LKPM iku ribet ora? Aku kudu isi dewe?
...
**13 — Client:**
Sakwise 2 taun, extend E28A piye?
...
- Updated RPTKA (show karyawan lokal bertambah)
- PT financial statements (tunjukke operasional aktif)
- Proof of tax compliance (SPT filed, ora ono arrears)
- LKPM up to date
...
**Iso extend pirang-pirang kali** salawase PT isih aktif & compliant.

**14 — Client:**
Nek PT ku ora profitable, KITAS iso di-reject naliko extension?
...
- ✅ **Tax compliance** (SPT filed on time, bayar pajak)
- ✅ **LKPM filed** regularly
- ✅ **Ono operasional** (revenue/activity, sanajan rugi)
- ✅ **Local employees** (hire commitment)
...
**15 — Client:**
Gaji ku dadi direktur diatur piye? Kudu piro?

**Consultant:**
**Ora ono minimum gaji** kanggo direktur asing neng E28A.

**Opsi:**

1. **Salary soko PT:**
   - PT bayar gaji neng sampeyan
   - Kena **PPh 21** (tax brackets 5-35%)
   - Iso diklaim dadi biaya operasional PT

2. **Dividend:**
   - Jukut profit neng akhir taun
   - Kena **PPh 23 = 10%**
   - Luwih tax-efficient nek profit gedhe

3. **Ora ono salary (reinvest):**
   - Ora nompo gaji
   - Kabeh profit reinvest neng PT
...
**16 — Client:**
Aku perlu travel kerep neng Singapura. E28A allow multiple entry kan?
...
**17 — Client:**
Nek aku arep add bisnis liyo (KBLI anyar), kudu apply KITAS anyar?

**Consultant:**
**Ora perlu KITAS anyar.**

**Process:**

1. **Revisi PT PMA:**
   - Add KBLI anyar via OSS system
   - Inject additional capital (Rp 10 miliar per KBLI anyar)
   - Update akta (notary amendment)

2. **Update RPTKA:**
   - Notify Kemnaker soal business expansion
   - Update employee plan (hire more locals nek perlu)

3. **KITAS tetep valid** — ora perlu reapply

**Timeline:** 2-4 minggu kanggo revisi PT + RPTKA update.

**18 — Client:**
Isoko aku convert E28A neng permanent residence (KITAP)?
...
**20 — Client:**
Perfect! Dokumen PT ku wis lengkap. Tak kirim saiki yo. Thanks!

**Consultant:**
Monggo! Kirim kabehe neng:
...
Kito review dalam **24 jam** lan mulai processing langsung.

Congrats neng PT PMA sampeyan — welcome to doing business in Indonesia! 🇮🇩
