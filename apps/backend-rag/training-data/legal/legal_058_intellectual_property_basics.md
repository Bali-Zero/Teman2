...
> **Topics Covered**: Trademark Registration, Copyright Protection, Patent Basics, Licensing Agreements, Brand Protection, DJKI Process, IP Enforcement
> **Style**: Startup founder, detail-oriented, building tech brand
...
**1 — Client:**
Selamat siang. Saya baru launch startup tech di Bali, namanya "KopiByte" - platform untuk order kopi specialty. Saya mau protect brand saya biar gak dicuri orang. Gimana caranya daftar trademark di Indonesia?

**Consultant:**
Selamat siang! Selamat untuk launch startupnya.

Untuk protect brand "KopiByte", Anda perlu daftar **merek dagang** ke **DJKI (Direktorat Jenderal Kekayaan Intelektual)** di bawah Kemenkumham.

**Proses Pendaftaran Merek:**

1. **Pencarian Merek** - Cek dulu apakah "KopiByte" sudah terdaftar
2. **Permohonan Online** - Via dgip.go.id
3. **Pemeriksaan Formalitas** - 30 hari
4. **Publikasi** - 2 bulan untuk oposisi
5. **Pemeriksaan Substantif** - 150 hari
6. **Sertifikat** - Jika lolos
...
Perlu saya bantu dengan proses lengkapnya?

---

**2 — Client:**
Wah lama juga ya 8-12 bulan. Kalau selama proses pendaftaran ada yang pake nama "KopiByte" juga gimana? Saya kan gak bisa nunggu setahun baru dilindungi.
...
4. Dokumentasikan penggunaan pertama (first use evidence)

Mau saya bantu pencarian merek dulu? Biaya pencarian Rp 1.500.000 termasuk analisis ketersediaan.

---

**3 — Client:**
Ok, saya mau pencarian dulu. Btw KopiByte ini bukan cuma nama, saya juga punya logo khusus. Itu didaftarkan terpisah atau gimana?
...
Mau mulai dengan word mark "KopiByte" dulu?

---

**4 — Client:**
Oke daftar terpisah aja. Satu lagi, saya juga develop app sendiri. Source code-nya perlu didaftarkan juga? Takut ada yang copy fitur-fitur saya.
...
- ✅ UI/UX design
- ✅ Dokumentasi
- ❌ Ide/konsep fitur (tidak bisa dilindungi)
- ❌ Algoritma umum

Jadi jika kompetitor buat fitur serupa dengan code berbeda, itu legal. Hak cipta protect EKSPRESI, bukan IDE.

---

**5 — Client:**
Ohh jadi kalau ada yang bikin app serupa dengan cara coding sendiri itu gak bisa digugat ya? Terus gimana protect fitur unik saya dong?

**Consultant:**
Untuk protect **fitur/fungsi unik**, Anda butuh **PATEN**, bukan hak cipta!
...
4. **Rahasia Dagang** - Algoritma proprietary (jangan disclose)

Paten biasanya untuk startup yang sudah scale dan punya budget R&D besar.

---

**6 — Client:**
Noted! Berarti untuk sekarang fokus merek + hak cipta aja dulu ya. Btw kelas merek itu maksudnya apa? Saya baca-baca ada kelas 9, kelas 35, bingung.
...
Jika Anda daftar 1 kelas tapi kompetitor daftar di kelas lain, mereka bisa pakai nama sama di kelas itu!

---

**7 — Client:**
Wow baru tau ada 45 kelas. Saya mau yang ideal, kelas 9, 35, dan 43. Total Rp 5.400.000 untuk 3 kelas ya?

Oh ya, saya juga mau hire freelance designer buat bikin marketing materials. Gimana mastiin design yang dia bikin jadi milik saya?
...
**Solusi - Work for Hire Agreement:**
...
5. **Warranty:**
   > Jaminan design original, tidak menjiplak
...
Tanpa kontrak ini, Anda TIDAK memiliki design yang dibuat freelancer!

---

**8 — Client:**
Duh, saya sudah pernah hire designer sebelumnya tanpa kontrak. Design logo saya sekarang itu hasil kerja dia. Gimana dong?

**Consultant:**
**Situasi ini bisa diperbaiki dengan retroactive assignment:**

**Langkah Penyelesaian:**

1. **Contact Designer:**
   - Hubungi, jelaskan situasi profesional
   - Minta tanda tangan assignment agreement

2. **Retroactive IP Assignment:**
   - Dokumen yang menyatakan transfer hak cipta
   - Berlaku surut sejak tanggal pembuatan
   - Pertimbangkan kompensasi tambahan (fair dealing)

3. **Get Source Files:**
   - Minta semua source files (AI, PSD, dll)
...
**Pelajaran:**
Selalu gunakan kontrak SEBELUM project dimulai. Retroactive assignment lebih mahal dan risky.

Mau saya bantu draft assignment agreement untuk designer Anda?

---

**9 — Client:**
Oke saya akan hubungi designer-nya. Mudah-mudahan mau sign.

Pertanyaan lain, kalau saya mau license teknologi dari partner (misal payment gateway), apa yang harus saya perhatikan di kontrak license-nya?
...
- ❌ No source code escrow (untuk critical software)

Mau saya review license agreement spesifik? Biaya review: Rp 3.500.000/dokumen.

---

**10 — Client:**
Berguna banget checklistnya! Nanti saya minta review ya kalau udah ada draft dari payment gateway-nya.

Last question, gimana kalau ada yang pake nama "KopiByte" atau nama mirip di social media/domain? Bisa saya tuntut?

**Consultant:**
**Enforcement Tergantung Status:**
...
1. **Somasi (Cease & Desist):**
   - Surat resmi dari lawyer
   - Minta stop penggunaan dalam 14 hari
   - Biaya: Rp 2.500.000

2. **Jika Tidak Patuh:**
   - Laporan ke platform (Instagram, TikTok, dll)
   - Dispute domain via PANDI/WIPO
...
**Takeaway:** Daftarkan merek SEGERA = enforcement power maksimal.
...
4. Retroactive assignment dari designer
5. Kontrak untuk future freelancers

Bisa kasih breakdown total biaya?

**Consultant:**
**Breakdown Total Biaya IP Protection KopiByte:**
...
Mau proceed dengan package ini?

---

**12 — Client:**
Deal! Saya proceed. Tapi tolong prioritaskan pencarian merek dulu ya, karena saya mau launch marketing campaign bulan depan. Kalau nama "KopiByte" sudah diambil orang, saya harus rebrand secepatnya.

**Consultant:**
**Perfect, prioritas pencarian merek!**
...
4. Alamat pemohon
5. Deskripsi bisnis singkat

**DP Pencarian: Rp 750.000**

Transfer ke rekening kami dan kirim data di atas, saya mulai Senin!
...
Oh iya, PT-nya belum jadi, masih proses di notaris. Bisa daftar merek dulu sebelum PT jadi?
...
**Timeline PT:**
Biasanya akta PT jadi 2-4 minggu. Transfer merek bisa dilakukan kapan saja setelah itu.

Confirm mau proceed dengan nama pribadi?

---

**14 — Client:**
Oke daftar nama pribadi dulu aja. Nama saya: Andi Prasetyo, KTP Jakarta.

Satu concern lagi, nama "KopiByte" itu saya dapat dari brainstorming sama co-founder saya. Dia ikut contribute ide nama. Nanti ada masalah gak ya soal ownership?
...
Saya bisa bantu draft **IP Acknowledgment Letter** untuk Anda dan co-founder.
Biaya: Rp 1.500.000 (simple letter) atau include dalam Founders' Agreement komprehensif Rp 7.500.000

Ini KRITIS sebelum merek terdaftar atas nama pribadi Anda!

---

**15 — Client:**
Bener juga ya. Mending clear dari awal. Draft IP Acknowledgment Letter aja dulu yang simple. Founders' Agreement nanti setelah PT jadi.

Jadi total biaya sekarang jadi berapa dengan tambahan ini?

**Consultant:**
**Updated Breakdown dengan IP Acknowledgment:**
...
- Setelah PT jadi: Rp 6.000.000 (Phase 3)
...
**16 — Client:**
Deal! Transfer Rp 1.5 juta hari ini.

Oh ya, satu lagi. Saya juga punya nama tagline "Coffee, Coded for You". Itu perlu didaftarkan juga atau gimana?
...
Mau include tagline di package atau skip dulu?

---

**17 — Client:**
Skip dulu aja tagline-nya, nanti aja kalau sudah establish.

Terakhir nih, kalau suatu hari saya mau jual startup atau merger, IP registration ini berpengaruh ke valuation gak?

**Consultant:**
**IP registration SANGAT berpengaruh ke valuation!**
...
- No pending IP disputes?

**Kesimpulan:**
Rp 20 juta investasi IP sekarang = could be worth millions dalam exit valuation.

IP adalah **intangible asset** yang real dan measurable!

---

**18 — Client:**
Makes total sense. Saya glad kita ngobrol ini sebelum launch. Banyak yang gak kepikiran ternyata.

Kapan bisa mulai pencarian merek?

**Consultant:**
**Bisa mulai SENIN ini!**
...
1. **Transfer Rp 1.500.000** ke:
   - Bank: BCA
   - No. Rek: 123-456-7890
   - A/N: Nuzantara Legal Consulting

2. **Data untuk IP Acknowledgment:**
   - Nama lengkap founder 1 (Anda): Andi Prasetyo
   - Nama lengkap co-founder: [nama]
   - Kontribusi masing-masing ke "KopiByte" concept

3. **Konfirmasi nama merek:**
   - "KopiByte" (satu kata, capital K dan B)
...
Spelling: "KopiByte" - huruf K dan B kapital, sisanya lowercase, satu kata tanpa spasi.

**Consultant:**
**Excellent! Semua data received.**

**Confirmation:**

✅ Transfer Rp 1.500.000 - RECEIVED
✅ Founder 1: Andi Prasetyo
✅ Co-founder: Budi Santoso
✅ Brand: KopiByte (K dan B kapital)
✅ Kelas: 9, 35, 43
...
Ada pertanyaan lain sebelum kita mulai?

---

**20 — Client:**
Sudah lengkap! Terima kasih banyak penjelasannya, sangat helpful. Saya tunggu draft IP Acknowledgment hari Jumat ya.

Good luck dengan pencarian mereknya, semoga clear! 🤞
...
4. Assignment agreements untuk freelancers
...
Saya kabari Jumat dengan draft IP Acknowledgment.
Pencarian merek result Kamis/Jumat.

**Semoga sukses dengan launch KopiByte!** 🚀

Best regards,
Legal Team - Nuzantara Consulting
...
**1 — Client:**
Good afternoon. I just launched a tech startup in Bali called "KopiByte" - it's a specialty coffee ordering platform. I want to protect my brand so nobody can steal it. How do I register a trademark in Indonesia?

**Consultant:**
Good afternoon! Congratulations on your launch.

To protect the "KopiByte" brand, you need to register a **trademark** with **DJKI (Directorate General of Intellectual Property)** under the Ministry of Law and Human Rights.

**Trademark Registration Process:**

1. **Trademark Search** - Check if "KopiByte" is already registered
2. **Online Application** - Via dgip.go.id
3. **Formality Examination** - 30 days
4. **Publication** - 2 months for opposition period
5. **Substantive Examination** - 150 days
6. **Certificate** - If approved
...
Would you like me to assist with the complete process?

---

**2 — Client:**
Wow, 8-12 months is quite long. What if someone uses the name "KopiByte" during the registration process? I can't wait a year before getting protection.
...
4. Document your first use (first use evidence)

Would you like me to help with a trademark search first? Search fee: IDR 1,500,000 including availability analysis.

---

**3 — Client:**
Okay, I'll do the search first. By the way, KopiByte isn't just a name - I also have a custom logo. Should that be registered separately or together?
...
Would you like to start with the "KopiByte" word mark first?

---

**4 — Client:**
Okay, let's register them separately. One more thing - I also developed the app myself. Does my source code need to be registered? I'm worried someone might copy my features.
...
- ✅ UI/UX design
- ✅ Documentation
- ❌ Ideas/feature concepts (cannot be protected)
- ❌ General algorithms

So if a competitor creates a similar feature with different code, that's legal. Copyright protects EXPRESSION, not IDEAS.

---

**5 — Client:**
Oh, so if someone builds a similar app but codes it themselves, I can't sue them? Then how do I protect my unique features?

**Consultant:**
To protect **unique features/functionality**, you need a **PATENT**, not copyright!
...
4. **Trade Secret** - Proprietary algorithms (don't disclose)

Patents are typically for startups that have scaled and have a large R&D budget.

---

**6 — Client:**
Noted! So for now, focus on trademark + copyright first. By the way, what does trademark "class" mean? I read about class 9, class 35 - it's confusing.
...
If you register in 1 class but a competitor registers in another class, they can legally use the same name in that class!

---

**7 — Client:**
Wow, I didn't know there were 45 classes. I want the ideal option - classes 9, 35, and 43. Total IDR 5,400,000 for 3 classes, right?

Oh, I also want to hire a freelance designer to create marketing materials. How do I make sure the designs they create belong to me?
...
**Solution - Work for Hire Agreement:**
...
5. **Warranty:**
   > Guarantee design is original, not copied
...
Without this contract, you DO NOT own designs created by freelancers!

---

**8 — Client:**
Damn, I already hired a designer before without a contract. My current logo was made by them. What do I do?

**Consultant:**
**This situation can be fixed with a retroactive assignment:**

**Resolution Steps:**

1. **Contact the Designer:**
   - Reach out, explain the situation professionally
   - Request signature on an assignment agreement

2. **Retroactive IP Assignment:**
   - Document stating transfer of copyright
   - Effective retroactively from creation date
   - Consider additional compensation (fair dealing)

3. **Get Source Files:**
   - Request all source files (AI, PSD, etc.)
...
**Lesson:**
Always use contracts BEFORE projects start. Retroactive assignment is more expensive and risky.

Would you like me to help draft an assignment agreement for your designer?

---

**9 — Client:**
Okay, I'll contact the designer. Hopefully they'll sign.

Another question - if I want to license technology from a partner (e.g., payment gateway), what should I look for in the license agreement?
...
- ❌ Licensor can terminate without cause
- ❌ No source code escrow (for critical software)

Would you like me to review a specific license agreement? Review fee: IDR 3,500,000/document.

---

**10 — Client:**
That checklist is super helpful! I'll send for review once I have the draft from the payment gateway.

Last question - what if someone uses the name "KopiByte" or similar name on social media/domain? Can I sue them?

**Consultant:**
**Enforcement Depends on Status:**
...
1. **Cease & Desist Letter:**
   - Formal letter from lawyer
   - Request to stop use within 14 days
   - Cost: IDR 2,500,000

2. **If Non-Compliant:**
   - Report to platform (Instagram, TikTok, etc.)
   - Domain dispute via PANDI/WIPO
   - Lawsuit to Commercial Court

3. **Commercial Court (Pengadilan Niaga):**
...
**Takeaway:** Register trademark ASAP = maximum enforcement power.
...
4. Retroactive assignment from designer
5. Contracts for future freelancers

Can you give me a total cost breakdown?

**Consultant:**
**Total IP Protection Cost Breakdown for KopiByte:**
...
Ready to proceed with this package?

---

**12 — Client:**
Deal! I'll proceed. But please prioritize the trademark search - I want to launch a marketing campaign next month. If "KopiByte" is already taken, I need to rebrand ASAP.

**Consultant:**
**Perfect, trademark search is priority!**
...
4. Applicant address
5. Brief business description

**Search deposit: IDR 750,000**

Transfer to our account and send the above data - I'll start Monday!
...
Oh, the PT isn't ready yet - still in process with the notary. Can I register the trademark before the PT is established?
...
**PT Timeline:**
PT deed usually takes 2-4 weeks. Transfer can be done anytime after.

Confirm you want to proceed under personal name?

---

**14 — Client:**
Okay, register under personal name first. My name: Andi Prasetyo, Jakarta ID.

One more concern - the name "KopiByte" came from brainstorming with my co-founder. He contributed to the name idea. Will there be ownership issues later?
...
I can help draft an **IP Acknowledgment Letter** for you and your co-founder.
Fee: IDR 1,500,000 (simple letter) or include in comprehensive Founders' Agreement IDR 7,500,000

This is CRITICAL before trademark is registered under your personal name!

---

**15 — Client:**
Good point. Better to be clear from the start. Just draft the simple IP Acknowledgment Letter for now. Founders' Agreement later after PT is established.

So what's the total cost now with this addition?

**Consultant:**
**Updated Breakdown with IP Acknowledgment:**
...
- After PT established: IDR 6,000,000 (Phase 3)
...
**16 — Client:**
Deal! Transferring IDR 1.5 million today.

Oh, one more thing. I also have a tagline "Coffee, Coded for You". Should that be registered too?
...
Want to include the tagline in the package or skip for now?

---

**17 — Client:**
Skip the tagline for now - I'll do it later once established.

Last thing - if I want to sell the startup or merge someday, does IP registration affect valuation?

**Consultant:**
**IP registration SIGNIFICANTLY affects valuation!**
...
**Conclusion:**
IDR 20 million IP investment now = could be worth millions in exit valuation.

IP is a **real and measurable intangible asset**!

---

**18 — Client:**
Makes total sense. I'm glad we had this conversation before launch. So many things I hadn't thought of.

When can you start the trademark search?

**Consultant:**
**Can start THIS MONDAY!**
...
1. **Transfer IDR 1,500,000** to:
   - Bank: BCA
   - Account: 123-456-7890
   - Name: Nuzantara Legal Consulting

2. **Data for IP Acknowledgment:**
   - Full name founder 1 (you): Andi Prasetyo
   - Full name co-founder: [name]
   - Each person's contribution to "KopiByte" concept

3. **Confirm trademark spelling:**
   - "KopiByte" (one word, capital K and B)
   - Spelling exactly as you want it registered
...
Spelling: "KopiByte" - capital K and B, rest lowercase, one word no spaces.

**Consultant:**
**Excellent! All data received.**

**Confirmation:**

✅ Transfer IDR 1,500,000 - RECEIVED
✅ Founder 1: Andi Prasetyo
✅ Co-founder: Budi Santoso
✅ Brand: KopiByte (capital K and B)
✅ Classes: 9, 35, 43
...
**20 — Client:**
All complete! Thank you so much for the thorough explanation, super helpful. I'll wait for the IP Acknowledgment draft on Friday.

Good luck with the trademark search - hoping it's clear! 🤞

**Consultant:**
**You're welcome, Mr. Andi!**
...
4. Assignment agreements for freelancers
...
I'll update you Friday with the IP Acknowledgment draft.
Trademark search results Thursday/Friday.

**Best of luck with the KopiByte launch!** 🚀
...
## 🟫 Javanese Version — Surabaya Dialect

**1 — Client:**
Sugeng siang mas. Aku nembe launch startup tech nang Bali, jenenge "KopiByte" - platform gawe pesen kopi specialty. Aku pengen protect brand-ku ben gak dicuri uwong. Piye carane daftar trademark nang Indonesia?

**Consultant:**
Sugeng siang mas! Selamat gawe launch startup-e.

Kanggo protect brand "KopiByte", sampeyan kudu daftar **merek dagang** nang **DJKI (Direktorat Jenderal Kekayaan Intelektual)** nang bawah Kemenkumham.

**Proses Pendaftaran Merek:**

1. **Pencarian Merek** - Cek disik opo "KopiByte" wis didaftar
2. **Permohonan Online** - Lewat dgip.go.id
3. **Pemeriksaan Formalitas** - 30 dino
4. **Publikasi** - 2 wulan kanggo oposisi
5. **Pemeriksaan Substantif** - 150 dino
6. **Sertifikat** - Nek lolos
...
Perlu tak bantu proses lengkape?

---

**2 — Client:**
Wah suwe yo 8-12 wulan. Nek selama proses pendaftaran onok sing nganggo jeneng "KopiByte" yo piye? Aku gak iso ngenteni setahun lagi dilindungi.
...
4. Dokumentasino penggunaan pertama (first use evidence)

Pengen tak bantu pencarian merek disik? Biaya pencarian Rp 1.500.000 termasuk analisis ketersediaan.

---

**3 — Client:**
Ok, aku pengen pencarian disik. Btw KopiByte iki dudu mung jeneng, aku yo duwe logo khusus. Iku didaftarno terpisah opo piye?
...
Pengen mulai karo word mark "KopiByte" disik?

---

**4 — Client:**
Oke daftar terpisah ae. Siji maneh, aku yo develop app dewe. Source code-ne perlu didaftarno yo? Wedi onok sing copy fitur-fiturku.
...
- ✅ UI/UX design
- ✅ Dokumentasi
- ❌ Ide/konsep fitur (gak iso dilindungi)
- ❌ Algoritma umum

Dadi nek kompetitor gawe fitur serupa karo code bedo, iku legal. Hak cipta protect EKSPRESI, dudu IDE.

---

**5 — Client:**
Ohh dadi nek onok sing gawe app serupa karo cara coding dewe iku gak iso digugat yo? Terus piye protect fitur unikku dong?

**Consultant:**
Kanggo protect **fitur/fungsi unik**, sampeyan butuh **PATEN**, dudu hak cipta!
...
4. **Rahasia Dagang** - Algoritma proprietary (ojo disclose)

Paten biasane kanggo startup sing wis scale lan duwe budget R&D gede.

---

**6 — Client:**
Noted! Dadine saiki fokus merek + hak cipta disik yo. Btw kelas merek iku maksude opo? Aku moco-moco onok kelas 9, kelas 35, bingung.
...
Nek sampeyan daftar 1 kelas tapi kompetitor daftar nang kelas liyo, dheweke iso nganggo jeneng podho nang kelas iku!

---

**7 — Client:**
Wow nembe ngerti onok 45 kelas. Aku pengen sing ideal, kelas 9, 35, karo 43. Total Rp 5.400.000 kanggo 3 kelas yo?

Oh yo, aku yo pengen hire freelance designer gawe gawe marketing materials. Piye mastino design sing dheweke gawe dadi duwekku?
...
5. **Warranty:**
   > Jaminan design original, gak menjiplak
...
Tanpa kontrak iki, sampeyan GAK nduweni design sing digawe freelancer!

---

**8 — Client:**
Waduh, aku wis tau hire designer sakdurunge tanpa kontrak. Design logo sakiki iku hasil kerjone dheweke. Piye dong?

**Consultant:**
**Situasi iki iso didandani karo retroactive assignment:**

**Langkah Penyelesaian:**

1. **Contact Designer:**
   - Hubungi, jelasno situasi profesional
   - Minta tanda tangan assignment agreement

2. **Retroactive IP Assignment:**
   - Dokumen sing nyatakno transfer hak cipta
   - Berlaku surut sakjak tanggal pembuatan
   - Pertimbangno kompensasi tambahan (fair dealing)

3. **Get Source Files:**
   - Minta kabeh source files (AI, PSD, dll)
...
**Pelajaran:**
Selalu nganggo kontrak SAKDURUNGE project dimulai. Retroactive assignment luwih larang lan risky.

Pengen tak bantu draft assignment agreement kanggo designer sampeyan?

---

**9 — Client:**
Oke aku bakal hubungi designer-e. Moga-moga gelem sign.

Pertanyaan liyo, nek aku pengen license teknologi seko partner (contone payment gateway), opo sing kudu tak perhatino nang kontrak license-e?
...
- ❌ No source code escrow (kanggo critical software)

Pengen tak review license agreement spesifik? Biaya review: Rp 3.500.000/dokumen.

---

**10 — Client:**
Checklist-e berguna banget! Mengko tak minta review yo nek wis onok draft seko payment gateway-e.

Last question, piye nek onok sing nganggo jeneng "KopiByte" opo jeneng mirip nang social media/domain? Iso tak tuntut?

**Consultant:**
**Enforcement Gumantung Status:**
...
1. **Somasi (Cease & Desist):**
   - Surat resmi seko lawyer
   - Minta stop penggunaan nang 14 dino
   - Biaya: Rp 2.500.000

2. **Nek Gak Patuh:**
   - Laporan nang platform (Instagram, TikTok, dll)
   - Dispute domain lewat PANDI/WIPO
   - Gugatan nang Pengadilan Niaga
...
**Takeaway:** Daftarno merek SEGERA = enforcement power maksimal.
...
2. Daftar merek 3 kelas
3. Daftar hak cipta source code
4. Retroactive assignment seko designer
5. Kontrak kanggo future freelancers

Iso dikei breakdown total biaya?
...
Pengen proceed karo package iki?

---

**12 — Client:**
Deal! Aku proceed. Tapi tolong prioritasno pencarian merek disik yo, soale aku pengen launch marketing campaign sasi ngarep. Nek jeneng "KopiByte" wis dijupuk uwong, aku kudu rebrand secepatnya.
...
Transfer nang rekening kita lan kirim data nang dhuwur, aku mulai Senin!
...
Oh yo, PT-ne durung dadi, isih proses nang notaris. Iso daftar merek disik sakdurunge PT dadi?
...
**Timeline PT:**
Biasane akta PT dadi 2-4 minggu. Transfer merek iso dilakokno kapan ae sakwise iku.

Confirm pengen proceed karo jeneng pribadi?

---

**14 — Client:**
Oke daftar jeneng pribadi disik ae. Jenengku: Andi Prasetyo, KTP Jakarta.

Siji concern maneh, jeneng "KopiByte" iku tak oleh seko brainstorming bareng co-founder-ku. Dheweke melu contribute ide jeneng. Mengko onok masalah gak yo soal ownership?
...
Aku iso bantu draft **IP Acknowledgment Letter** kanggo sampeyan karo co-founder.
Biaya: Rp 1.500.000 (simple letter) opo include nang Founders' Agreement komprehensif Rp 7.500.000

Iki KRITIS sakdurunge merek terdaftar atas jeneng pribadi sampeyan!

---

**15 — Client:**
Bener yo yo. Mending clear seko awal. Draft IP Acknowledgment Letter ae disik sing simple. Founders' Agreement mengko sakwise PT dadi.

Dadi total biaya saiki dadi piro karo tambahan iki?

**Consultant:**
**Updated Breakdown karo IP Acknowledgment:**
...
- Sakwise PT dadi: Rp 6.000.000 (Phase 3)
...
**16 — Client:**
Deal! Transfer Rp 1.5 juta dino iki.

Oh yo, siji maneh. Aku yo duwe jeneng tagline "Coffee, Coded for You". Iku perlu didaftarno yo opo piye?
...
Pengen include tagline nang package opo skip disik?

---

**17 — Client:**
Skip disik ae tagline-e, mengko ae nek wis establish.

Terakhir iki, nek sewaktu-waktu aku pengen jual startup opo merger, IP registration iki berpengaruh nang valuation gak?

**Consultant:**
**IP registration SANGAT berpengaruh nang valuation!**
...
**Kesimpulan:**
Rp 20 juta investasi IP saiki = could be worth millions nang exit valuation.

IP iku **intangible asset** sing real lan measurable!

---

**18 — Client:**
Makes total sense. Aku glad kita ngobrol iki sakdurunge launch. Akeh sing gak kepikiran ternyata.

Kapan iso mulai pencarian merek?
...
1. **Transfer Rp 1.500.000** nang:
   - Bank: BCA
   - No. Rek: 123-456-7890
   - A/N: Nuzantara Legal Consulting

2. **Data kanggo IP Acknowledgment:**
   - Jeneng lengkap founder 1 (sampeyan): Andi Prasetyo
   - Jeneng lengkap co-founder: [jeneng]
   - Kontribusi saben uwong nang konsep "KopiByte"

3. **Konfirmasi jeneng merek:**
   - "KopiByte" (siji tembung, capital K karo B)
   - Spelling exactly as you want it registered
...
Spelling: "KopiByte" - huruf K karo B kapital, sisane lowercase, siji tembung tanpa spasi.

**Consultant:**
**Excellent! Kabeh data received.**
...
✅ Founder 1: Andi Prasetyo
✅ Co-founder: Budi Santoso
✅ Brand: KopiByte (K karo B kapital)
✅ Kelas: 9, 35, 43
...
Onok pertanyaan liyo sakdurunge kita mulai?

---

**20 — Client:**
Wis lengkap! Matur nuwun banget penjelasane, sangat helpful. Aku ngenteni draft IP Acknowledgment dino Jumat yo.

Good luck karo pencarian mereke, moga-moga clear! 🤞
...
4. Assignment agreements kanggo freelancers
...
Tak kabari Jumat karo draft IP Acknowledgment.
Pencarian merek result Kamis/Jumat.

**Sukses karo launch KopiByte!** 🚀
