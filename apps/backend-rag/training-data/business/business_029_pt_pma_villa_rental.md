# PT PMA Villa Rental — Full Conversation (Intermediate)

> **Generated**: 2025-12-10
> **Topics Covered**: PT PMA Villa Rental, KBLI 55130, Tourism License, Property Structure, Short-term vs Long-term Rental Tax, Platform Compliance
> **Style**: Expat property investor, intermediate complexity
...
**1 — Client:**
Halo, saya expat punya beberapa villa di Bali. Mau rental-kan lewat Airbnb dan Booking.com. Perlu PT PMA atau bisa personal?
...
- Platform (Airbnb, Booking) butuh **tax ID bisnis** untuk compliance

Personal rental tanpa izin = **illegal**, risiko villa disegel.

**2 — Client:**
Villa saya HGB atas nama PT existing. Apakah bisa langsung operate?
...
Apa KBLI PT existing kamu?

**3 — Client:**
PT saya trading company (KBLI 46 series). Artinya harus tambah KBLI?
...
**Modal dasar:** Pastikan minimal **IDR 10 Miliar** (syarat KBLI 55130 untuk PMA).

**4 — Client:**
Modal IDR 10 Miliar? Villa saya cuma 2, value sekitar IDR 5 Miliar total. Gimana caranya?
...
Banyak PT PMA villa pakai cara ini — property sebagai modal, bukan cash.

**5 — Client:**
Kalau villa masih leasehold (Hak Sewa), bukan HGB, bisa jadi modal PT?
...
Untuk compliance dan exit strategy, **HGB via PT PMA** lebih aman long-term.

**6 — Client:**
Oke, saya mau convert leasehold ke HGB lewat PT. Berapa biaya dan waktu?
...
- **Total: ~7-10% of property value**

**HGB validity:** 30 tahun, renewable 2x (max 80 tahun total).

**7 — Client:**
Untuk villa rental, apa beda short-term (Airbnb) dan long-term (yearly) dari segi pajak?
...
**8 — Client:**
PPh 10% itu dibayar kapan? Quarterly atau yearly?
...
**9 — Client:**
Airbnb withhold pajak tidak di Indonesia? Saya perlu double bayar?

**Consultant:**
**Clarifikasi Airbnb tax:**
...
- Airbnb fee: USD 3
- Kamu terima: USD 97
- **PPh basis:** USD 100 × kurs IDR = taxable amount
- **PPh 10%:** 10% × IDR amount

**10 — Client:**
Booking.com sama treatment-nya?
...
**Tip:** Pakai property management software (Guesty, Hostaway) untuk auto-track revenue across platforms.

**11 — Client:**
Untuk dapat Tourism License (TDUP), apa syaratnya?
...
**12 — Client:**
PBG dan SLF itu apa? Villa saya sudah ada lama, tidak punya IMB modern.
...
- Timeline: 2-4 minggu
- **Wajib** untuk dapat TDUP

**13 — Client:**
Lokasi villa saya di zona residential, bukan commercial. Apakah masalah?

**Consultant:**
**Ini masalah serius yang sering diabaikan.**
...
**Rekomendasi:** Check zoning **sebelum** invest di PT PMA setup.

**14 — Client:**
Kalau zoning sudah clear, berapa total biaya setup PT PMA Villa sampai dapat TDUP?
...
**Timeline total:** 6-9 minggu (PT + TDUP), atau 4-6 bulan jika perlu property conversion.

**15 — Client:**
Annual compliance cost berapa setelah operate?
...
- **SLF renewal**: IDR 2-3M (setiap 5 tahun)
...
**Rough total:** **IDR 80-150M/tahun** fixed overhead + variable (accountant, PM).

**16 — Client:**
Kalau saya hire property manager, mereka handle tax juga?
...
- Separate **accountant** untuk:
  ...
  - Reconcile dengan platform data
  - Bayar PPh 10% tepat waktu
...
**17 — Client:**
Saya mau hire expat sebagai villa manager. Perlu IMTA?
...
**Cost saving:** Local manager typically **IDR 8-15M/bulan** all-in vs expat **IDR 25M++ plus IMTA cost**.

**18 — Client:**
Kalau villa tidak perform, bisa tutup PT dan jual property?
...
**19 — Client:**
Oke saya interested. Langkah pertama apa?
...
Mau kita bantu start dari mana?

**20 — Client:**
Start dari PT PMA setup dulu. Kirim proposal ke email saya.

**Consultant:**
Siap! Kami kirim proposal lengkap:
...
**Timeline commitment:** 6-9 minggu dari signed engagement sampai **TDUP issued**.

Terima kasih! Tim Bali Zero siap bantu villa rental business kamu. 🏡
...
**1 — Client:**
Hi, I'm an expat with several villas in Bali. Want to rent them via Airbnb and Booking.com. Do I need a PT PMA or can I do it personally?
...
- Platforms (Airbnb, Booking) need **business tax ID** for compliance

Personal rental without permit = **illegal**, risk of villa being sealed.

**2 — Client:**
My villa is HGB under an existing PT. Can I operate directly?
...
What's your existing PT's KBLI?

**3 — Client:**
My PT is a trading company (KBLI 46 series). So I need to add KBLI?
...
**Authorized capital:** Ensure minimum **IDR 10 Billion** (requirement for KBLI 55130 for PMA).

**4 — Client:**
IDR 10 Billion capital? I only have 2 villas worth about IDR 5 Billion total. How do I manage that?
...
Many villa PT PMAs use this approach — property as capital, not cash.

**5 — Client:**
If villa is still leasehold (Hak Sewa), not HGB, can it become PT capital?
...
For compliance and exit strategy, **HGB via PT PMA** is safer long-term.

**6 — Client:**
OK, I want to convert leasehold to HGB through PT. What's the cost and timeline?
...
**HGB validity:** 30 years, renewable 2x (max 80 years total).

**7 — Client:**
For villa rental, what's the tax difference between short-term (Airbnb) and long-term (yearly)?
...
**8 — Client:**
When is PPh 10% paid? Quarterly or yearly?
...
**9 — Client:**
Does Airbnb withhold tax in Indonesia? Do I need to double pay?

**Consultant:**
**Airbnb tax clarification:**
...
- Airbnb fee: USD 3
- You receive: USD 97
- **PPh basis:** USD 100 × IDR rate = taxable amount
- **PPh 10%:** 10% × IDR amount

**10 — Client:**
Is Booking.com treated the same?
...
**Tip:** Use property management software (Guesty, Hostaway) to auto-track revenue across platforms.

**11 — Client:**
What are the requirements for Tourism License (TDUP)?
...
**12 — Client:**
What are PBG and SLF? My villa has been around for a while, doesn't have modern IMB.
...
- Timeline: 2-4 weeks
- **Mandatory** to get TDUP

**13 — Client:**
My villa location is in residential zone, not commercial. Is that a problem?

**Consultant:**
**This is a serious issue often overlooked.**
...
**Recommendation:** Check zoning **before** investing in PT PMA setup.

**14 — Client:**
If zoning is clear, what's the total cost for PT PMA Villa setup including TDUP?
...
**Total timeline:** 6-9 weeks (PT + TDUP), or 4-6 months if property conversion needed.

**15 — Client:**
What's the annual compliance cost after operating?
...
- **SLF renewal**: IDR 2-3M (every 5 years)
- **Property tax (PBB)**: ~0.5% of NJOP
...
**Rough total:** **IDR 80-150M/year** fixed overhead + variable (accountant, PM).

**16 — Client:**
If I hire a property manager, do they handle tax too?
...
**17 — Client:**
I want to hire an expat as villa manager. Do I need IMTA?
...
**Cost saving:** Local manager typically **IDR 8-15M/month** all-in vs expat **IDR 25M++ plus IMTA cost**.

**18 — Client:**
If villa doesn't perform, can I close PT and sell property?
...
Where would you like us to help you start?

**20 — Client:**
Start with PT PMA setup first. Send proposal to my email.

**Consultant:**
Ready! We'll send a complete proposal:
...
**Timeline commitment:** 6-9 weeks from signed engagement to **TDUP issued**.

Thank you! Bali Zero team is ready to help your villa rental business. 🏡
...
**1 — Client:**
Halo mas, aku expat duwe villa sawetara neng Bali. Arep tak rental-ke lewat Airbnb karo Booking.com. Perlu PT PMA opo iso personal?
...
- Platform (Airbnb, Booking) butuh **tax ID bisnis** kanggo compliance

Personal rental tanpa izin = **illegal**, risiko villa disegel.

**2 — Client:**
Villa ku HGB atas jeneng PT existing. Opo iso langsung operate?
...
Opo KBLI PT existing sampeyan?

**3 — Client:**
PT ku trading company (KBLI 46 series). Artine kudu tambah KBLI?
...
**Modal dasar:** Pastiken minimal **IDR 10 Miliar** (syarat KBLI 55130 kanggo PMA).

**4 — Client:**
Modal IDR 10 Miliar? Villa ku mung 2, value sekitar IDR 5 Miliar total. Piye carane?
...
Akeh PT PMA villa nganggo cara iki — property dadi modal, dudu cash.

**5 — Client:**
Nek villa isih leasehold (Hak Sewa), dudu HGB, iso dadi modal PT?
...
Kanggo compliance lan exit strategy, **HGB via PT PMA** luwih aman long-term.

**6 — Client:**
Oke, aku arep convert leasehold neng HGB lewat PT. Piro biaya lan waktune?
...
- BPHTB: 5% soko NJOP
- BPN registration: IDR 5-10M
- **Total: ~7-10% soko property value**

**HGB validity:** 30 taun, renewable 2x (max 80 taun total).

**7 — Client:**
Kanggo villa rental, opo bedo short-term (Airbnb) lan long-term (yearly) soko segi pajak?
...
**8 — Client:**
PPh 10% iku dibayar kapan? Quarterly opo yearly?
...
**9 — Client:**
Airbnb withhold pajak ora neng Indonesia? Aku perlu double bayar?

**Consultant:**
**Klarifikasi Airbnb tax:**
...
**Tip:** Nganggo property management software (Guesty, Hostaway) kanggo auto-track revenue across platforms.

**11 — Client:**
Kanggo entuk Tourism License (TDUP), opo syarate?
...
**12 — Client:**
PBG lan SLF iku opo? Villa ku wis ono suwe, ora duwe IMB modern.
...
- Biaya: IDR 10-30M tergantung ukuran
- Timeline: 2-4 minggu
- **Wajib** kanggo entuk TDUP

**13 — Client:**
Lokasi villa ku neng zona residential, dudu commercial. Opo masalah?

**Consultant:**
**Iki masalah serius sing sering diabaike.**
...
**Rekomendasi:** Check zoning **sakdurunge** invest neng PT PMA setup.

**14 — Client:**
Nek zoning wis clear, piro total biaya setup PT PMA Villa sampek entuk TDUP?
...
**Timeline total:** 6-9 minggu (PT + TDUP), opo 4-6 sasi nek perlu property conversion.

**15 — Client:**
Annual compliance cost piro sakwise operate?
...
- **SLF renewal**: IDR 2-3M (saben 5 taun)
...
**Rough total:** **IDR 80-150M/taun** fixed overhead + variable (accountant, PM).

**16 — Client:**
Nek aku hire property manager, wong-e handle tax yo?
...
**17 — Client:**
Aku arep hire expat dadi villa manager. Perlu IMTA?
...
**Cost saving:** Local manager biasane **IDR 8-15M/sasi** all-in vs expat **IDR 25M++ plus IMTA cost**.

**18 — Client:**
Nek villa ora perform, iso tutup PT lan jual property?
...
**19 — Client:**
Oke aku interested. Langkah pertama opo?
...
Arep kito bantu start soko endi?

**20 — Client:**
Start soko PT PMA setup dhisik. Kirim proposal neng email ku.

**Consultant:**
Siap! Kito kirim proposal lengkap:
...
**Timeline commitment:** 6-9 minggu soko signed engagement sampek **TDUP issued**.

Matur nuwun! Tim Bali Zero siap bantu villa rental business sampeyan. 🏡
