...
test.describe("Nuzantara Mission Simulation", () => {
  ...
  test("Complete Mission: Login -> Dashboard -> Chat -> Blog", async ({
    page,
  }) => {
    // 1. LOGIN
    ...
    // Type a question
    const question =
      "Ciao Zantara, dimmi lo stato attuale del sistema e quanti documenti hai in memoria.";
    ...
    console.log(
      `🤖 [AI Response] (Partial/Full): ${lastResponse?.substring(0, 100)}...`,
    );
