 ...
 * needed — the legacy doors must not answer 200, and the already-shared result
 * links must keep answering 200. Both are asserted on the HTTP response, not on
 * a rendered heading, because a client-side rewrite that still renders a quiz
 * would pass a DOM assertion.
 *
