...
test.describe("Memory Debug Tests", () => {
  ...
  test("should remember city across multiple turns", async ({ page }) => {
    ...
    const cityFound = responseContains(response2, [
      "Milano",
      "Milan",
      "milano",
      "MILANO",
  ...
  test("should remember both name and city", async ({ page }) => {
    ...
    const cityFound = responseContains(response3, [
      "Milano",
      "Milan",
      "milano",
      "MILANO",
  ...
  test("should remember information after multiple unrelated messages", async ({
    page,
  }) => {
    ...
    await sendMessageAndWaitForResponse(
      page,
      "Come funziona il visto per l'Indonesia?",
    );
    await page.waitForTimeout(TEST_CONFIG.waitBetweenMessages);
    ...
    console.log(
      "[TEST] Name response after unrelated messages:",
    ...
    console.log(
      "[TEST] City response after unrelated messages:",
