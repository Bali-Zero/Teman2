  ...
  describe('Client CRUD Operations', () => {
    describe('getClients', () => {
      ...
      it('should fetch clients with search filter', async () => {
        const mockClients = [{ id: 1, full_name: 'John Doe', email: 'john@example.com' }];
    ...
    describe('createClient', () => {
      it('should create a new client', async () => {
        ...
        const result = await crmApi.createClient(newClient, 'admin@balizero.com');

        expect(mockClient.request).toHaveBeenCalledWith(
          expect.stringContaining('/api/crm/clients?created_by=admin%40balizero.com'),
    ...
    describe('updateClient', () => {
      it('should update client information', async () => {
        ...
        const result = await crmApi.updateClient(1, updates, 'admin@balizero.com');

        expect(mockClient.request).toHaveBeenCalledWith(
          expect.stringContaining('/api/crm/clients/1?updated_by=admin%40balizero.com'),
          expect.objectContaining({
            method: 'PATCH',
    ...
    describe('deleteClient', () => {
      it('should soft delete a client', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith(
          expect.stringContaining('/api/crm/clients/1?deleted_by=admin%40balizero.com'),
          { method: 'DELETE' }
        );
        expect(result.success).toBe(true);
      });
    ...
    describe('getClientByEmail', () => {
      ...
      it('should throw error for non-404 errors', async () => {
        ...
        await expect(crmApi.getClientByEmail('error@example.com')).rejects.toThrow(
          '500 Server Error'
        );
      });
    });
  ...
  describe('Practice CRUD Operations', () => {
    ...
    describe('createPractice', () => {
      it('should create a new practice', async () => {
        ...
        const result = await crmApi.createPractice(newPractice, 'admin@balizero.com');

        expect(mockClient.request).toHaveBeenCalledWith(
          expect.stringContaining('/api/crm/practices/?created_by=admin%40balizero.com'),
          expect.objectContaining({
            method: 'POST',
    ...
    describe('updatePractice', () => {
      it('should update practice status and payment', async () => {
        ...
        const result = await crmApi.updatePractice(1, updates, 'admin@balizero.com');

        expect(mockClient.request).toHaveBeenCalledWith(
          expect.stringContaining('/api/crm/practices/1/?updated_by=admin%40balizero.com'),
          expect.objectContaining({
            method: 'PATCH',
            body: JSON.stringify(updates),
          }),
    ...
    describe('deletePractice', () => {
      it('should soft delete a practice', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith(
          expect.stringContaining('/api/crm/practices/1?deleted_by=admin%40balizero.com'),
          { method: 'DELETE' }
        );
        expect(result.success).toBe(true);
      });
  ...
  describe('Interaction Operations', () => {
    ...
    describe('deleteInteraction', () => {
      it('should delete an interaction', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith(
          expect.stringContaining('/api/crm/interactions/1?deleted_by=admin%40balizero.com'),
          { method: 'DELETE' }
        );
        expect(result.success).toBe(true);
      });
  ...
  describe('Document Management', () => {
    describe('getClientDocuments', () => {
      it('should fetch client documents', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/clients/1/documents');
    ...
    describe('deleteDocument', () => {
      it('should archive document by default', async () => {
        mockClient.request.mockResolvedValue({ success: true, action: 'archived' });
      ...
      it('should permanently delete when specified', async () => {
        mockClient.request.mockResolvedValue({ success: true, action: 'deleted' });
  ...
  describe('Statistics and Analytics', () => {
    describe('getPracticeStats', () => {
      it('should fetch practice statistics', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/practices/stats/overview');
    ...
    describe('getInteractionStats', () => {
      it('should fetch interaction statistics', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/interactions/stats/overview');
    ...
    describe('getAutoCRMStats', () => {
      it('should fetch AUTO CRM extraction stats', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/auto/stats?days=7');
    ...
    describe('getClientSummary', () => {
      it('should fetch complete client summary', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/clients/1/summary');
  ...
  describe('Google Drive Operations', () => {
    describe('createDriveFolder', () => {
      it('should create standardized Google Drive folder structure', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/clients/1/create-drive-folder', {
          method: 'POST',
        });
        expect(result.success).toBe(true);
    ...
    describe('getDriveFolder', () => {
      it('should get Google Drive folder information', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/clients/1/drive-folder');
    ...
    describe('getDriveFolderStructure', () => {
      it('should get complete folder structure with file counts', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/clients/1/drive-folder/structure');
    ...
    describe('uploadFileToFolder', () => {
      it('should upload file to a subfolder', async () => {
        ...
        const result = await crmApi.uploadFileToFolder(1, 'Immigration', mockFile);
    ...
    describe('getDriveFolderStats', () => {
      it('should get folder statistics', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/clients/1/drive-folder/stats');
  ...
  describe('Family Members CRUD', () => {
    describe('getFamilyMembers', () => {
      it('should get family members for a client', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/clients/1/family');
    ...
    describe('deleteFamilyMember', () => {
      it('should delete a family member', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/clients/1/family/10', {
          method: 'DELETE',
        });
        expect(result.success).toBe(true);
      });
  ...
  describe('Expiry Alerts', () => {
    describe('getExpiryAlerts', () => {
      it('should get all expiry alerts', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/expiry-alerts');
    ...
    describe('getExpiryAlertsSummary', () => {
      it('should get expiry alerts summary for dashboard', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/expiry-alerts/summary');
  ...
  describe('Client Profile (Enhanced)', () => {
    describe('getClientProfile', () => {
      it('should get enhanced client profile with family, documents, alerts', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/clients/1/profile');
        expect(result.client.id).toBe(1);
    ...
    describe('getDocumentCategories', () => {
      it('should get document categories for dropdowns', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/document-categories');
        expect(result).toHaveLength(2);
    ...
    describe('getClientPractices', () => {
      it('should get practices for a specific client', async () => {
        ...
        expect(mockClient.request).toHaveBeenCalledWith('/api/crm/practices/?client_id=1');
        expect(result).toHaveLength(2);
      });
    });
    ...
    describe('getClient', () => {
      it('should get a single client by ID', async () => {
        ...
        expect((crmApi as any).client.request).toHaveBeenCalledWith('/api/crm/clients/1');
