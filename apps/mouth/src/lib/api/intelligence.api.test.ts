...
describe("intelligence.api", () => {
  ...
  describe("getPendingItems", () => {
    ...
    it("should fetch visa-only items successfully", async () => {
      ...
      expect(api.request).toHaveBeenCalledWith(
        "/api/intel/staging/pending?type=visa",
      );
      expect(logger.apiCall).toHaveBeenCalledWith(
        "/api/intel/staging/pending?type=visa",
        "GET",
    ...
    it("should fetch news-only items successfully", async () => {
      ...
      expect(api.request).toHaveBeenCalledWith(
        "/api/intel/staging/pending?type=news",
      );
      expect(logger.apiCall).toHaveBeenCalledWith(
        "/api/intel/staging/pending?type=news",
        "GET",
    ...
    it("should handle and log errors", async () => {
      ...
      await expect(intelligenceApi.getPendingItems("all")).rejects.toThrow(
        "Network error",
      );
  ...
  describe("getPreview", () => {
    ...
    it("should handle and log errors", async () => {
      ...
      await expect(
        intelligenceApi.getPreview("visa", "invalid-id"),
  ...
  describe("approveItem", () => {
    ...
    it("should approve news item successfully", async () => {
      ...
      expect(api.request).toHaveBeenCalledWith(
        "/api/intel/staging/approve/news/news-456",
        {
          method: "POST",
        },
      );
    ...
    it("should handle and log errors", async () => {
      ...
      await expect(
        intelligenceApi.approveItem("visa", "fail-id"),
  ...
  describe("rejectItem", () => {
    ...
    it("should reject news item successfully", async () => {
      ...
      expect(api.request).toHaveBeenCalledWith(
        "/api/intel/staging/reject/news/news-999",
        {
          method: "POST",
        },
      );
    ...
    it("should handle and log errors", async () => {
      ...
      await expect(
        intelligenceApi.rejectItem("news", "fail-reject"),
  ...
  describe("publishItem", () => {
    ...
    it("should handle and log errors", async () => {
      ...
      await expect(
        intelligenceApi.publishItem("visa", "fail-publish"),
  ...
  describe("getMetrics", () => {
    ...
    it("should handle and log errors", async () => {
      ...
      await expect(intelligenceApi.getMetrics()).rejects.toThrow(
        "Metrics unavailable",
      );
  ...
  describe("getAnalytics", () => {
    ...
    it("should handle and log errors", async () => {
      ...
      await expect(intelligenceApi.getAnalytics(30)).rejects.toThrow(
