...
describe('ConversationsApi', () => {
  ...
  describe('saveConversation', () => {
    ...
    it('should save conversation with metadata', async () => {
      ...
      expect(mockClient.request).toHaveBeenCalledWith('/api/bali-zero/conversations/save', {
        method: 'POST',
        body: expect.stringContaining('"metadata":{"source":"web","timestamp":"2024-01-01"}'),
      });
    });
  ...
  describe('getConversation', () => {
    it('should get a single conversation by ID', async () => {
      ...
      expect(mockClient.request).toHaveBeenCalledWith('/api/bali-zero/conversations/123');
      expect(result).toEqual(mockResponse);
    });
    ...
    it('should handle different conversation IDs', async () => {
      ...
      expect(mockClient.request).toHaveBeenCalledWith('/api/bali-zero/conversations/999');
    });
  });
  ...
  describe('deleteConversation', () => {
    it('should delete a conversation by ID', async () => {
      ...
      expect(mockClient.request).toHaveBeenCalledWith('/api/bali-zero/conversations/456', {
        method: 'DELETE',
      });
      expect(result).toEqual(mockResponse);
    });
    ...
    it('should handle different conversation IDs for deletion', async () => {
      ...
      expect(mockClient.request).toHaveBeenCalledWith('/api/bali-zero/conversations/789', {
        method: 'DELETE',
      });
    });
  });
  ...
  describe('error handling', () => {
    it('should handle API errors in getConversationHistory', async () => {
      ...
      await expect(conversationsApi.getConversationHistory()).rejects.toThrow('API Error');
    });
    ...
    it('should handle API errors in deleteConversation', async () => {
      ...
      await expect(conversationsApi.deleteConversation(123)).rejects.toThrow('Delete failed');
    });
  });
});
