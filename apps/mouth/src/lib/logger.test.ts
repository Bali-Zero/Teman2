...
describe('Logger with Sentry Integration', () => {
  ...
  describe('Sentry Integration (Production)', () => {
    ...
    it('should send warning to Sentry', () => {
      ...
      prodLogger.warn('Warning occurred', { component: 'TestComponent', action: 'test_action' });
  ...
  describe('Convenience Methods', () => {
    ...
    it('should log user actions', () => {
      ...
      logger.userAction('click_button', 'visa', 'visa123', { component: 'VisaCard' });
  ...
  describe('Error Handling', () => {
    it('should not throw if Sentry fails', () => {
      ...
      expect(() => {
        prodLogger.error('Test error', { component: 'Test' }, new Error('Original error'));
      }).not.toThrow();
