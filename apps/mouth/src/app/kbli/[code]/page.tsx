        ...
        <div className="relative -mx-4 mb-10 mt-4 overflow-hidden rounded-2xl sm:-mx-6 lg:-mx-8">
          {heroImage ? (
            ...
            <>
              ...
              />
              <div className="absolute inset-0" style={{ background: heroStyle.pattern }} />
              <div
                className="absolute inset-0"
                style={{
          ...
          >
            ...
            <div className="mb-4 flex items-center gap-3">
              ...
              {isGold && (
                <span className="text-xs text-amber-400 font-medium">★ Gold-Tier Intel</span>
              )}
            </div>
            ...
            <div className="mt-5 flex flex-wrap gap-2.5">
              ...
              {kbli.licensing[0] && <RiskBadge category={kbli.licensing[0].riskCategory} />}
          ...
          <div className="space-y-0">
            ...
            >
              ...
              <div className="px-5 py-4 kbli-prose">
                <MarkdownClient withKbliLinks>{gold.youllAlsoNeed}</MarkdownClient>
              </div>
            </section>
          </div>
        ) : (
          ...
          <div className="space-y-0">
            ...
            <section className="mt-8">
              ...
              <div className="space-y-4">
                <details className="rounded-xl border border-[var(--border)] overflow-hidden" open>
                  <summary
                    ...
                    style={{ background: 'var(--kbli-bg-elevated)' }}
                  >
                    Can foreigners operate a {kbli.titleEn.toLowerCase()} business in Indonesia?
                  </summary>
                  <div
                ...
                {kbli.transition.previousCodes.length > 0 && (
                  <details className="rounded-xl border border-[var(--border)] overflow-hidden">
                    ...
                    >
                      ...
                      {kbli.transition.mappingNote ? ` ${kbli.transition.mappingNote}` : ''}
                      {kbli.transition.mappingStatus === 'MATCH_LANGSUNG'
                        ...
                        : kbli.transition.mappingStatus === 'CODICE_RINUMERATO'
                          ...
                          : kbli.transition.mappingStatus === 'MATCH_CON_AGGREGAZIONE'
                            ? ' Multiple 2020 codes were merged into this single 2025 code.'
                            : ''}{' '}
                      All businesses must migrate to KBLI 2025 by June 18, 2026 (BPS Regulation
                      7/2025).
                    </div>
                  </details>
                )}
