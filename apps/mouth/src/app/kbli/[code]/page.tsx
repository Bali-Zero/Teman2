          ...
          >
            ...
            <div className="mb-4 flex items-center gap-3">
              <span
                ...
                style={{
                  background: "var(--kbli-accent-muted)",
                  color: "var(--kbli-accent)",
                  border: "1px solid var(--kbli-border-accent)",
          ...
          <div className="space-y-0">
            ...
            <section className="relative -mx-4 sm:-mx-6 lg:-mx-8">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, color-mix(in srgb, var(--accent-funnel) 4%, transparent), rgba(139, 156, 247, 0.02), transparent 60%)",
                }}
              />
                ...
                <div className="space-y-5" style={{ maxWidth: "780px" }}>
                  {gold.baliContext.split(/\n---\n/).map((block, idx) => {
                    ...
                    const blockBg = isMistakes
                      ...
                      : "color-mix(in srgb, var(--accent-funnel) 2%, transparent)";
