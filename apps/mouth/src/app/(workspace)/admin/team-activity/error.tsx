...
export default function TeamActivityError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    logger.error('Team Activity Error', {}, error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center p-6">
      ...
      <div className="mt-6 text-center space-y-2 max-w-md">
        <h2 className="text-2xl font-semibold tracking-tight">Couldn&apos;t Load Team Activity</h2>
