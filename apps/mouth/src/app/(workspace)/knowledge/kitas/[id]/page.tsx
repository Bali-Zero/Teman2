  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-[var(--border)] bg-gradient-to-br from-[var(--background-secondary)] to-[var(--background-elevated)]">
        ...
        <div className="p-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            <span
              className={`px-3 py-1.5 text-sm font-medium rounded-full border ${getCategoryColor(visa.category)}`}
            >
              {visa.category}
            </span>
            {difficulty && (
              <span
                className={`px-3 py-1.5 text-sm font-medium rounded-full border ${getDifficultyColor(difficulty)}`}
              >
            ...
            <InfoCard
              ...
              subValue={
                visa.processing_time_express
                  ? `Express: ${visa.processing_time_express}`
                  : undefined
              }
            />
            <InfoCard
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        {/* Allowed Activities - only show if has data */}
        {visa.allowed_activities && visa.allowed_activities.length > 0 && (
          <Section
        ...
        {/* Restrictions - only show if has data */}
      ...
      {/* Process Steps - Full Width - only show if has data */}
      {visa.process_steps && visa.process_steps.length > 0 && (
        <Section
      ...
      {/* Tips & Advice - Full Width - only show if has data */}
