...
export default function OmnichannelPage() {
  ...
  // Channel configuration with brand colors and logos
  const channels: Array<{ 
    ...
    { 
      ...
      inactiveClass: 'bg-[#25D366]/10 text-[#25D366] border-[#25D366]/20 hover:bg-[#25D366]/20',
      brandColor: '#25D366'
    },
    { 
      id: 'telegram', 
      ...
      activeClass: 'bg-[#0088cc] text-white border-[#0088cc]',
      inactiveClass: 'bg-[#0088cc]/10 text-[#0088cc] border-[#0088cc]/20 hover:bg-[#0088cc]/20',
      brandColor: '#0088cc'
    },
    { 
      id: 'instagram', 
      ...
      activeClass: 'bg-gradient-to-r from-[#E4405F] to-[#833AB4] text-white border-transparent',
      inactiveClass: 'bg-gradient-to-r from-[#E4405F]/10 to-[#833AB4]/10 text-[#E4405F] border-[#E4405F]/20 hover:from-[#E4405F]/20 hover:to-[#833AB4]/20',
      brandColor: '#E4405F'
    },
    { 
      id: 'twitter', 
      ...
      activeClass: 'bg-black dark:bg-white text-white dark:text-black border-black dark:border-white',
      inactiveClass: 'bg-black/10 dark:bg-white/10 text-black dark:text-white border-black/20 dark:border-white/20 hover:bg-black/20 dark:hover:bg-white/20',
      brandColor: '#000000'
    },
  ];
      ...
      <div className="flex items-center gap-3 p-4 border-b border-[var(--border)] bg-[var(--background-secondary)]">
        {channels.map((channel) => {
          const conversationCount = 
            channel.id === 'whatsapp' ? whatsappConversations.length :
            channel.id === 'telegram' ? telegramConversations.length :
            channel.id === 'instagram' ? instagramConversations.length :
          ...
          return (
            <button
              ...
              className={cn(
                'flex items-center gap-2.5 px-4 py-2.5 rounded-lg transition-all duration-200 border-2 font-medium',
                activeChannel === channel.id
                  ? channel.activeClass + ' shadow-lg shadow-black/10'
                  : channel.inactiveClass + ' hover:scale-105'
              )}
            >
              <span className={cn(
                'flex-shrink-0',
                activeChannel === channel.id ? 'text-white' : ''
              )}>
                {channel.icon}
              </span>
