...
describe("NewsRoomPage", () => {
  ...
  it("should load and display pending news items", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Breaking: New Immigration Policy Announced"),
      ).toBeInTheDocument();
    });
  ...
  it("should show empty state when no items", async () => {
    ...
    expect(
      screen.getByText(
        /The intelligence scraper hasn't flagged any new items/i,
      ),
    ).toBeInTheDocument();
  });
  ...
  describe("Filtering and Sorting", () => {
    it("should filter items by search query", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.queryByText("Visa Requirements Updated"),
        ).not.toBeInTheDocument();
      });
    });
