...
import { Shield, Newspaper, PenTool, BarChart3, Activity, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="text-center py-8">
        <h1 className="text-4xl font-bold text-[var(--foreground)] mb-3">Intelligence Center</h1>
        <p className="text-lg text-[var(--foreground-muted)] max-w-2xl mx-auto">
          AI-powered tools for monitoring Indonesian immigration regulations, curating news, and
        ...
        {tools.map((tool) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-[var(--foreground-muted)] text-sm mb-4">{tool.description}</p>
