  ...
  if (isLoading) {
    return (
      <div className="space-y-6 animate-in fade-in duration-500">
        <section>
          <div className="h-7 w-24 rounded animate-pulse" style={{ background: 'var(--bz-border)' }} />
          <div className="h-4 w-64 rounded mt-2 animate-pulse" style={{ background: 'var(--bz-border)', opacity: 0.5 }} />
        </section>
        <div className="rounded-xl border p-6 space-y-4 animate-pulse" style={{ background: 'rgba(30,30,35,0.7)', borderColor: 'rgba(255,255,255,0.05)' }}>
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex items-center justify-between py-3 border-t" style={{ borderColor: 'var(--bz-border)' }}>
              <div className="space-y-1">
                <div className="h-4 w-36 rounded" style={{ background: 'var(--bz-border)' }} />
                <div className="h-3 w-52 rounded" style={{ background: 'var(--bz-border)', opacity: 0.4 }} />
              </div>
              <div className="h-6 w-11 rounded-full" style={{ background: 'var(--bz-border)' }} />
            </div>
          ))}
        </div>
      </div>
