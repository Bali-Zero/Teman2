...
export async function generateMetadata({
  ...
  const metaOverrides: Record<string, { title: string; description: string; keywords?: string[] }> =
    {
      visa: {
        title: 'Bali Visa Agency 2026 | KITAS, Visit & Working Visa Indonesia | Bali Zero',
        description:
      ...
      company: {
        title: 'Company Registration Bali 2026 | PT PMA, Business License Indonesia | Bali Zero',
        description:
      ...
      tax: {
        title: 'Indonesia Tax Compliance 2026 | NPWP, Tax Filing & Advisory | Bali Zero',
        description:
      ...
      property: {
        title: 'Bali Property Services 2026 | Legal Due Diligence & Investment | Bali Zero',
        description:
