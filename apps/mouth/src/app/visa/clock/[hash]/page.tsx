...
/**
 * Rumah Putih LIGHT wrapper for the visa clock surfaces. Per-page (NEVER on
 * /visa/layout.tsx — shared, owns the dark NavShell). AppFrame + App* are
 * token-driven, so RUMAH_VARS flips the readable surfaces to paper.
 */
  ...
  return (
    <VisaLight>
      <AppFrame
        ...
        footer={
          <>
            Timeline generated {formatIsoDate(today)}. Government fees may
            change —{" "}
            <a
