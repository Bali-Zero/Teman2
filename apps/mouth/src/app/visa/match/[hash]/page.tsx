...
/**
 * Rumah Putih LIGHT wrapper for the visa result surfaces. Applied per-page
 * (NEVER on /visa/layout.tsx — shared, owns the dark NavShell). The AppFrame +
 * App* components are token-driven, so the RUMAH_VARS re-map flips the readable
 * surfaces (stamp, cost, checklist, CTA) to paper; image/overlay islands stay
 * dark via the rumah-putih .absolute exclusions.
 */
function VisaLight({ children }: { children: ReactNode }) {
  return (
