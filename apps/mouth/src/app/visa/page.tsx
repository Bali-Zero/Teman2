...
export default function VisaEntryPage() {
  ...
  return (
    // Rumah Putih LIGHT — applied per-page (NEVER on /visa/layout.tsx, which is
    // shared and owns the dark NavShell). AppFrame/BranchSelector/TrustStrip are
    // token-driven (--surface-base/--text-primary/--surface-raised), so the
    // RUMAH_VARS re-map flips them to paper. The ambient video is an .absolute
    // overlay → stays a dark island via the rumah-putih .absolute exclusions.
