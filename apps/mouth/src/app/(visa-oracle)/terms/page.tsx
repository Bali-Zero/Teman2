    ...
    >
      ...
      <section className="mb-8">
        ...
        <p style={{ color: "var(--tx-secondary)" }}>
          ...
          immigration. This is not legal advice. Immigration regulations change
          frequently and information presented here may not reflect the most
          recent changes.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p style={{ color: "var(--tx-secondary)" }}>
          Bali Zero is a registered business services provider in Indonesia, not
          a law firm or licensed immigration consultancy. Our AI provides
          information, not professional legal counsel.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p style={{ color: "var(--tx-secondary)" }}>
          We may update these terms at any time. Continued use of Visa Oracle
