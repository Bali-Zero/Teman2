...
import { isCallingVisa, isGuarantorRequired } from '@/lib/visa-oracle/nationalities';
      ...
      <div className="flex flex-col gap-6 max-w-2xl mx-auto py-8">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold" style={{ color: 'var(--bz-accent)' }}>
              Calling Visa Required
            </h2>
          </div>
          <div className="flex flex-col gap-3" style={{ color: 'var(--tx-secondary)' }}>
            <p className="leading-relaxed">
              As a national of <strong style={{ color: 'var(--tx-primary)' }}>{nationality}</strong>,
              you are required to apply for a{' '}
              <strong style={{ color: 'var(--tx-primary)' }}>Calling Visa</strong> to enter Indonesia.
            </p>
            <p className="leading-relaxed">
              This is a special visa category that requires:
            </p>
            <ul className="list-disc list-inside space-y-1.5 text-sm">
              <li>A corporate guarantor (sponsor company) based in Indonesia</li>
              <li>Mandatory interview at the Directorate General of Immigration in Jakarta</li>
              <li>Pre-approval from Indonesian Immigration before visa issuance</li>
              <li>Processing time is typically longer than standard visas</li>
            </ul>
            <p className="leading-relaxed text-sm mt-2">
              The Calling Visa process is complex and cannot be done independently. Our immigration
              team has experience handling these cases and can guide you through every step.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-6 max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-sm leading-relaxed" style={{ color: 'var(--tx-secondary)' }}>
            As a national of <strong style={{ color: 'var(--tx-primary)' }}>{nationality}</strong>,
            your visa application requires a company sponsor (guarantor) in Indonesia. Processing may
            take longer and requires additional verification. Our team can act as your sponsor.
          </p>
        </div>

        {/* Still show normal results below the warning */}
        <div className="flex flex-col gap-2">
          <h1 className="text-2xl sm:text-3xl font-bold">Your visa recommendations</h1>
          <p className="text-sm" style={{ color: 'var(--tx-secondary)' }}>
            You have{' '}
            <span style={{ color: 'var(--bz-accent)' }}>{MAX_QUESTIONS} free questions</span> to ask
            about these visa options.
          </p>
        </div>
        ...
        >
          <div className="flex flex-col gap-1 flex-1">
            <p className="font-semibold text-sm">Need sponsorship assistance?</p>
            <p className="text-xs leading-relaxed" style={{ color: 'var(--tx-secondary)' }}>
              Our team can act as your corporate guarantor and handle the entire visa process.
            </p>
          </div>
          <a
  ...
  if (visas.length === 0) {
    return (
      <div className="flex flex-col items-center gap-6 py-20 text-center max-w-lg mx-auto">
        ...
        <p className="text-sm leading-relaxed" style={{ color: 'var(--tx-secondary)' }}>
          We could not find a visa matching your profile. Speak directly with our team on WhatsApp —
          they will help you find the right solution.
        </p>
        <a
          href="https://wa.me/6281338051876"
          target="_blank"
  ...
  return (
    <div className="flex flex-col gap-8 max-w-2xl mx-auto">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl sm:text-3xl font-bold">Your visa recommendations</h1>
        <p className="text-sm" style={{ color: 'var(--tx-secondary)' }}>
          You have <span style={{ color: 'var(--bz-accent)' }}>{MAX_QUESTIONS} free questions</span>{' '}
      ...
      >
        <div className="flex flex-col gap-1 flex-1">
          ...
          <p className="text-xs leading-relaxed" style={{ color: 'var(--tx-secondary)' }}>
            Our Bali Zero immigration specialists are ready to help you start your application
            today.
          </p>
        </div>
        <a
