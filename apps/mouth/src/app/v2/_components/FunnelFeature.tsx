...
import { Search, IdCard, Building2, TrendingUp, MapPinned, ArrowRight, Sparkles, MapPin, type LucideIcon } from "lucide-react";
...
const CONFIGS: Record<Exclude<Funnel, null>, Omit<FunnelFeatureProps, "layout">> = {
  visa: {
    funnel: "visa",
    status: "Live",
    badge: "AI Immigration Assistant",
    title: "Visa Oracle",
    subtitle: "KITAS & Golden Visa 2025: residency guide for foreign investors.",
    description:
    ...
    searchSuggestions: ["KITAS for retirees", "Golden Visa 5yr", "E33G investor", "Digital Nomad B1", "Dependent family visa"],
    Icon: IdCard,
  ...
  kbli: {
    ...
    searchPlaceholder: "Search KBLI codes — e.g. villa rental, restaurant, tech startup",
    searchSuggestions: ["Villa rental", "Restaurant", "Tech startup", "Property", "Education"],
    Icon: Building2,
  ...
  tax: {
    ...
    subtitle: "CoreTax 2025: corporate tax compliance for foreign PT PMA owners.",
    description:
    ...
    searchSuggestions: ["PPh 21 for expats", "VAT refund", "SPT annual", "BPJS", "LKPM quarterly"],
    Icon: TrendingUp,
  ...
  property: {
    ...
    title: "Property Map",
    subtitle: "Property due diligence 2025: zoning guide for foreign buyers in Bali.",
    description:
    ...
    searchSuggestions: ["Canggu villa zone", "Ubud residential", "Seminyak commercial", "Hak Pakai", "Leasehold"],
    Icon: MapPinned,
...
export function FunnelFeature({
  ...
  return (
    <section
      ...
      style={{
        paddingTop: isFull ? "clamp(48px, 6vw, 80px)" : "clamp(32px, 4vw, 48px)",
        paddingBottom: isFull ? "clamp(48px, 6vw, 80px)" : "clamp(32px, 4vw, 48px)",
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            border: "1px solid color-mix(in srgb, var(--accent-funnel) 18%, transparent)",
            boxShadow:
        ...
        <div
          ...
          style={{
            ...
            border: "1px solid color-mix(in srgb, var(--accent-funnel) 55%, transparent)",
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              border: "1px solid color-mix(in srgb, var(--accent-funnel) 50%, transparent)",
              background: "color-mix(in srgb, var(--accent-funnel) 14%, transparent)",
            }}
          >
            <span
          ...
          <h2
            ...
            style={{
              ...
              fontSize: isFull ? "clamp(40px, 4vw, 60px)" : "clamp(28px, 2.6vw, 38px)",
            }}
          >
            {cfg.title}
          </h2>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <button
              ...
              style={{
                ...
                boxShadow: "0 8px 32px color-mix(in srgb, var(--accent-funnel) 40%, transparent)",
              }}
            >
              {cfg.cta}
            ...
            <a
              ...
              style={{
                background: "color-mix(in srgb, var(--accent-funnel) 8%, transparent)",
          ...
          <div
            ...
            style={{
              ...
              border: "1px solid color-mix(in srgb, var(--accent-funnel) 32%, transparent)",
          ...
          <div className="flex flex-wrap gap-1.5">
            {cfg.searchSuggestions.slice(0, 4).map((sug) => (
              <button
                ...
                style={{
                  background: "color-mix(in srgb, var(--accent-funnel) 10%, transparent)",
                  border: "1px solid color-mix(in srgb, var(--accent-funnel) 28%, transparent)",
                  color: "var(--accent-funnel-text)",
                }}
              >
                {sug}
