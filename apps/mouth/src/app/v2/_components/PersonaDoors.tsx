...
const DOORS: Door[] = [
  {
    ...
    href: "/visa",
    alsoNeeded: "Also needed: PT PMA setup (62% of long-term visa holders)",
  },
  {
    door: "company",
    funnel: "kbli",
    ...
    href: "/kbli",
    alsoNeeded: "Also needed: KITAS investor + tax compliance",
  },
  {
    door: "tax",
    funnel: "tax",
  ...
  },
  {
    ...
    href: "/property",
    alsoNeeded: "Also needed: PT PMA for foreign ownership + due diligence",
  },
];
    ...
    >
      ...
      <div className="max-w-[1120px] mx-auto px-6 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          {DOORS.map(
            ({ door, funnel, title, body, fact, tool, href, alsoNeeded }) => {
