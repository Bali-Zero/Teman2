...
export const KBLI_CONCORDANCE_2025: Record<string, ConcordanceEntry> = {
  "63122": {
    ...
    impact: "Digital Agencies, Portals, and Nomad hubs are now technically non-compliant.",
    action: "Requires split into specific codes for AI, Content, or Infrastructure."
  },
  "56101": {
    code: "56101",
    status: "CRITICAL",
    reason: "Restructured F&B classification for Restaurants.",
    impact: "Small Cafés are being auto-migrated into Large Enterprise categories (10B IDR investment).",
  ...
  "70209": {
    ...
    impact: "Consulting firms must now specify their sector (IT, HR, Marketing, etc.).",
  ...
  "62019": {
    ...
    impact: "High-tech companies need to align with new specific incentive-eligible codes.",
