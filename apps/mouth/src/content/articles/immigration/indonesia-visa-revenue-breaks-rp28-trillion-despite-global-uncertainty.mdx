...
<Checklist
  title="Action Items"
  items={[
    { text: "Recommended Actions", subItems: ["Identify your current permit expiry date and calculate whether your next renewal falls within the next 12 months. If so, initiate your application now to lock in the current PNBP schedule rather than risk a revision cycle. Request a written, dated fee breakdown from your immigration agent \u2014 not a cached quote from prior quarters. Business owners sponsoring expatriate KITAS should model immigration costs over the next 24 months, treating a 10\u201320% PNBP increase as a conservative planning scenario. Monitor official publications from Direktorat Jenderal Imigrasi at imigrasi.go.id and the Ministry of Law and Human Rights for any new Government Regulation on PNBP tariffs. If you are evaluating a first visa application or a permit upgrade, schedule a consultation before the next expected revision window."] },
  ]}
/>
