...
<InfoCard
  ...
  items={[
    ...
    { label: "Who's Affected", value: "Tourists, digital nomads, and investors in Bali" },
    { label: "Key Change", value: "B211A abolished — now B1 (Visit) and C1 (Tourist/eVOA)" },
  ]}
/>
...
<Checklist
  title="Action Items"
  items={[
    { text: "Check your visa type", subItems: ["Confirm you have a valid B1 (Visit Visa) or C1 (Tourist Visa/eVOA) for your stay. The old B211A no longer exists — if a third party offers you a 'B211A extension', this is not a valid Indonesian immigration product."] },
    { text: "For digital nomads and remote workers", subItems: ["If you are currently in Bali working remotely on a B1 or C1 tourist visa, consult an Indonesian immigration lawyer about the E33G Digital Nomad Visa or Second Home Visa — both provide a legal framework for remote work."] },
    { text: "For property holders", subItems: ["If you hold property through a nominee arrangement, request a title review from a licensed notaris and explore conversion to Hak Pakai or a PT PMA structure."] },
    { text: "For business owners and investors", subItems: ["If you are planning an extended stay or business activity in Bali in 2026, engage a business consultant before arrival to determine the correct visa and entity structure. Do not rely on informal advice — the cost of getting it wrong is deportation, not a fine."] },
  ]}
/>
