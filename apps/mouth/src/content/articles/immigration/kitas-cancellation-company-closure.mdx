...
tags: ["KITAS cancellation", "EPO", "exit permit", "company closure Indonesia", "leave Indonesia", "PT PMA dissolution", "BPJS cancellation", "tax clearance"]
...
seoTitle: "KITAS Cancellation 2026: Exit Process & Company Closure Guide"
...
**Consequence:**
- EPO expires
- You become overstay (IDR 300,000/day fine)
...
- If previous was employment (E25B), new could be investor (E27) or retirement (E26)
...
1. **WhatsApp consultation:** +62 812 3456 7890 (send "KITAS Cancel")
...
2. **Change KITAS type:** Convert to retirement (E26), investor (E27), or spouse visa (if married to Indonesian). Requires separate application.
...
You're immediately in overstay status. Fines are IDR 300,000/day. You'll need to visit immigration office to:
- Pay fines
...
- Overstaying EPO (IDR 300k/day fine)
...
**Next steps:** WhatsApp +62 812 3456 7890 with "KITAS Cancel" to start your cancellation process. Mention this article for priority consultation.
