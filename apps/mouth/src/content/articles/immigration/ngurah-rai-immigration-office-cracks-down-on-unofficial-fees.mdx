...
<Checklist
  ...
  items={[
    ...
    { text: "For Investors", subItems: ["Review the current official PNBP fee schedule for your pending immigration document before your next appointment at Ngurah Rai \u2014 these are published on the Dirjen Imigrasi website and should be your only financial reference point. If you have an upcoming KITAS renewal, KITAP application, or visa extension, verify with your immigration consultant that your file is complete to avoid any pretext for delays that might generate informal payment requests. If you are approached for any payment not on the official fee schedule, decline, note the staff member's name and post, and use the office's complaint mechanism or report via the national KPK portal. Contact Bali Zero if you experience any irregularity \u2014 we track systemic patterns and can advise on escalation."] },
  ]}
/>
