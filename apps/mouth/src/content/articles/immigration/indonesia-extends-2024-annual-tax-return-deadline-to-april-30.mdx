...
<Checklist
  title="Action Items"
  items={[
    { text: "Recommended Actions", subItems: ["Contact your Indonesian tax consultant or accountant this week to confirm your 2024 filing obligations and gather all required documents: salary slips, dividend records, overseas income declarations, and your Form 1721-A1 or A2 from your employer if applicable. Log in to djponline.pajak.go.id to verify your NPWP status and check for any pre-populated data in your e-Filing account. If you owe tax for 2024, arrange payment via the e-Billing system before filing \u2014 do not wait until April 30 for both. If you are unsure whether you qualify as an Indonesian tax resident or whether your income is taxable in Indonesia, consult a licensed Konsultan Pajak before the deadline. Bali Zero can connect you with a qualified tax advisor familiar with expatriate and PT PMA filing requirements."] },
  ]}
/>
