...
seoTitle: "Indonesia's Hajj Pilgrims Arrive in Saudi Arabia: What..."
seoDescription: "## Facts  Each year, Indonesia sends the world's largest national Hajj delegation to Saudi Arabia, with quotas typically ranging between 200,000 and..."
aiGenerated: true
aiConfidenceScore: 0.85
aiOptimization:
  answerSnippet: "## Facts  Each year, Indonesia sends the world's largest national Hajj delegation to Saudi Arabia, with quotas typically ranging between 200,000 and 240,000 pilgrims. The journey represents one of the most significant logistical operations managed by the Indonesian government, co"
  primaryQuestion: "What does Indonesia's Hajj Pilgrims Arrive in Saudi Arabia: What Expats Should Know mean for expats in Bali?"
...
<Checklist
  title="Action Items"
  items={[
    { text: "For Expats", subItems: ["\u2014 this is a planning and awareness item, not a crisis signal."] },
