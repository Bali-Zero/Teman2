...
<Checklist
  title="Action Items"
  items={[
    { text: "Recommended Actions", subItems: ["Americans planning a Bali relocation should establish their primary intent\u2014tourism, remote work, retirement, or investment\u2014before selecting a visa entry point, since the entry document determines what conversion options are available onshore. Those arriving within 90 days: enter on a C1 Visit Visa rather than Visa on Arrival if there is any possibility of extending beyond 60 days. Digital nomads must prepare 12 months of income documentation confirming the USD 60,000 threshold and obtain written confirmation of their employer's non-Indonesian domicile. Investors approaching the USD 2.5M Golden Visa threshold should obtain a legal assessment of the Jaminan Keimigrasian financial guarantee process before committing capital. Anyone holding a KITAS issued before UU 63/2024 should verify the MERP appears on their permit or request written confirmation from their immigration agent. Never overstay: the Rp 1,000,000 daily fine carries no grace period."] },
  ]}
/>
