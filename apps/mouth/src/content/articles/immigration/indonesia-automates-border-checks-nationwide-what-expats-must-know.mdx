...
<Checklist
  title="Action Items"
  items={[
    { text: "Recommended Actions", subItems: ["On your next arrival in Indonesia, ask the immigration officer at the counter whether your biometric data is enrolled. If it is not, the enrollment takes under two minutes and activates autogate access for every subsequent visit. Do not assume it happened automatically, even if you have been visiting for years.", "If you hold a KITAS or KITAP and recently renewed your permit, verify with your immigration agent that biometric data was captured or updated as part of the renewal process \u2014 not all renewals trigger a re-enrollment if the permit office and the airport operate separate data systems.", "Business owners managing expat staff: brief your team before their next international departure so they arrive with accurate expectations. Monitor the Directorate General of Immigration's official site (imigrasi.go.id) for the official list of airports included in each expansion phase."] },
  ]}
/>
