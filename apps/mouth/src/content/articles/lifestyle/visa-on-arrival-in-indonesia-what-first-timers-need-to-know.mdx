...
seoTitle: "Visa on Arrival in Indonesia: What First-Timers Need to Know"
seoDescription: "## Facts  The Visa on Arrival (VoA) is Indonesia's primary entry mechanism for nationals of eligible countries, currently priced at IDR 500,000..."
aiGenerated: true
aiConfidenceScore: 0.85
aiOptimization:
  answerSnippet: "## Facts  The Visa on Arrival (VoA) is Indonesia's primary entry mechanism for nationals of eligible countries, currently priced at IDR 500,000 (approximately USD 30) per entry and valid for 30 days. It can be extended once, for an additional 30 days, at a local immigration offic"
  primaryQuestion: "What does Visa on Arrival in Indonesia: What First-Timers Need to Know mean for expats in Bali?"
...
<Checklist
  ...
  items={[
    ...
    { text: "For Investors", subItems: ["KITAS, or Second Home Visa. Do not assume you can convert a VoA to a work or stay permit from inside Indonesia without advance preparation."] },
  ]}
/>
