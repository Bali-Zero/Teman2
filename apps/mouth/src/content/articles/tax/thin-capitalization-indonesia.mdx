...
seoDescription: "Indonesia's thin cap rule limits DER to 4:1 under PMK 169/2015. Interest on excess debt is non-deductible. Complete guide for PT PMA financing and exceptions."
readingTime: 13
aiGenerated: true
aiConfidenceScore: 0.90
aiOptimization:
  primaryQuestion: "What is the thin capitalization rule in Indonesia?"
  answerSnippet: "Indonesia's thin capitalization rule under PMK 169/PMK.010/2015 limits the debt-to-equity ratio to 4:1 for tax purposes. If a company's total debt exceeds four times its equity, the interest expense on the excess portion is not deductible for corporate income tax. This applies to both third-party and intercompany debt, with exceptions for certain regulated industries."
  entityMentions:
...
canonicalUrl: "https://balizero.com/news/tax-legal/thin-capitalization-indonesia"
