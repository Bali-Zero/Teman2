...
Under Indonesian Income Tax Law (UU PPh No. 36/2008, Pasal 2), an individual becomes a **domestic tax subject** — which is effectively tax residency — through one of two routes: physical presence or vital interest. The law does not require you to tick both boxes. Either one is enough.
...
The critical detail that trips people up: the 12-month window is **not a calendar year**. It is a rolling 12-month window calculated from the date of your first entry into Indonesia in that period. If you arrived in Bali on July 14, the DJP counts forward to July 13 of the following year — not December 31.
