...
seoDescription: "Complete freelancer tax guide Indonesia 2026. NPWP registration, PPh 21 withholding, norma deemed profit by profession, quarterly payments, SPT 1770 filing."
aiOptimization:
  primaryQuestion: "How do freelancers pay taxes in Indonesia?"
  answerSnippet: "Freelancers in Indonesia must register for NPWP and file annual SPT 1770. If paid by an Indonesian company, PPh 21 is withheld at source. For direct client payments, freelancers self-assess using either actual bookkeeping or norma penghitungan (deemed profit percentages by profession, typically 40-50% of revenue). Quarterly PPh 25 installments are required based on prior year's tax liability."
  entityMentions:
...
canonicalUrl: "https://balizero.com/news/tax/tax-for-freelancers-indonesia-2026"
