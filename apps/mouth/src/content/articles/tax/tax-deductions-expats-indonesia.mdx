...
aiOptimization:
  ...
  answerSnippet: "Expats in Indonesia can claim PTKP (non-taxable income) of IDR 54 million for single filers, plus IDR 4.5 million per dependent (max 3). Additional deductions include occupational expenses (5% of gross, max IDR 6 million/year), pension contributions, and BPJS contributions. Corporate employers can deduct expat-related costs like housing, transport, and RPTKA fees."
  entityMentions:
...
canonicalUrl: "https://balizero.com/news/tax-legal/tax-deductions-expats-indonesia"
