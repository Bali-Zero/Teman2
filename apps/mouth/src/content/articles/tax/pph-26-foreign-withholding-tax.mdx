...
coverImage: "/static/blog/tax/pph-26-foreign-withholding-tax.jpg"
...
trending: false
status: "published"
seoTitle: "PPh 26 Indonesia Guide 2026: Foreign Withholding Tax & Treaty Rates"
seoDescription: "Master PPh 26 withholding tax on foreign payments. Learn 20% standard rate, tax treaty reductions, DGT form requirements, and compliance for cross-border transactions."
aiOptimization:
  primaryQuestion: "What is PPh 26 and when do I need to withhold tax on payments to foreign parties?"
  answerSnippet: "PPh 26 is withholding tax on payments from Indonesian entities to non-resident foreign parties. Standard rate is 20% on services, dividends, interest, royalties, and other income. Tax treaties may reduce rates with proper documentation (DGT form). Withhold at payment, remit by 10th of following month, and report monthly via e-Bupot."
  entityMentions:
