...
This gap matters for BPHTB (transfer tax) calculations, where the tax base is the higher of NJOP or the actual transaction price. See our [BPHTB guide](/taxes/bphtb-property-transfer-tax) for details.
