...
<Checklist
  title="Action Items"
  items={[
    { text: "Recommended Actions", subItems: ["If you are an individual or SME investor setting up a PT PMA: assess whether your target sector qualifies as a pioneer industry under current Ministry of Finance guidelines. If it does, initiate the tax holiday application process \u2014 the benefit remains fully intact for your group size and the GMT debate is irrelevant to you.", "If you are part of a large MNE group with consolidated revenue above EUR 750 million: commission a Pillar Two ETR analysis for your Indonesian entity before committing to a tax holiday application. Map whether your parent's home country has enacted IIR and whether UTPR exposure exists elsewhere in your ownership chain.", "For all clients with long-horizon investment plans: ask your tax adviser to run explicit QDMTT scenarios in any five-year-plus financial model. Contact Bali Zero for a current-position review of how GMT intersects with your Indonesian investment structure."] },
  ]}
/>
