...
<Checklist
  title="Action Items"
  items={[
    { text: "Recommended Actions", subItems: ["Audit your current LKPM filing history in the OSS portal: log in, navigate to Investment Activity Reports, and verify that all quarterly reports for 2024 and 2025 show 'submitted' status. If any are missing, file remediation reports immediately \u2014 late submission is penalized but accepted; non-submission is not. Confirm whether your PT PMA has completed the 2024 RUPS and, if so, whether the results were submitted via SABH under Permenkum 49/2025 \u2014 this is the highest-probability compliance gap for companies established before 2025. Check KITAS and IMTA expiry dates for all expatriate employees against a 90-day forward window. If your company has not filed an annual manpower report for the current year, engage your HR representative or legal advisor to do so before December 31."] },
  ]}
/>
