...
- **Just over two-thirds not blocked** (1,040 codes carry no blocked flag — though 70 of them are scope-dependent and a handful unclassified) means the door you want is _probably_ findable — usually as the higher-risk sibling of the code you first reached for. The pivot exists more often than not.
