...
**Of 1,559 classified KBLI codes, 518 are blocked for a foreign PT PMA in Bali. That is 33.2% — just over one in three.**
...
- **372 — blocked by risk class** (`BLOCCATO_CLASSE_RISCHIO`): all but one nationally open, but low/medium-low risk, so the moratorium catches them. This is the dominant category — the café, the jewellery wholesaler, the general retailer.
