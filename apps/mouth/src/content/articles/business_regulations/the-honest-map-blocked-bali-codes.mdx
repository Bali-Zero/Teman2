...
- **5 — the remainder**: 2 closed by their own sector regulator, 1 scope-dependent, 2 under Bali's own announced closures (70209 and one proposed).
...
- **Just over two-thirds not blocked** (1,041 codes carry no blocked flag — though 67 of them are scope-dependent and a handful unclassified) means the door you want is _probably_ findable — usually as the higher-risk sibling of the code you first reached for. The pivot exists more often than not.
