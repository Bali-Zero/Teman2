...
National: open. Bali: **BLOCKED** — and the basis is an explicit reservation, not a missing registration row. Perpres 10/2021, as amended by Perpres 49/2021, allocates _salon kecantikan_ to cooperatives and MSMEs in its Annex II (p.16, entry 57, against KBLI 96112, ticked _dialokasikan_). A PT PMA cannot take a reserved _bidang usaha_, so a foreign-owned beauty salon or aesthetics studio operating under 96220 cannot be registered here.
...
_Check 86105 and 96220 side by side on the Bali Zero KBLI Navigator at balizero.com — the two-branch national-vs-Bali view shows you the clinical-vs-cosmetic line that decides whether your wellness business is an open door or a hidden wall._
