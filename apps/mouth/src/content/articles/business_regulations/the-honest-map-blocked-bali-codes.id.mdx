...
**Dari 1.559 kode KBLI terklasifikasi, 519 diblokir untuk PT PMA asing di Bali. Itu adalah 33,3% — hampir tepat satu dari tiga.**
...
Dan berikut adalah bagian yang paling sering disembunyikan oleh perhitungan: 519 tersebut terbagi menjadi jenis-jenis _tidak_ yang berbeda —
...
- **Sedikit lebih dari dua pertiga tidak diblokir** (1.040 kode tanpa penanda blokir — meski 70 di antaranya bergantung ruang lingkup dan segelintir belum terklasifikasi) berarti pintu yang Anda inginkan _mungkin_ dapat ditemukan — biasanya sebagai versi berisiko lebih tinggi dari kode yang pertama kali Anda tuju. Pivot sering kali ada.

Peta ini bukan "Bali tertutup." Ini adalah "Bali tertutup untuk versi _mudah, berisiko rendah_ dari sebagian besar hal, dan terbuka untuk versi _serius, berisiko lebih tinggi_ dari banyak hal tersebut." Kalimat tunggal ini, didukung oleh 519 kode yang dihitung, adalah seluruh moratorium dalam satu baris.
