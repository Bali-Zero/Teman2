...
Latar belakang ekonomi global turut memperburuk tekanan ini. Bank sentral utama, khususnya Federal Reserve AS, mempertahankan sikap moneter yang relatif *hawkish* untuk meredam inflasi mereka sendiri. Hal ini menjaga imbal hasil aset berdenominasi Dolar tetap menarik dan memicu arus modal keluar dari pasar obligasi serta ekuitas di pasar berkembang. Oleh karena itu, Indonesia harus mengelola guncangan langsung dari konflik Timur Tengah sekaligus tekanan tidak langsung dari penguatan Dolar AS secara bersamaan.
...
<Checklist
  ...
  items={[
    { text: "Untuk Ekspatriat", subItems: ["Tinjau pengeluaran bulanan dan manfaatkan daya beli valas untuk investasi aset tetap di Indonesia."] },
    { text: "Untuk Investor", subItems: ["Segera tinjau eksposur mata uang asing Anda: jika Anda menyimpan tabungan Rupiah dalam jumlah besar untuk kebutuhan valas di masa depan, pertimbangkan langkah konversi parsial atau lindung nilai (*hedging*) sesuai dengan jangka waktu investasi Anda. Konsultasikan dengan penasihat keuangan berlisensi sebelum melakukan transaksi valas besar.", "Jika berencana melakukan investasi signifikan—seperti properti, pendirian PT PMA, atau injeksi modal—buatlah pemodelan skenario menggunakan berbagai tingkat nilai tukar. Fluktuasi Rupiah sebesar 5–10% sangat mungkin terjadi dalam skenario konflik yang berkepanjangan.", "Pelaku bisnis harus mengaudit struktur biaya terkait impor dan memodelkan dampak Laporan Laba Rugi jika terjadi depresiasi lebih lanjut sebesar 10%. Segera mulai negosiasi dengan pemasok terkait penyesuaian harga. Pantau terus pernyataan resmi Bank Indonesia mengenai suku bunga sebagai indikator utama arah pergerakan Rupiah."] },
  ]}
/>
