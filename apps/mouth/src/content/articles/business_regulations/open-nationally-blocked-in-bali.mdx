...
The villa code looks like the textbook case, and isn't. **KBLI 55203 (Aktivitas Vila)** is reserved nationally by Lampiran II, not a Bali-only block: Annex II of Perpres 10/2021, as amended by 49/2021, allocates the _Vila_ line of business to cooperatives and MSMEs (p.15, entry 48), and a reserved _bidang usaha_ is closed to a PT PMA at any scale, in Bali or anywhere else in Indonesia. There was never a national door open here for the risk-class filter to lock behind it — the closure sits on the same national instrument.

The milder pattern — national door open, provincial door locked, two different doors — is what actually repeats across hospitality, food and beverage, retail, real estate, and creative services. Villa is the harder wall of the two.
