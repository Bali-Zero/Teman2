...
The villa code is the textbook case. **KBLI 55203 (Aktivitas Vila)** is `TERBUKA` — 100% open — on the national list. In Bali, it is blocked. (The precise mechanism is a touch more elegant than "low-risk": Annex II of Perpres 10/2021, as amended by 49/2021, allocates the _Vila_ line of business to cooperatives and MSMEs, and a reserved _bidang usaha_ is closed to a PT PMA at any scale. The outcome for the foreigner is identical: you cannot register it.)
