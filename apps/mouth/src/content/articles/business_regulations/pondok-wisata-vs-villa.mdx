...
Both of these codes read `TERBUKA` — 100% open — on the national investment list. Both are closed to a foreign-owned company in Bali. But they are closed in two _different_ ways, and the difference is the whole story.
...
- **55203 — Aktivitas Vila.** The boutique villa. Bali status: **blocked** — but via a different mechanism: _Vila_ is one of the lines of business Annex II of Perpres 10/2021 (as amended by 49/2021) allocates to cooperatives and MSMEs, so a PT PMA cannot take it at any scale.

So: the villa is blocked because the system has no door your foreign company can fit through. The pondok wisata is _closed_ — reserved outright for Indonesians, with an owner-resident requirement baked in.
