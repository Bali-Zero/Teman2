...
Both of these codes are allocated to cooperatives and MSMEs by the *same* line of the same annex: entry 48 of Annex II, Perpres 10/2021 as amended by 49/2021, which covers traditional lodging. A new PT PMA cannot enter either line of business, in Bali or anywhere else in Indonesia. What differs is the sub-row each code falls under, and what that means for the business model.
