...
The national law looks like it agrees with you: **KBLI 55203 — Aktivitas Vila** — is listed as `TERBUKA` on the national scale table. So you set up the PMA, lease the land, and start construction next month. Right?
...
There is no route around this one: because the closure is a national annex reservation, not a provincial moratorium, registering the 55203 PMA in a different province does not open a path — the same allocation to cooperatives and MSMEs applies there too. Be honest with yourself: 55204 or 55400 is the way a foreigner actually gets into accommodation, not a change of address.
