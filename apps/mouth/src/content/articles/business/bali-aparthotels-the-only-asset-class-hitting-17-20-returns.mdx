...
Bali's property market has long attracted foreign capital on the promise of high rental yields, but most investors end up with returns in the 6–10% range — respectable by global standards, yet well short of the figures circulated in developer brochures. The aparthotel category is the exception. Units within professionally managed aparthotel complexes are consistently producing net returns of 17–20% per annum, according to data from operators and independent analysts tracking the Seminyak, Canggu, and Ubud corridors.
