...
seoDescription: "How KBLI 2025 serves as Indonesia's industrial policy tool — formalizing the digital economy, enabling green finance, and modernizing business classification."
readingTime: 12
aiGenerated: true
...
canonicalUrl: "https://balizero.com/news/business/upgrading-indonesia-kbli-2025"
...
The new system expands to **22 categories** (A through V), **87 main groups**, and **1,560 five-digit codes**. The mandatory compliance deadline is **June 18, 2026**.
...
4. **Update your investment reporting (LKPM)** to reflect the correct codes once OSS is ready.
5. **Use the [KBLI Navigator](/kbli-navigator/)** to explore the full classification system and identify your correct codes.

The deadline is real. The system integration is coming. And the businesses that treat this as a strategic opportunity — rather than an administrative burden — will be the ones that thrive in Indonesia's next economic chapter.
