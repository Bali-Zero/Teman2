...
The paid-up capital requirement for PT PMA incorporation has been reduced by 75%: from IDR 10 billion to **IDR 2.5 billion per company** (BKPM Regulation 5/2025, Art. 26(10)), regardless of how many KBLI codes it holds. This democratizes market access for mid-size operators. However, the total investment commitment of more than **IDR 10 billion** per 5-digit KBLI code per project location (Art. 26(2)), excluding land and building acquisition, must still be demonstrated over time through tangible Capex, inventory, IT infrastructure, and operational expenses.

The critical insight: **wholesale trade (KBLI 46xxx) is the one sector where several codes can share a single threshold — but only within the same first-4-digit group** (Art. 26(3)(a)). 46441, 46791, and 46499 sit in three different 4-digit groups (4644, 4679, 4649), so a PT PMA registering all three still needs an investment plan of more than IDR 10 billion for each group — above IDR 30 billion combined, not a single IDR 10 billion plan. The real efficiency multiplier is registering several sub-codes that DO share a 4-digit prefix (for example three variants within 4644x), which genuinely consolidate under one threshold.
