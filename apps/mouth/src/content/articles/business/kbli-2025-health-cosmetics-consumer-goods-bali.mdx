...
Under BKPM Regulation 5/2025, you can incorporate with **IDR 2.5 billion paid-up capital** at the company level (Art. 26(10)) — a 75% reduction from the previous requirement, and it does not scale with the number of KBLI codes. However, the **total investment plan of more than IDR 10 billion** per 5-digit code, per project location (Art. 26(2)), must still be demonstrated over time. Wholesale trade (KBLI 46xxx) is the one exception that consolidates by the first 4 digits of the code (Art. 26(3)(a)) — but 46441, 46791, and 46499 sit in three different 4-digit groups (4644, 4679, 4649), so this combination still needs three separate investment plans above IDR 10 billion each, not a single IDR 10 billion plan.
