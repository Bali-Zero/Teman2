...
<InfoCard variant="danger" title="2026 Compliance Alert: Mandatory Annual Reports">
  **Regulation 49/2025:** As of March 2026, the Ministry of Law now mandates that all PT PMAs submit
  a notarized **Annual Report (GMS Approval)** via the SABH system. This is separate from your
  quarterly LKPM reports. Failure to submit this annual report will trigger an automatic NIB
  suspension and block all future corporate changes. [Read the full guide on the 2026 Corporate
  Reporting Mandate →](/business/indonesia-corporate-reporting-mandate-regulation-49-2025)
</InfoCard>
