...
- **Employee salaries** — For a software company, engineers *are* the factory
...
- **Exception:** Land and buildings *are* included for sectors where real estate is the primary product or production factor: property development, agriculture, aquaculture, and directly managed hospitality (hotels/resorts).
