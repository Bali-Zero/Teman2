...
<Checklist
  ...
  items={[
    ...
    { text: "For Investors", subItems: ["already holding Bali property, an annual compliance check of your PT PMA's KBLI registration, LKPM filings, and licence stack is the minimum standard to avoid enforcement exposure as regulatory scrutiny in Bali's tourism corridor increases."] },
  ]}
/>
