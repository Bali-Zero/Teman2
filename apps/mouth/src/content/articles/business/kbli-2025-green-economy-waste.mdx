...
- **38110 is the exception** — Non-hazardous waste collection carries no foreign-ownership reservation or cap located in Perpres 10/2021 as amended by 49/2021; PT PMA eligibility for this code must be confirmed in OSS, not assumed from the table above.
