...
seoDescription: "Understand Bali's new short-term rental rules for 2026. Learn about TDUP licensing, zoning, and tax compliance to keep your property legal and safe."
aiGenerated: true
aiConfidenceScore: 0.85
aiOptimization:
  answerSnippet: "Starting in 2026, all short-term rental owners in Bali must secure a tourism business registration certificate (TDUP) and ensure zoning compliance under Perda RTRW. Operators are also required to register for hotel tax (Pajak Hotel) and VAT (PPN) if turnover exceeds the Rp 4.8 billion threshold."
