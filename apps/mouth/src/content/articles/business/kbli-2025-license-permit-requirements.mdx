...
seoDescription: "Which permits does your KBLI code require? Low, medium, high risk licensing paths. Sector-specific permits for F&B, hospitality, construction. Bali Zero pricing."
readingTime: 13
aiGenerated: true
...
canonicalUrl: "https://balizero.com/news/business/kbli-2025-license-permit-requirements"
...
The mandatory compliance deadline is **June 18, 2026**. Every business operating in Indonesia — whether a new PT PMA or an existing company migrating from KBLI 2020 — must have the correct code and its corresponding licenses in place by that date.
...
**Note on OSS integration:** As of February 2026, the OSS system has **not yet fully integrated KBLI 2025 codes**. The system is expected to be updated before the June 2026 deadline. Businesses should prepare their documentation and code mapping now, then execute the formal registration when OSS is updated. See our [OSS registration guide](/insights/oss-registration-guide) for current system navigation.
...
5. **OSS has not yet integrated KBLI 2025.** Prepare now, execute when the system updates. The June 2026 deadline is firm.
