...
The June 2026 transition window has closed. Every business operating in Indonesia — whether a new PT PMA or an existing company migrating from KBLI 2020 — must have the correct code and its corresponding licenses in place by that date.
