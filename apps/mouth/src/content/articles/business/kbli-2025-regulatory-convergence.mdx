...
seoTitle: "KBLI 2025 Regulatory Convergence | PP 28/2025 & BKPM 5/2025 Foreign Investment Guide"
seoDescription: "How KBLI 2025, PP 28/2025, and BKPM Regulation 5/2025 converge to reshape foreign investment in Bali. Capital requirements, risk-based licensing, sector impacts, and migration strategy."
readingTime: 14
aiGenerated: true
aiConfidenceScore: 0.91
aiOptimization:
  primaryQuestion: "How do KBLI 2025, PP 28/2025, and BKPM Regulation 5/2025 affect foreign investment in Bali?"
  answerSnippet: "Three regulations converge to reshape foreign business in Indonesia. KBLI 2025 reclassifies all business activity codes with a June 18, 2026 migration deadline. PP 28/2025 assigns risk-based licensing tiers (Low to High) that determine your permit pathway. BKPM Regulation 5/2025 sets PT PMA capital at IDR 2.5B paid-up minimum with IDR 10B total investment per KBLI code. Together, they define what you can do, what permits you need, and how much capital you must commit."
  entityMentions:
    - type: "Regulation"
      name: "PP 28/2025"
    - type: "Regulation"
...
faq:
  - question: "What is the KBLI 2025 migration deadline?"
    answer: "June 18, 2026, per BPS Regulation 7/2025. All businesses must migrate from KBLI 2020 codes to KBLI 2025 equivalents by this date. Failure to migrate means your existing codes become 'ghost codes' — technically valid in your NIB but unrecognized by the updated OSS system, which can block license renewals, amendments, and new permit applications."
...
canonicalUrl: "https://balizero.com/news/business/kbli-2025-regulatory-convergence"
...
BPS Regulation 7/2025 establishes June 18, 2026, as the mandatory migration date. After this date, KBLI 2020 codes become "ghost codes" — technically present in your NIB (Nomor Induk Berusaha) but unrecognized by the updated OSS system. Ghost codes cannot be used for new license applications, permit renewals, or NIB amendments. Your company continues to exist, but its ability to transact with the regulatory system is effectively frozen until migration is completed.

The practical implication is that migration is not optional, but neither is it urgent in a way that rewards haste. The OSS system has not yet been fully updated to support KBLI 2025 codes as of February 2026. Rushing to migrate before the system is ready creates its own risks, particularly if intermediate codes or temporary mappings are used that do not accurately reflect your business activities.
...
Given the convergence of three major regulations, the incomplete state of OSS system updates, and the complexity of cross-regulation interactions, the correct strategic response for foreign investors is not to rush. It is to prepare methodically.

### Phase 1: Audit (Now through April 2026)
...
**Assess risk tier changes.** If any of your codes moved to a higher risk tier, identify the new licensing requirements. Determine what documentation, certifications, or verifications you will need. Begin assembling these materials now, before the migration deadline creates time pressure.
...
**Planning a PT PMA in Bali or migrating existing KBLI codes?** Bali Zero provides end-to-end regulatory advisory covering KBLI 2025 classification, PP 28/2025 risk assessment, and BKPM 5/2025 capital structuring. We audit your current compliance position and build a migration strategy that optimizes across all three regulations. [Contact us](https://balizero.com/contact) before the June 2026 deadline.
