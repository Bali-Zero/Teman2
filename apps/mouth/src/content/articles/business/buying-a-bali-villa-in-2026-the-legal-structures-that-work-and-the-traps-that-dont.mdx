...
<Checklist
  ...
  items={[
    ...
    { text: "For Investors", subItems: ["If you are actively considering a Bali property purchase: commission a title and zoning audit before signing any letter of intent or paying a deposit \u2014 this typically costs IDR 5\u201315 million and can prevent losses many orders of magnitude larger. If you are weighing leasehold against PT PMA, map your intended use first: personal residence favors Hak Pakai or leasehold; commercial rental favors PT PMA with the correct KBLI. Request the land certificate number and submit it for an independent BPN check. If a broker or developer discourages independent legal review or insists on urgency before due diligence is complete, treat that as a disqualifying red flag. Engage a PPAT who is not connected to the vendor's side of the transaction."] },
  ]}
/>
