...
Most physical retail codes are classified as **Rendah (Low)** risk. This means the licensing path through OSS is the simplest available: you register your NIB, declare your KBLI code, and receive your business license without additional professional certifications or third-party audits. For a foreign-owned PT PMA, the minimum investment commitment is more than IDR 10 billion per 5-digit KBLI code per project location (BKPM Regulation 5/2025, Art. 26(2)) — retail trade (47xxx) has no exception, unlike wholesale trade (46xxx), which is counted per the first 4 digits of the code (Art. 26(3)(a)).
...
Under BKPM Regulation 5/2025 (Art. 26(2)), the PT PMA minimum investment of more than IDR 10 billion, excluding land and buildings, applies per 5-digit KBLI code per project location — retail trade (47xxx) has no exception for this. Registering five retail codes at one location means an investment plan above IDR 50 billion, not a single IDR 10 billion commitment. If you register codes spanning furniture, jewelry, e-commerce, and automotive parts, each code needs its own credible investment plan at that location.
