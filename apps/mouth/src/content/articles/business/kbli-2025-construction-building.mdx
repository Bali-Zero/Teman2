...
Once the villa is built and operational, you need a hospitality code for running it as an accommodation business. Code 55193 specifically covers villa operations — guest bookings, housekeeping, facility management. This falls under the [hospitality and accommodation](/business/kbli-2025-hospitality-accommodation) classification.

**3. KBLI 68111 — Real Estat Yang Dimiliki Sendiri Atau Disewa (Management Phase)**

If the villa is part of a property portfolio — leased to guests, managed as a rental asset, or held as a real estate investment — you need this [real estate code](/business/kbli-2025-real-estate-property). It covers the ownership and leasing dimension of the business. All 68xxx codes allow 100% PMA.
...
For PT PMA companies engaged in construction, the minimum investment requirement is more than **IDR 10 billion** (approximately USD 625,000), excluding the value of land and buildings, counted per the first 4 digits of the KBLI code rather than per full 5-digit code (BKPM Regulation 5/2025, Art. 26(3)(c)). Equipment, building materials, and working capital count toward this threshold. Paid-up capital is a separate, company-level requirement of at least **IDR 2.5 billion** (Art. 26(10)), regardless of the number of shareholders.
