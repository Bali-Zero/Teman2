...
**BKPM Reg 5/2025 note**: each 5-digit sub-code in the 01611–01619 range needs its own investment plan of more than IDR 10 billion at the project location (Art. 26(2)) — there is no consolidation exception for agriculture like the one wholesale trade or F&B services get. Land and buildings count toward that threshold here (Art. 26(5)), which can work in your favor if the operation already needs agricultural land.
