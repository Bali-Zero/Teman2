...
The June 2026 transition window has closed. After that date, old KBLI 2020 codes become unrecognized for new permits, investment activity reports (LKPM), and import approvals. If you operate in real estate, you need to act before that cutoff.
...
## The Compliance Timeline: What to Do Before June 2026
...
The June 2026 transition window has closed. The codes are clear. The opportunity — 14 real estate classifications, all open to 100% foreign ownership — has never been this well-defined. The question is whether you verify and remediate before the next filing exposes the gap.
