...
seoDescription: "Complete Bali hospitality investment guide: villa code 55203, critical 55193 migration, Sarbagita moratorium, OSS-RDTR GPS zoning, TDUP licensing, and PT PMA structure for hotels and villas."
aiOptimization:
  primaryQuestion: "What KBLI code applies to villa commercial rental activity in Bali under KBLI 2025?"
  answerSnippet: "Commercial villa activity in Bali is classified under KBLI 55203 (Aktivitas Vila) in KBLI 2025. This replaces the old misused code 55193 (Pondok Wisata), which becomes a ghost code after June 18 2026. PT PMA with 100% foreign ownership can operate under 55203 with IDR 2.5B paid-up capital and IDR 10B total investment. TDUP from Dinas Pariwisata Bali and OSS-RDTR GPS zone validation are mandatory before commercial operations."
  entityMentions:
    - type: "Regulation"
...
faq:
  - question: "What is the difference between KBLI 55193 and 55203 for Bali villas?"
    answer: "KBLI 55193 (Pondok Wisata) was misused by commercial villa operators for years. KBLI 2025 replaces it with 55203 (Aktivitas Vila), a dedicated code for commercial villa activity. After June 18 2026, code 55193 becomes a ghost code — unrecognized by OSS. Villas still on 55193 risk OTA delistment, bank account complications, and CoreTax audit flags. All commercial villa operators must migrate to 55203 before the deadline."
...
featured: true
canonicalUrl: "https://balizero.com/news/business/kbli-2025-hospitality-villa-hotel-bali-investment-guide"
...
After June 18, 2026 (the KBLI 2025 migration deadline per BPS Regulation 7/2025), **code 55193 becomes a ghost code** — unrecognized by the OSS-RBA system. Any business still operating under 55193 will find their NIB pointing to a non-existent classification, creating compounding problems:
...
## The Sarbagita Construction Moratorium

### What It Is

The **Sarbagita moratorium** is a construction freeze applicable to four regencies: **Denpasar, Badung, Gianyar, and Tabanan** — the core of Bali's tourist economy. The moratorium, tied to the regional spatial plan (RTRW Bali 2009-2029 and its revisions), effectively blocks new accommodation construction permits in the zones of highest demand.

### How It Works in 2026

The moratorium doesn't prohibit all construction — it targets new accommodation structures on undeveloped or residentially-zoned land. In practice:

- **New hotel construction**: Effectively impossible in Seminyak, Kuta, Sanur, Nusa Dua, central Ubud without pre-existing PBG komersial
- **Villa construction**: New green-field villas in Canggu, Uluwatu, Pecatu require RDTR verification that often blocks commercial accommodation use
- **Renovation/expansion**: Generally permitted for structures with existing PBG komersial
- **Outside the four regencies**: Buleleng, Karangasem, Klungkung, Jembrana, Bangli are not under the moratorium

### The Investment Implication

The moratorium creates **artificial scarcity** in Bali's prime zones. Existing licensed accommodation assets — hotels, villas, guesthouses with valid TDUP and PBG komersial — trade at a structural premium. For PMA investors, the optimal entry strategy has shifted from greenfield construction to:
...
3. **Outside Sarbagita zones**: New construction in Buleleng (Lovina), Karangasem (Amed, Candidasa), Klungkung (Nusa Penida)
...
Hotels with NIB showing 55110 must migrate to their correct star code before June 18, 2026. The migration is not automatic — it requires an active OSS application with LSU certification documentation as supporting evidence.
...
| 55120    | Kondominium Hotel     | 55204       | Migrate to aparthotel code                   |
...
**Deadline for all migrations: June 18, 2026**
...
- Is the property in one of the four Sarbagita regencies?
- If yes: is it a renovation/expansion of existing structure or new construction?
- Existing licensed structures in Sarbagita zones have premium value — price accordingly
...
**For operators with legacy structures**: The June 18, 2026 deadline is real. Start the 55193→55203 migration now — six months is barely enough time for RDTR verification, PBG conversion if needed, TDUP reissuance, and NIB update.
