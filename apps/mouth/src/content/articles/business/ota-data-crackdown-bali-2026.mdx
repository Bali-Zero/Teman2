...
<InfoCard variant="error" title="Quick Facts">
  ...
  **Who's affected:** 39,000+ Airbnb listings (most without proper licenses) - **When:** March 31,
  2026 compliance deadline - **Risk Level:** **VERY HIGH** for unlicensed properties
</InfoCard>
...
<InfoCard variant="warning" title="The Real Risk">
  This isn't just about losing your Airbnb listing. If the Tax Office has booking data and you
  haven't reported rental income, you could face: - **Back taxes** + penalties (up to 48% of unpaid
  amount) - **Criminal prosecution** for tax evasion (Article 39 Tax Law) - **Property seizure** in
  extreme cases
</InfoCard>
