...
function getGreeting(path: string): string {
  if (path.includes("/services") || path.includes("/visa") || path.includes("/company"))
  ...
  const send = useCallback(async () => {
    ...
    try {
      ...
      setMessages((prev) => {
        ...
        return [
          ...prev.slice(0, -1),
          { ...last, content: accumulated || "Sorry, I couldn't respond. Try again!", isStreaming: false },
        ];
      });
    } catch {
      setMessages((prev) => {
        ...
        return [
          ...
          {
            ...last,
            content: "Connection issue. Please try again or reach us on WhatsApp.",
            isStreaming: false,
          },
        ];
      });
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-white/10 bg-[#0a1929]">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/40">Bali Zero AI Assistant</p>
              </div>
            </div>
            <button
          ...
          <div className="border-t border-white/10 bg-[#0a1929] px-3 py-2.5">
            ...
            >
              ...
              <button
                ...
                className="p-2.5 rounded-xl bg-[#2251ff] text-white disabled:opacity-30 hover:bg-[#1a41cc] transition-all"
              >
                {isStreaming ? (
      ...
      {!open && (
        <button
          ...
          className="
            ...
            rounded-full bg-[#2251ff] hover:bg-[#1a41cc]
