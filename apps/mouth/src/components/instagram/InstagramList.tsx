...
export function InstagramList({
  ...
  const filteredConversations = conversations.filter((conv) => {
    ...
    return (
      conv.instagram_user_id.toLowerCase().includes(query) ||
        ...
        {isLoading ? (
          ...
          <div className="divide-y divide-[var(--border)]">
            {filteredConversations.map((conv) => {
              const isSelected = selectedUserId === conv.instagram_user_id;
              const isChecked = selectedIds.has(conv.instagram_user_id);
