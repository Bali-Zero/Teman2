import type { EditorialFeed } from "./types";
    ...
    <>
      {fixture ? (
        <p className="editorial-preview-note">
          Editorial preview — sample stories and illustration. Original articles
          and source links are not connected.
        </p>
      ) : null}
      {status !== "ready" ? (
        <p className="editorial-feed-notice" role="status">
          {messages[status]}
        </p>
      ) : null}
    </>
