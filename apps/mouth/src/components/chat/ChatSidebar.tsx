              ...
              <div className="space-y-1">
                {conversations.slice(0, 10).map((conv) => (
                  <div
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2.5 hover:bg-white/5 rounded-lg transition-all duration-200 text-left group cursor-pointer border border-transparent focus-visible:ring-1 focus-visible:ring-[var(--accent)] outline-none ${
                  ...
                  >
                    ...
                    <button
                      ...
                      className="p-1 hover:bg-white/10 rounded opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 focus-visible:opacity-100 transition-opacity"
