...
export function WhatsAppCTA({ whatsappUrl, onDismiss }: WhatsAppCTAProps) {
  return (
    ...
    >
      <div
        className="w-full max-w-sm rounded-2xl p-8 flex flex-col items-center gap-5 text-center shadow-2xl"
        style={{
      ...
      >
        ...
        {/* Heading */}
        <h2 className="text-xl font-semibold leading-snug" style={{ color: 'var(--tx-primary)' }}>
          You&apos;ve used your {MAX_QUESTIONS} free questions
        </h2>

        {/* Explanation */}
        <p className="text-sm leading-relaxed" style={{ color: 'var(--tx-secondary)' }}>
          Chat directly with our Indonesia immigration specialist for personalised guidance on your
          specific situation.
        </p>
