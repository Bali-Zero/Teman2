  ...
  return (
    <div
      ...
      style={{
        ...
        border: isBestMatch ? '1px solid var(--bz-accent)' : '1px solid rgba(255,255,255,0.08)',
      }}
    >
      {/* Badge + name */}
      <div className="flex items-start justify-between gap-4">
        <div className="flex flex-col gap-1">
          <span
            ...
            style={{
              backgroundColor: isBestMatch ? 'var(--bz-accent)' : 'rgba(255,255,255,0.08)',
      ...
      {/* Category */}
      <p className="text-sm font-medium" style={{ color: 'var(--tx-secondary)' }}>
        {categoryLabel}
      </p>

      {/* Price */}
      <div className="flex items-baseline gap-2">
        <span className="text-2xl font-bold" style={{ color: 'var(--bz-accent)' }}>
          {visa.price}
        </span>
      ...
      {/* Details */}
      <div className="flex flex-col gap-1 text-sm" style={{ color: 'var(--tx-secondary)' }}>
        <span>Duration: {visa.duration}</span>
        <span>Validity: {visa.validity}</span>
        {visa.notes && (
          <p className="text-xs mt-1 leading-relaxed" style={{ color: 'var(--tx-secondary)' }}>
            {visa.notes}
          </p>
        )}
      </div>
