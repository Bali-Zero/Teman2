...
const FALLBACK_WA_URL =
  "https://wa.me/6282210302328?text=Hi%2C%20I%20used%20Visa%20Oracle.";
...
export function VisaChat({
  ...
  async function doHandoff(currentMessages: ChatMessage[]) {
    ...
    trackVisaWhatsAppCTA("shown", "handoff");
    setShowCTA(true);
  }
  ...
  async function handleSend() {
    ...
    trackVisaChatQuestion(remaining);
            ...
            return (
              <div key={idx} className="flex justify-center">
                <p
                  ...
                  style={{
                    backgroundColor:
                      "var(--bz-surface, rgba(255,255,255,0.04))",
