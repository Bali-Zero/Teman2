...
| **L6** frontend + design   | `/visa/voa` pages restored then redesigned, tracker UI, Brevo emails from `zantara@`, imagegen assets                                                                                                                                                                              | Codex Terra + Haiku grunt | Opus 5.5 critic gate (screenshots, mobile-first, WCAG AA) | contract tests + visual diff | MERGED (#4876)                |
