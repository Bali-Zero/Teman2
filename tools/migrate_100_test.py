...
class MigrationEngine:
    def __init__(self):
        self.stats = {"clients_migrated": 0, "files_uploaded": 0, "errors": []}
    ...
    def migrate_client(self, client):
        ...
        try:
            ...
            categories = {
                ...
                "03_Other_Documents": self.create_folder(
                    "03_Other_Documents", client_folder_id
                ),
            }
            ...
            print(f"   ❌ Error: {e}")
            self.stats["errors"].append({"client": client_name, "error": str(e)})
